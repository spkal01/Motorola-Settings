...
public class VzwMobileDataPreferenceController extends ExtendedMobileDataPreferenceController {
    private static final String SUBSCRIPTION_KEY = "subscription";
    private static final String TAG = "VzwMobileDataPreferenceController";
    ...
    public VzwMobileDataPreferenceController(Context context, String str) {
        super(context, str);
    }

    public boolean setChecked(boolean z) {
        if (isChecked()) {
            Intent motoDataDisableDialog = getMotoDataDisableDialog();
            this.mMotDataDisableDialogIntent = motoDataDisableDialog;
            motoDataDisableDialog.putExtra(SUBSCRIPTION_KEY, this.mSubId);
        } else {
