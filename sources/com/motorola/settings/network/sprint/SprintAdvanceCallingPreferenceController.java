...
public class SprintAdvanceCallingPreferenceController extends ExtendedEnhanced4gLtePreferenceController {
    ...
    public SprintAdvanceCallingPreferenceController(Context context, String str) {
        super(context, str);
    }
