...
public class SprintVoLTEPreferenceController extends ExtendedEnhanced4gLtePreferenceController {
    ...
    public SprintVoLTEPreferenceController(Context context, String str) {
        super(context, str);
    }
