...
public class HotspotHelper {
    ...
    public static boolean shouldWarnWhenEditingTethering(Context context) {
        return Arrays.asList(context.getResources().getStringArray(R$array.carrier_id_warn_tethering_edit_disconnect)).contains(String.valueOf(getCarrierId(context)));
    }
