...
public class InstalledAppUtils {
    ...
    public boolean isPackageNonDisableable(String str) {
        return NON_DISABLE_APP_FILTER.contains(this.mContext, str);
    }

    public boolean isPackageNonForceStoppable(String str) {
        return NON_FORCESTOP_APP_FILTER.contains(this.mContext, str);
    }
    ...
    public boolean isPkgDisableUiOfNotifListener(String str) {
        return DISABLE_UI_OF_NOTIF_LISTNER_APP_FILTER.contains(this.mContext, str);
    }

    public boolean isPkgHideSensitiveContentItem(String str) {
        return HIDE_SENSITIVE_CONTENT_APP_FILTER.contains(this.mContext, str);
    }

    public boolean isHiddenPackage(String str) {
        return HIDE_APP_LIST.contains(this.mContext, str);
    }

    public boolean hasHiddenPackages() {
        return HIDE_APP_LIST.containsRestrictedPackages(this.mContext);
    }
}
