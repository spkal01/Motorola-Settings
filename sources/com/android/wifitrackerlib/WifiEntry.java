...
public class WifiEntry implements Comparable<WifiEntry> {
    ...
    public synchronized int getConnectedState() {
        ...
        switch (C15761.$SwitchMap$android$net$NetworkInfo$DetailedState[networkInfo.getDetailedState().ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    static /* synthetic */ class C15761 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.wifitrackerlib.WifiEntry.C15761.<clinit>():void");
        }
    }
