...
public class AdbQrcodeScannerFragment extends WifiDppQrCodeBaseFragment implements TextureView.SurfaceTextureListener, QrCamera.ScannerCallback {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C1987R$layout.adb_qrcode_scanner_fragment, viewGroup, false);
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setHeaderIconImageResource(C1983R$drawable.ic_scan_24dp);
        this.mQrCameraView = view.findViewById(C1985R$id.camera_layout);
        this.mVerifyingView = view.findViewById(C1985R$id.verifying_layout);
        this.mVerifyingTextView = (TextView) view.findViewById(C1985R$id.verifying_textview);
        setHeaderTitle(C1992R$string.wifi_dpp_scan_qr_code, new Object[0]);
        this.mSummary.setText(C1992R$string.adb_wireless_qrcode_pairing_description);
