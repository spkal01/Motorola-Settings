...
public class BlobInfoListView extends ListActivity {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 8108 && i2 == -1) {
            Toast.makeText(this, C1992R$string.shared_data_delete_failure_text, 1).show();
        }
    }
    ...
    private void showDeleteBlobDialog(BlobInfo blobInfo) {
        new AlertDialog.Builder(this.mContext).setMessage(C1992R$string.shared_data_no_accessors_dialog_text).setPositiveButton(17039370, getDialogOnClickListener(blobInfo)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create().show();
    }
    ...
    private void queryBlobsAndUpdateList() {
        try {
            ...
            Toast.makeText(this, C1992R$string.shared_data_query_failure_text, 1).show();
            finish();
        }
    }
    ...
    private class BlobListAdapter extends ArrayAdapter<BlobInfo> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            createOrRecycle.blobId.setText(BlobInfoListView.this.getString(C1992R$string.blob_id_text, new Object[]{Long.valueOf(blobInfo.getId())}));
            createOrRecycle.blobExpiry.setText(BlobInfoListView.this.getString(C1992R$string.blob_expires_text, new Object[]{SharedDataUtils.formatTime(blobInfo.getExpiryTimeMs())}));
