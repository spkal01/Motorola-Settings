...
public class AppViewHolder {
    ...
    public static AppViewHolder createOrRecycle(LayoutInflater layoutInflater, View view) {
        ...
        View inflate = layoutInflater.inflate(C1987R$layout.preference_app, (ViewGroup) null);
        ...
        appViewHolder.disabled = (TextView) inflate.findViewById(C1985R$id.appendix);
