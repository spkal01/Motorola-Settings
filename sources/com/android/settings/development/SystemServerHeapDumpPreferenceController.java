...
public class SystemServerHeapDumpPreferenceController extends DeveloperOptionsPreferenceController implements PreferenceControllerMixin {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        try {
            ...
            Toast.makeText(this.mContext, C1992R$string.capturing_system_heap_dump_message, 0).show();
            ActivityManager.getService().requestSystemServerHeapDump();
            this.mHandler.postDelayed(new C0853xd19f3818(preference), 5000);
            return true;
        } catch (RemoteException e) {
            Log.e("PrefControllerMixin", "error taking system heap dump", e);
            Toast.makeText(this.mContext, C1992R$string.error_capturing_system_heap_dump_message, 0).show();
            return false;
        }
    }
}
