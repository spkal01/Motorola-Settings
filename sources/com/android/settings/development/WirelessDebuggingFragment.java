...
public class WirelessDebuggingFragment extends DashboardFragment implements WirelessDebuggingEnabler.OnEnabledListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.adb_wireless_settings) {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        switchBar.setTitle(getContext().getString(C1992R$string.wireless_debugging_main_switch_title));
    ...
    private void addPreferences() {
        ...
        this.mOffMessagePreference.setTitle(getText(C1992R$string.adb_wireless_list_empty_off));
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.adb_wireless_settings;
    }
    ...
    private void launchPairedDeviceDetailsFragment(AdbPairedDevicePreference adbPairedDevicePreference) {
        ...
        new SubSettingLauncher(getContext()).setTitleRes(C1992R$string.adb_wireless_device_details_title).setDestination(AdbDeviceDetailsFragment.class.getName()).setArguments(adbPairedDevicePreference.getExtras()).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, 0).launch();
    }
