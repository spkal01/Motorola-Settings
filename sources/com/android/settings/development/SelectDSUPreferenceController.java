...
class SelectDSUPreferenceController extends DeveloperOptionsPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        preference.setSummary((CharSequence) this.mContext.getResources().getString(isDSURunning() ? C1992R$string.dsu_is_running : C1992R$string.dsu_loader_description));
    }
}
