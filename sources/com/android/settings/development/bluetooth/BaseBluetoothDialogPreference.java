...
public abstract class BaseBluetoothDialogPreference extends CustomDialogPreferenceCompat implements RadioGroup.OnCheckedChangeListener {
    ...
    public void onBindDialogView(View view) {
        ...
        if (this.mCallback == null) {
            ...
            TextView textView = (TextView) view.findViewById(C1985R$id.bluetooth_audio_codec_help_info);
            if (selectableIndex.size() == this.mRadioButtonIds.size()) {
                textView.setVisibility(8);
                return;
            }
            textView.setText(C1992R$string.bluetooth_select_a2dp_codec_type_help_info);
    ...
    public String generateSummary(int i) {
        if (i > this.mSummaryStrings.size()) {
            ...
            return String.format(getContext().getResources().getString(C1992R$string.bluetooth_select_a2dp_codec_streaming_label), new Object[]{this.mSummaryStrings.get(i)});
        }
    }
}
