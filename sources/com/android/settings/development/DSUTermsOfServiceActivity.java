...
public class DSUTermsOfServiceActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1987R$layout.dsu_terms_of_service);
        TextView textView = (TextView) findViewById(C1985R$id.tos_content);
        ...
        ((Button) findViewById(C1985R$id.accept)).setOnClickListener(new View.OnClickListener() {
