...
public class MockLocationAppPreferenceController extends DeveloperOptionsPreferenceController implements PreferenceControllerMixin, OnActivityResultListener {
    ...
    private void updateMockLocation() {
        ...
        if (!TextUtils.isEmpty(currentMockLocationApp)) {
            this.mPreference.setSummary((CharSequence) this.mContext.getResources().getString(C1992R$string.mock_location_app_set, new Object[]{getAppLabel(currentMockLocationApp)}));
            return;
        }
        this.mPreference.setSummary((CharSequence) this.mContext.getResources().getString(C1992R$string.mock_location_app_not_set));
    }
