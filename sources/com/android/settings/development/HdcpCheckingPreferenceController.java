...
public class HdcpCheckingPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {
    ...
    private final String[] mListSummaries = this.mContext.getResources().getStringArray(C1978R$array.hdcp_checking_summaries);
    private final String[] mListValues = this.mContext.getResources().getStringArray(C1978R$array.hdcp_checking_values);
