    ...
    private void updateSimulateColorSpace() {
        ...
        if (z) {
            ...
            if (listPreference.findIndexOfValue(num) < 0) {
                ...
                listPreference.setSummary(resources.getString(C1992R$string.daltonizer_type_overridden, new Object[]{resources.getString(C1992R$string.accessibility_display_daltonizer_preference_title)}));
                return;
            }
