...
public class DisableDevSettingsDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setMessage(C1992R$string.bluetooth_disable_a2dp_hw_offload_dialog_message).setTitle(C1992R$string.bluetooth_disable_a2dp_hw_offload_dialog_title).setPositiveButton(C1992R$string.bluetooth_disable_a2dp_hw_offload_dialog_confirm, (DialogInterface.OnClickListener) this).setNegativeButton(C1992R$string.bluetooth_disable_a2dp_hw_offload_dialog_cancel, (DialogInterface.OnClickListener) this).create();
    }
