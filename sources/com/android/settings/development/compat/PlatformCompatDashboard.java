...
public class PlatformCompatDashboard extends DashboardFragment {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.platform_compat_settings;
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (i != 6) {
            ...
            new AlertDialog.Builder(getContext()).setTitle(C1992R$string.platform_compat_dialog_title_no_apps).setMessage(C1992R$string.platform_compat_dialog_text_no_apps).setPositiveButton(C1992R$string.okay, new PlatformCompatDashboard$$ExternalSyntheticLambda0(this)).setOnDismissListener(new PlatformCompatDashboard$$ExternalSyntheticLambda1(this)).setCancelable(false).show();
        }
    }
    ...
    private void addPreferences(ApplicationInfo applicationInfo) {
        ...
        createChangeCategoryPreference(arrayList, appChangeMappings, getString(C1992R$string.platform_compat_default_enabled_title));
        createChangeCategoryPreference(arrayList2, appChangeMappings, getString(C1992R$string.platform_compat_default_disabled_title));
        for (Integer num : treeMap.keySet()) {
            createChangeCategoryPreference((List) treeMap.get(num), appChangeMappings, getString(C1992R$string.platform_compat_target_sdk_title, num));
        }
    }
    ...
    public Preference createAppPreference(ApplicationInfo applicationInfo) {
        ...
        preference.setSummary((CharSequence) getString(C1992R$string.platform_compat_selected_app_summary, this.mSelectedApp, Integer.valueOf(applicationInfo.targetSdkVersion)));
