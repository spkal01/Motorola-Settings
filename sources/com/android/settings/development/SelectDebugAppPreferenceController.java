...
public class SelectDebugAppPreferenceController extends DeveloperOptionsPreferenceController implements PreferenceControllerMixin, OnActivityResultListener {
    ...
    public void onDeveloperOptionsSwitchDisabled() {
        ...
        this.mPreference.setSummary((CharSequence) this.mContext.getResources().getString(C1992R$string.debug_app_not_set));
    }
    ...
    private void updatePreferenceSummary() {
        ...
        this.mPreference.setSummary((CharSequence) this.mContext.getResources().getString(C1992R$string.debug_app_set, new Object[]{getAppLabel(string)}));
    }
