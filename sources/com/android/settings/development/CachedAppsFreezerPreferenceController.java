...
public class CachedAppsFreezerPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {
    ...
    public CachedAppsFreezerPreferenceController(Context context) {
        super(context);
        this.mListValues = context.getResources().getStringArray(C1978R$array.cached_apps_freezer_values);
        this.mListSummaries = context.getResources().getStringArray(C1978R$array.cached_apps_freezer_entries);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        new AlertDialog.Builder(this.mContext).setMessage(C1992R$string.cached_apps_freezer_reboot_dialog_text).setPositiveButton(17039370, getRebootDialogOkListener(obj)).setNegativeButton(17039360, getRebootDialogCancelListener()).create().show();
        return true;
    }
