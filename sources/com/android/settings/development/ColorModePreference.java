...
public class ColorModePreference extends SwitchPreference implements DisplayManager.DisplayListener {
    ...
    public static List<ColorModeDescription> getColorModeDescriptions(Context context) {
        ...
        int[] intArray = resources.getIntArray(C1978R$array.color_mode_ids);
        String[] stringArray = resources.getStringArray(C1978R$array.color_mode_names);
        String[] stringArray2 = resources.getStringArray(C1978R$array.color_mode_descriptions);
