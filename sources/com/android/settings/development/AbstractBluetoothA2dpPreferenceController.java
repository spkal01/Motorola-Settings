...
public abstract class AbstractBluetoothA2dpPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin, BluetoothServiceConnectionListener, LifecycleObserver, OnDestroy {
    static final int STREAMING_LABEL_ID = C1992R$string.bluetooth_select_a2dp_codec_streaming_label;
    ...
    public boolean onPreferenceChange(androidx.preference.Preference r6, java.lang.Object r7) {
        ...
        L_0x0006:
            ...
            monitor-enter(r1)
            android.bluetooth.BluetoothA2dp r2 = r5.mBluetoothA2dp     // Catch:{ all -> 0x0057 }
            if (r2 == 0) goto L_0x0021
            android.bluetooth.BluetoothDevice r2 = r2.getActiveDevice()     // Catch:{ all -> 0x0057 }
            if (r2 != 0) goto L_0x001e
            monitor-exit(r1)     // Catch:{ all -> 0x0057 }
            return r0
        L_0x001e:
            r5.setCodecConfigPreference(r2, r6)     // Catch:{ all -> 0x0057 }
        L_0x0021:
            monitor-exit(r1)     // Catch:{ all -> 0x0057 }
