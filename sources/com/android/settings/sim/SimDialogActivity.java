...
public class SimDialogActivity extends FragmentActivity {
    ...
    private SimDialogFragment createFragment(int i) {
        if (i == 0) {
            return SimListDialogFragment.newInstance(i, C1992R$string.select_sim_for_data, false);
        }
        if (i == 1) {
            return SimListDialogFragment.newInstance(i, C1992R$string.select_sim_for_calls, true);
        }
        if (i == 2) {
            return SimListDialogFragment.newInstance(i, C1992R$string.select_sim_for_sms, true);
        }
        if (i != 3) {
            if (i == 4) {
                return SimListDialogFragment.newInstance(i, C1992R$string.select_sim_for_sms, false);
            }
    ...
    private void setDefaultDataSubId(int i) {
        ...
        Toast.makeText(this, C1992R$string.data_switch_started, 1).show();
    }
