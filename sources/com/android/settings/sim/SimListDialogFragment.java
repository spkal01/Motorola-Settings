    ...
    private static class SelectSubscriptionAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view == null) {
                ...
                view = this.mInflater.inflate(C1987R$layout.select_account_list_item, viewGroup, false);
            }
            SubscriptionInfo item = getItem(i);
            TextView textView = (TextView) view.findViewById(C1985R$id.title);
            TextView textView2 = (TextView) view.findViewById(C1985R$id.summary);
            ImageView imageView = (ImageView) view.findViewById(C1985R$id.icon);
            String str = "";
            if (item == null) {
                textView.setText(C1992R$string.sim_calls_ask_first_prefs_title);
                textView2.setText(str);
                imageView.setImageDrawable(this.mContext.getDrawable(C1983R$drawable.ic_feedback_24dp));
