...
public class DsdsDialogActivity extends SubscriptionActionDialogActivity implements SidecarFragment.Listener, ConfirmDialogFragment.OnConfirmListener {
    ...
    private void showEnableDsdsConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 1, getString(C1992R$string.sim_action_enable_dsds_title), getString(C1992R$string.sim_action_enable_dsds_text), getString(C1992R$string.sim_action_yes), getString(C1992R$string.sim_action_no_thanks));
    }

    private void showRebootConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 2, getString(C1992R$string.sim_action_restart_title), getString(C1992R$string.sim_action_enable_dsds_text), getString(C1992R$string.sim_action_reboot), getString(C1992R$string.cancel));
    }
