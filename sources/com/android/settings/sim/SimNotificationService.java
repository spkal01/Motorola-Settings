...
public class SimNotificationService extends JobService {
    ...
    public static void scheduleSimNotification(Context context, int i) {
        ...
        ((JobScheduler) context.getApplicationContext().getSystemService(JobScheduler.class)).schedule(new JobInfo.Builder(C1986R$integer.sim_notification_send, componentName).setExtras(persistableBundle).build());
    }
