...
public class SmartForwardingFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener, Instrumentable {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        setPreferencesFromResource(C1994R$xml.smart_forwarding_switch, str);
        getActivity().getActionBar().setTitle(getResources().getString(C1992R$string.smart_forwarding_title));
    ...
    private void switchToMDNFragment() {
        getActivity().getSupportFragmentManager().beginTransaction().replace(C1985R$id.content_frame, new MDNHandlerFragment()).commit();
    }
