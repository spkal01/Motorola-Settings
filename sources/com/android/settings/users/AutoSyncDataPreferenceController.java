...
public class AutoSyncDataPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public static class ConfirmAutoSyncChangeFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            if (!this.mEnabling) {
                builder.setTitle(C1992R$string.data_usage_auto_sync_off_dialog_title);
                builder.setMessage(C1992R$string.data_usage_auto_sync_off_dialog);
            } else {
                builder.setTitle(C1992R$string.data_usage_auto_sync_on_dialog_title);
                builder.setMessage(C1992R$string.data_usage_auto_sync_on_dialog);
            }
