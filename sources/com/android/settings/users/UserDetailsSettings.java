...
public class UserDetailsSettings extends SettingsPreferenceFragment implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.user_details_settings);
    ...
    public void initialize(Context context, Bundle bundle) {
        ...
        if (i2 != -10000) {
            ...
            if (this.mUserInfo.isGuest()) {
                this.mPhonePref.setTitle(C1992R$string.user_enable_calling);
                ...
                this.mRemoveUserPref.setTitle(C1992R$string.user_remove_user);
            }
    ...
    private void openAppAndContentAccessScreen(boolean z) {
        ...
        new SubSettingLauncher(getContext()).setDestination(AppRestrictionsFragment.class.getName()).setArguments(bundle).setTitleRes(C1992R$string.user_restrictions_title).setSourceMetricsCategory(getMetricsCategory()).launch();
    }
