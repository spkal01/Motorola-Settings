...
public class AppRestrictionsFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, View.OnClickListener, Preference.OnPreferenceClickListener, AppRestrictionsHelper.OnDisableUiForPackageListener {
    ...
    static class AppRestrictionsPreference extends SwitchPreference {
        ...
        AppRestrictionsPreference(Context context, View.OnClickListener onClickListener) {
            super(context);
            setLayoutResource(C1987R$layout.preference_app_restrictions);
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            View findViewById = preferenceViewHolder.findViewById(C1985R$id.app_restrictions_settings);
            int i = 8;
            findViewById.setVisibility(this.hasSettings ? 0 : 8);
            View findViewById2 = preferenceViewHolder.findViewById(C1985R$id.settings_divider);
            if (this.hasSettings) {
                i = 0;
            }
            ...
            View findViewById3 = preferenceViewHolder.findViewById(C1985R$id.app_restrictions_pref);
    ...
    public void init(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.app_restrictions);
    ...
    private String getPackageSummary(PackageInfo packageInfo, AppRestrictionsHelper.SelectableAppInfo selectableAppInfo) {
        ...
        if (selectableAppInfo2 != null) {
            if (!this.mRestrictedProfile || packageInfo.restrictedAccountType == null) {
                return getString(C1992R$string.user_restrictions_controlled_by, selectableAppInfo2.activityName);
            }
            return getString(C1992R$string.app_sees_restricted_accounts_and_controlled_by, selectableAppInfo2.activityName);
        } else if (packageInfo.restrictedAccountType != null) {
            return getString(C1992R$string.app_sees_restricted_accounts);
        } else {
            return null;
        }
    }
    ...
    private void addLocationAppRestrictionsPreference(AppRestrictionsHelper.SelectableAppInfo selectableAppInfo, AppRestrictionsPreference appRestrictionsPreference) {
        ...
        appRestrictionsPreference.setIcon(C1983R$drawable.ic_preference_location);
        appRestrictionsPreference.setKey(getKeyForPackage(str));
    ...
    public void onClick(View view) {
        if (view.getTag() instanceof AppRestrictionsPreference) {
            ...
            if (view.getId() == C1985R$id.app_restrictions_settings) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v0, resolved type: androidx.preference.SwitchPreference} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v1, resolved type: androidx.preference.SwitchPreference} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v5, resolved type: androidx.preference.SwitchPreference} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v6, resolved type: androidx.preference.SwitchPreference} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v7, resolved type: androidx.preference.SwitchPreference} */
    /* access modifiers changed from: private */
    ...
    public void onRestrictionsReceived(com.android.settings.users.AppRestrictionsFragment.AppRestrictionsPreference r10, java.util.ArrayList<android.content.RestrictionEntry> r11) {
        ...
        L_0x0027:
            ...
            r4.setValues(r5)
            java.lang.String r5 = r3.getTitle()
            r4.setDialogTitle((java.lang.CharSequence) r5)
            goto L_0x00bc
        L_0x005c:
        ...
        L_0x00bc:
            ...
            int r3 = com.android.settings.C1983R$drawable.empty_icon
            r4.setIcon((int) r3)
