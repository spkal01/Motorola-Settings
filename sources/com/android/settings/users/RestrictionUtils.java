...
public class RestrictionUtils {
    public static final int[] sRestrictionDescriptions = {C1992R$string.restriction_location_enable_summary};
    public static final String[] sRestrictionKeys = {"no_share_location"};
    public static final int[] sRestrictionTitles = {C1992R$string.restriction_location_enable_title};
