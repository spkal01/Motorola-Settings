...
public class StorageWizardMigrateProgress extends StorageWizardBase {
        ...
        public void onStatusChanged(int i, int i2, long j) {
            if (StorageWizardMigrateProgress.this.mMoveId == i) {
                ...
                if (PackageManager.isMoveStatusFinished(i2)) {
                    ...
                    if (i2 != -100) {
                        Toast.makeText(storageWizardMigrateProgress, StorageWizardMigrateProgress.this.getString(C1992R$string.insufficient_storage), 1).show();
    ...
    public void onCreate(Bundle bundle) {
        ...
        setHeaderText(C1992R$string.storage_wizard_migrate_progress_v2_title, new CharSequence[0]);
        setAuxChecklist();
