...
public class PrivateVolumeUnmount extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(C1987R$layout.storage_internal_unmount, viewGroup, false);
        ((TextView) inflate.findViewById(C1985R$id.body)).setText(TextUtils.expandTemplate(getText(C1992R$string.storage_internal_unmount_details), new CharSequence[]{this.mDisk.getDescription()}));
