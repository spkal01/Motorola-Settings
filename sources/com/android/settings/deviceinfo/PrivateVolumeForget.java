...
public class PrivateVolumeForget extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(C1987R$layout.storage_internal_forget, viewGroup, false);
        ((TextView) inflate.findViewById(C1985R$id.body)).setText(TextUtils.expandTemplate(getText(C1992R$string.storage_internal_forget_details), new CharSequence[]{this.mRecord.getNickname()}));
        ((Button) inflate.findViewById(C1985R$id.confirm)).setOnClickListener(this.mConfirmListener);
        return inflate;
    }
    ...
    public static class ForgetConfirmFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            builder.setTitle(TextUtils.expandTemplate(getText(C1992R$string.storage_internal_forget_confirm_title), new CharSequence[]{findRecordByUuid.getNickname()}));
            builder.setMessage(TextUtils.expandTemplate(getText(C1992R$string.storage_internal_forget_confirm), new CharSequence[]{findRecordByUuid.getNickname()}));
            builder.setPositiveButton(C1992R$string.storage_menu_forget, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    storageManager.forgetVolume(string);
                    ForgetConfirmFragment.this.getActivity().finish();
                }
            });
            builder.setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null);
