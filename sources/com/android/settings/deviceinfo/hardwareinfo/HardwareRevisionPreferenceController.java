...
public class HardwareRevisionPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return (!this.mContext.getResources().getBoolean(C1980R$bool.config_show_device_model) || TextUtils.isEmpty(getSummary())) ? 3 : 0;
    }

    public void copy() {
        Sliceable.setCopyContent(this.mContext, getSummary(), this.mContext.getText(C1992R$string.hardware_revision));
    }
