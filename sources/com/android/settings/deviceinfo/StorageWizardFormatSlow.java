...
public class StorageWizardFormatSlow extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setHeaderText(C1992R$string.storage_wizard_slow_v2_title, getDiskShortDescription());
        setBodyText(C1992R$string.storage_wizard_slow_v2_body, getDiskDescription(), getDiskShortDescription(), getDiskShortDescription(), getDiskShortDescription());
        setBackButtonText(C1992R$string.storage_wizard_slow_v2_start_over, new CharSequence[0]);
        setNextButtonText(C1992R$string.storage_wizard_slow_v2_continue, new CharSequence[0]);
