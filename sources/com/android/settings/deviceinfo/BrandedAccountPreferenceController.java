...
public class BrandedAccountPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        if (!this.mContext.getResources().getBoolean(C1980R$bool.config_show_branded_account_in_device_info)) {
            return 3;
        }
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        new SubSettingLauncher(this.mContext).setDestination(AccountDetailDashboardFragment.class.getName()).setTitleRes(C1992R$string.account_sync_title).setArguments(bundle).setSourceMetricsCategory(40).launch();
        return true;
    }
