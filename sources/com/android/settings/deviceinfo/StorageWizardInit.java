...
public class StorageWizardInit extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1987R$layout.storage_wizard_init);
        this.mIsPermittedToAdopt = UserManager.get(this).isAdminUser() && !ActivityManager.isUserAMonkey();
        setHeaderText(C1992R$string.storage_wizard_init_v2_title, getDiskShortDescription());
        this.mInternal = (Button) requireViewById(C1985R$id.storage_wizard_init_internal);
        setBackButtonText(C1992R$string.storage_wizard_init_v2_later, new CharSequence[0]);
