...
public class SimStatusDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        this.mRootView = LayoutInflater.from(positiveButton.getContext()).inflate(C1987R$layout.dialog_sim_status, (ViewGroup) null);
    ...
    public void setText(int i, CharSequence charSequence) {
        if (getActivity() != null) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = getResources().getString(C1992R$string.device_info_default);
            }
            if (textView != null) {
