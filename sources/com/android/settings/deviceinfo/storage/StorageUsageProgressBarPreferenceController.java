...
public class StorageUsageProgressBarPreferenceController extends BasePreferenceController {
    ...
    private void getStorageStatsAndUpdateUi() {
        ThreadUtils.postOnBackgroundThread((Runnable) new C0892x8465e7c6(this));
    }
    ...
    public /* synthetic */ void lambda$getStorageStatsAndUpdateUi$1() {
        try {
            ...
            if (this.mUsageProgressBarPreference != null) {
                ...
                ThreadUtils.postOnMainThread(new C0893x8465e7c7(this));
            }
    ...
    public void updateState(Preference preference) {
        if (this.mIsUpdateStateFromSelectedStorageEntry) {
            ...
            this.mUsageProgressBarPreference.setUsageSummary(getStorageSummary(C1992R$string.storage_usage_summary, this.mUsedBytes));
            this.mUsageProgressBarPreference.setTotalSummary(getStorageSummary(C1992R$string.storage_total_summary, this.mTotalBytes));
