...
public class DiskInitFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(activity).setMessage(TextUtils.expandTemplate(getText(i), new CharSequence[]{findDiskById.getDescription()})).setPositiveButton(C1992R$string.storage_menu_set_up, (DialogInterface.OnClickListener) new DiskInitFragment$$ExternalSyntheticLambda0(this, activity, string)).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null).create();
    }
