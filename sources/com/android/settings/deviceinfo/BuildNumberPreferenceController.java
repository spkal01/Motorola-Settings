...
public class BuildNumberPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart {
    ...
    public void copy() {
        Sliceable.setCopyContent(this.mContext, getSummary(), this.mContext.getText(C1992R$string.build_number));
    }
        ...
        if (!this.mUm.isAdminUser() && !this.mUm.isDemoUser()) {
            ...
            if (i > 0) {
                ...
                if (i2 == 0 && !this.mProcessingLastDevHit) {
                    ...
                    boolean show = new ChooseLockSettingsHelper.Builder(this.mActivity, this.mFragment).setRequestCode(100).setTitle(this.mContext.getString(C1992R$string.unlock_set_unlock_launch_picker_title)).show();
                    ...
                    int i3 = C1990R$plurals.show_dev_countdown;
                ...
                Toast makeText2 = Toast.makeText(this.mContext, C1992R$string.show_dev_already, 1);
    ...
    private void enableDevelopmentSettings() {
        ...
        Toast makeText = Toast.makeText(this.mContext, C1992R$string.show_dev_on, 1);
        this.mDevHitToast = makeText;
        makeText.show();
    }
}
