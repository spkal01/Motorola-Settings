...
public class StorageWizardFormatConfirm extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setTitle(TextUtils.expandTemplate(getText(C1992R$string.storage_wizard_format_confirm_v2_title), new CharSequence[]{findDiskById.getShortDescription()}));
        builder.setMessage(TextUtils.expandTemplate(getText(C1992R$string.storage_wizard_format_confirm_v2_body), new CharSequence[]{findDiskById.getDescription(), findDiskById.getShortDescription(), findDiskById.getShortDescription()}));
        builder.setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
        builder.setPositiveButton(TextUtils.expandTemplate(getText(C1992R$string.storage_wizard_format_confirm_v2_action), new CharSequence[]{findDiskById.getShortDescription()}), (DialogInterface.OnClickListener) new StorageWizardFormatConfirm$$ExternalSyntheticLambda0(context, string, string2, z));
