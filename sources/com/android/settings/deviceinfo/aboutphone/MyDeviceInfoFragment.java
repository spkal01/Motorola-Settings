...
public class MyDeviceInfoFragment extends DashboardFragment implements DeviceNamePreferenceController.DeviceNamePreferenceHost {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.my_device_info) {
    ...
    public int getHelpResource() {
        return C1992R$string.help_uri_about;
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.my_device_info;
    }
    ...
    private void initHeader() {
        ...
        boolean z = getContext().getResources().getBoolean(C1980R$bool.config_show_device_header_in_device_info);
        layoutPreference.setVisible(z);
        if (z) {
            View findViewById = layoutPreference.findViewById(C1985R$id.entity_header);
