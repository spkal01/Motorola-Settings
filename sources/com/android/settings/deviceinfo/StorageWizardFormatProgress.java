...
public class StorageWizardFormatProgress extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setHeaderText(C1992R$string.storage_wizard_format_progress_title, getDiskShortDescription());
        setBodyText(C1992R$string.storage_wizard_format_progress_body, getDiskDescription());
