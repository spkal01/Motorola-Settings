...
public class SettingsLicenseActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<File> {
    ...
    private void showHtmlFromUri(Uri uri) {
        ...
        intent.putExtra("android.intent.extra.TITLE", getString(C1992R$string.settings_license_activity_title));
    ...
    private void showErrorAndFinish() {
        Toast.makeText(this, C1992R$string.settings_license_activity_unavailable, 1).show();
        finish();
    }
