...
public class BugreportPreference extends CustomDialogPreferenceCompat {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        View inflate = View.inflate(getContext(), C1987R$layout.bugreport_options_dialog, (ViewGroup) null);
        this.mInteractiveTitle = (CheckedTextView) inflate.findViewById(C1985R$id.bugreport_option_interactive_title);
        this.mInteractiveSummary = (TextView) inflate.findViewById(C1985R$id.bugreport_option_interactive_summary);
        this.mFullTitle = (CheckedTextView) inflate.findViewById(C1985R$id.bugreport_option_full_title);
        this.mFullSummary = (TextView) inflate.findViewById(C1985R$id.bugreport_option_full_summary);
        ...
        builder.setPositiveButton(17041325, onClickListener);
