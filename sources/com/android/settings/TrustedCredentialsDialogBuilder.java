...
class TrustedCredentialsDialogBuilder extends AlertDialog.Builder {
    ...
    private void initDefaultBuilderParams() {
        ...
        setPositiveButton(C1992R$string.trusted_credentials_trust_label, (DialogInterface.OnClickListener) null);
    ...
    private static class DialogEventHandler implements DialogInterface.OnShowListener, View.OnClickListener {
        ...
        private void onClickTrust() {
            ...
            if (!this.mDelegate.startConfirmCredentialIfNotConfirmed(currentCertInfo.getUserId(), new C0587xaae824fd(this))) {
        ...
        private void onClickEnableOrDisable() {
            ...
            C05831 r1 = new DialogInterface.OnClickListener() {
            ...
            if (currentCertInfo.isSystemCert()) {
                ...
                new AlertDialog.Builder(this.mActivity).setMessage(C1992R$string.trusted_credentials_remove_confirmation).setPositiveButton(17039379, (DialogInterface.OnClickListener) r1).setNegativeButton(17039369, (DialogInterface.OnClickListener) null).show();
            }
        }
        ...
        private void updatePositiveButton() {
            ...
            this.mPositiveButton = updateButton(-1, this.mActivity.getText((z || !this.mNeedsApproval) ? 17039370 : C1992R$string.trusted_credentials_trust_label));
        }
        ...
        private static int getButtonLabel(TrustedCredentialsSettings.CertHolder certHolder) {
            if (!certHolder.isSystemCert()) {
                return C1992R$string.trusted_credentials_remove_label;
            }
            if (certHolder.isDeleted()) {
                return C1992R$string.trusted_credentials_enable_label;
            }
            return C1992R$string.trusted_credentials_disable_label;
        }
