...
public class BugReportHandlerPicker extends DefaultAppPickerFragment {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.bug_report_handler_settings;
    }
    ...
    public void addStaticPreferences(PreferenceScreen preferenceScreen) {
        if (this.mFooter == null) {
            ...
            this.mFooter.setTitle(C1992R$string.bug_report_handler_picker_footer_text);
    ...
    private String getDescription(String str, int i) {
        ...
        if ("com.android.shell".equals(str)) {
            return context.getString(C1992R$string.system_default_app_subtext);
        }
        ...
        if (userInfo == null || !userInfo.isManagedProfile()) {
            return context.getString(C1992R$string.personal_profile_app_subtext);
        }
        return context.getString(C1992R$string.work_profile_app_subtext);
    }
    ...
    private static class BugreportHandlerAppInfo extends DefaultAppInfo {
        ...
        public CharSequence loadLabel() {
            ...
            if ("com.android.shell".equals(packageItemInfo.packageName)) {
                return this.mContext.getString(17039656);
            }
