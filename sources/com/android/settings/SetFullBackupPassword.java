...
public class SetFullBackupPassword extends Activity {
        ...
        public void onClick(View view) {
            ...
            if (view == setFullBackupPassword.mSet) {
                ...
                if (!charSequence2.equals(SetFullBackupPassword.this.mConfirmNewPw.getText().toString())) {
                    ...
                    Toast.makeText(SetFullBackupPassword.this, C1992R$string.local_backup_password_toast_confirmation_mismatch, 1).show();
                    ...
                    Toast.makeText(SetFullBackupPassword.this, C1992R$string.local_backup_password_toast_success, 1).show();
                    SetFullBackupPassword.this.finish();
                } else {
                    Log.i("SetFullBackupPassword", "failure; password mismatch?");
                    Toast.makeText(SetFullBackupPassword.this, C1992R$string.local_backup_password_toast_validation_failure, 1).show();
                }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1987R$layout.set_backup_pw);
        this.mCurrentPw = (TextView) findViewById(C1985R$id.current_backup_pw);
        this.mNewPw = (TextView) findViewById(C1985R$id.new_backup_pw);
        this.mConfirmNewPw = (TextView) findViewById(C1985R$id.confirm_new_backup_pw);
        this.mCancel = (Button) findViewById(C1985R$id.backup_pw_cancel_button);
        this.mSet = (Button) findViewById(C1985R$id.backup_pw_set_button);
