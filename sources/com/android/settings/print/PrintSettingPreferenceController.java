...
public class PrintSettingPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop, PrintManager.PrintJobStateChangeListener {
    ...
    public CharSequence getSummary() {
        ...
        if (i > 0) {
            return this.mContext.getResources().getQuantityString(C1990R$plurals.print_jobs_summary, i, new Object[]{Integer.valueOf(i)});
        }
        List printServices = this.mPrintManager.getPrintServices(1);
        if (printServices == null || printServices.isEmpty()) {
            return this.mContext.getText(C1992R$string.print_settings_summary_no_service);
        }
        int size = printServices.size();
        return this.mContext.getResources().getQuantityString(C1990R$plurals.print_settings_summary, size, new Object[]{Integer.valueOf(size)});
    }
