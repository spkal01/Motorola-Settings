...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener {
    private static final int[] XML_ATTRIBUTES = {C1979R$attr.switchBarMarginStart, C1979R$attr.switchBarMarginEnd, C1979R$attr.switchBarBackgroundColor, C1979R$attr.switchBarBackgroundActivatedColor, C1979R$attr.switchBarRestrictionIcon};
    ...
    public SwitchBar(final Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(C1987R$layout.switch_bar, this);
        setFocusable(true);
        setClickable(true);
        ...
        this.mTextView = (TextView) findViewById(C1985R$id.switch_text);
        this.mSummarySpan = new TextAppearanceSpan(this.mContext, C1993R$style.TextAppearance_Small_SwitchBar);
        ...
        ToggleSwitch toggleSwitch = (ToggleSwitch) findViewById(C1985R$id.switch_widget);
        ...
        setSwitchBarText(C1992R$string.switch_on_text, C1992R$string.switch_off_text);
        addOnSwitchChangeListener(new SwitchBar$$ExternalSyntheticLambda0(this));
        ImageView imageView = (ImageView) findViewById(C1985R$id.restricted_icon);
