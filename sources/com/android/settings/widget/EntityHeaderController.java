...
public class EntityHeaderController {
    ...
    private EntityHeaderController(Activity activity, Fragment fragment, View view) {
        ...
        if (view != null) {
            ...
            this.mHeader = LayoutInflater.from(fragment.getContext()).inflate(C1987R$layout.settings_entity_header, (ViewGroup) null);
        }
    }
    ...
    public View done(Activity activity, boolean z) {
        ImageView imageView = (ImageView) this.mHeader.findViewById(C1985R$id.entity_header_icon);
        if (imageView != null) {
            imageView.setImageDrawable(this.mIcon);
            imageView.setContentDescription(this.mIconContentDescription);
        }
        setText(C1985R$id.entity_header_title, this.mLabel);
        setText(C1985R$id.entity_header_summary, this.mSummary);
        setText(C1985R$id.entity_header_second_summary, this.mSecondSummary);
        if (this.mIsInstantApp) {
            setText(C1985R$id.install_type, this.mHeader.getResources().getString(C1992R$string.install_type_instant));
        }
        if (z) {
            bindHeaderButtons();
        }
    ...
    public EntityHeaderController bindHeaderButtons() {
        bindAppInfoLink(this.mHeader.findViewById(C1985R$id.entity_header_content));
            ...
            if (view == null || (str = this.mPackageName) == null || str.equals("os") || this.mUid == -10000) {
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        AppInfoBase.startAppInfoFragment(AppInfoDashboardFragment.class, C1992R$string.application_info_label, EntityHeaderController.this.mPackageName, EntityHeaderController.this.mUid, EntityHeaderController.this.mFragment, 0, EntityHeaderController.this.mMetricsCategory);
                    }
                });
            }
        }
        ...
        if (imageButton != null) {
            if (i == 0) {
                ...
                if (i == 2) {
                    ...
                    imageButton.setImageResource(17303644);
