...
public final class SlidingTabLayout extends FrameLayout implements View.OnClickListener {
    ...
    public SlidingTabLayout(Context context, AttributeSet attributeSet) {
        ...
        View inflate = from.inflate(C1987R$layout.sliding_tab_indicator_view, this, false);
    ...
    private void populateTabStrip() {
        ...
        while (i < adapter.getCount()) {
            TextView textView = (TextView) this.mLayoutInflater.inflate(C1987R$layout.sliding_tab_title_view, this.mTitleView, false);
