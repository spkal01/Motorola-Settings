...
public class VideoPreference extends Preference {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            if (animationController == null || animationController.getDuration() <= 0) {
                ...
                setVisible(true);
                setLayoutResource(C1987R$layout.video_preference);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (this.mAnimationAvailable) {
            this.mVideo = (TextureView) preferenceViewHolder.findViewById(C1985R$id.video_texture_view);
            this.mPreviewImage = (ImageView) preferenceViewHolder.findViewById(C1985R$id.video_preview_image);
            this.mPlayButton = (ImageView) preferenceViewHolder.findViewById(C1985R$id.video_play_button);
            AspectRatioFrameLayout aspectRatioFrameLayout = (AspectRatioFrameLayout) preferenceViewHolder.findViewById(C1985R$id.video_container);
