...
public class MobileDataSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C1983R$drawable.ic_network_cell);
        String charSequence = this.mContext.getText(C1992R$string.mobile_data_settings_title).toString();
