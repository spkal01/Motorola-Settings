...
public class AutoSelectPreferenceController extends TelephonyTogglePreferenceController implements LifecycleObserver {
    ...
    public void updateState(Preference preference) {
        ...
        if (serviceState == null) {
            ...
            if (this.mOnlyAutoSelectInHome) {
                preference.setSummary((CharSequence) this.mContext.getString(C1992R$string.manual_mode_disallowed_summary, new Object[]{this.mTelephonyManager.getSimOperatorName()}));
            }
        }
    }
    ...
    public AutoSelectPreferenceController init(Lifecycle lifecycle, int i) {
        ...
        this.mOnlyAutoSelectInHome = carrierConfigForSubId != null ? carrierConfigForSubId.getBoolean("only_auto_select_in_home_network") : false;
    ...
    private void showAutoSelectProgressBar() {
        if (this.mProgressDialog == null) {
            ...
            progressDialog.setMessage(this.mContext.getResources().getString(C1992R$string.register_automatically));
