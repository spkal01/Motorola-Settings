...
public class Enhanced4gLteSliceHelper {
    ...
    private CharSequence getEnhanced4glteModeTitle(int i) {
        ...
        CharSequence[] textArray = this.mContext.getResources().getTextArray(C1978R$array.enhanced_4g_lte_mode_title_variant);
        char c2 = 1;
