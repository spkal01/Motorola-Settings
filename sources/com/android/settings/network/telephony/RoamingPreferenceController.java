...
public class RoamingPreferenceController extends TelephonyTogglePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public boolean isDialogNeeded() {
        ...
        if (!isDataRoamingEnabled) {
            return carrierConfigForSubId == null || !carrierConfigForSubId.getBoolean("disable_charge_indication_bool");
        }
        return false;
    }
    ...
    private void showDialog() {
        if (((RoamingDialogFragment) this.mFragmentManager.findFragmentByTag(DIALOG_TAG)) == null) {
