...
public class CarrierPreferenceController extends TelephonyBasePreferenceController {
    ...
    public int getAvailabilityStatus(int i) {
        ...
        return (carrierConfigForSubId == null || !carrierConfigForSubId.getBoolean("carrier_settings_enable_bool") || (!MobileNetworkUtils.isCdmaOptions(this.mContext, i) && !MobileNetworkUtils.isGsmOptions(this.mContext, i))) ? 2 : 0;
    }
    ...
    private Intent getCarrierSettingsActivityIntent(int i) {
        ...
        if (carrierConfigForSubId != null) {
            str = carrierConfigForSubId.getString("carrier_settings_activity_component_name_string", str);
        }
