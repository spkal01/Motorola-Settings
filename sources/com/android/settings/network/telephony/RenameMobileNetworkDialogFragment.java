...
public class RenameMobileNetworkDialogFragment extends InstrumentedDialogFragment {
    ...
    public void onAttach(Context context) {
        ...
        this.mLightDarkMap = ImmutableMap.builder().put(Integer.valueOf(resources.getInteger(C1981R$color.SIM_color_teal)), Integer.valueOf(resources.getInteger(C1981R$color.SIM_dark_mode_color_teal))).put(Integer.valueOf(resources.getInteger(C1981R$color.SIM_color_blue)), Integer.valueOf(resources.getInteger(C1981R$color.SIM_dark_mode_color_blue))).put(Integer.valueOf(resources.getInteger(C1981R$color.SIM_color_indigo)), Integer.valueOf(resources.getInteger(C1981R$color.SIM_dark_mode_color_indigo))).put(Integer.valueOf(resources.getInteger(C1981R$color.SIM_color_purple)), Integer.valueOf(resources.getInteger(C1981R$color.SIM_dark_mode_color_purple))).put(Integer.valueOf(resources.getInteger(C1981R$color.SIM_color_pink)), Integer.valueOf(resources.getInteger(C1981R$color.SIM_dark_mode_color_pink))).put(Integer.valueOf(resources.getInteger(C1981R$color.SIM_color_red)), Integer.valueOf(resources.getInteger(C1981R$color.SIM_dark_mode_color_red))).build();
    }

    public Dialog onCreateDialog(Bundle bundle) {
        this.mColors = getColors();
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        View inflate = ((LayoutInflater) builder.getContext().getSystemService(LayoutInflater.class)).inflate(C1987R$layout.dialog_mobile_network_rename, (ViewGroup) null);
        populateView(inflate);
        builder.setTitle(C1992R$string.mobile_network_sim_name).setView(inflate).setPositiveButton(C1992R$string.mobile_network_sim_name_rename, (DialogInterface.OnClickListener) new RenameMobileNetworkDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
    ...
    public void populateView(View view) {
        ...
        String str;
        this.mNameView = (EditText) view.findViewById(C1985R$id.name_edittext);
        ...
        this.mColorSpinner = (Spinner) view.findViewById(C1985R$id.color_spinner);
        this.mColorSpinner.setAdapter(new ColorAdapter(getContext(), C1987R$layout.dialog_mobile_network_color_picker_item, this.mColors));
        int i = 0;
        int i2 = 0;
        while (true) {
        ...
        TextView textView = (TextView) view.findViewById(C1985R$id.operator_name_value);
        ...
        TextView textView2 = (TextView) view.findViewById(C1985R$id.number_label);
        if (subscriptionInfo.isOpportunistic()) {
            i = 8;
        }
        textView2.setVisibility(i);
        ((TextView) view.findViewById(C1985R$id.number_value)).setText(DeviceInfoUtils.getBidiFormattedPhoneNumber(getContext(), subscriptionInfo));
    }
    ...
    private class ColorAdapter extends ArrayAdapter<Color> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            ((ImageView) view.findViewById(C1985R$id.color_icon)).setImageDrawable(((Color) getItem(i)).getDrawable(z));
            ((TextView) view.findViewById(C1985R$id.color_label)).setText(((Color) getItem(i)).getLabel());
            return view;
        }
    ...
    private Color[] getColors() {
        ...
        int[] intArray = resources.getIntArray(17236206);
        String[] stringArray = resources.getStringArray(C1978R$array.color_picker);
        int dimensionPixelSize = resources.getDimensionPixelSize(C1982R$dimen.color_swatch_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C1982R$dimen.color_swatch_stroke_width);
