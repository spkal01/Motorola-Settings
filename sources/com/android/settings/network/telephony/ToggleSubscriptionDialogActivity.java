...
public class ToggleSubscriptionDialogActivity extends SubscriptionActionDialogActivity implements SidecarFragment.Listener, ConfirmDialogFragment.OnConfirmListener {
        ...
        if (!z && i != 3 && i != 4) {
            ...
            if (i == 2) {
                ...
                if (this.mIsEsimOperation) {
                    showProgressDialog(getString(C1992R$string.sim_action_switch_sub_dialog_progress, new Object[]{SubscriptionUtil.getUniqueSubscriptionDisplayName(this.mSubInfo, (Context) this)}));
                    this.mSwitchToEuiccSubscriptionSidecar.run(this.mSubInfo.getSubscriptionId());
                    return;
                }
                showProgressDialog(getString(C1992R$string.sim_action_enabling_sim_without_carrier_name));
            ...
            showProgressDialog(getString(C1992R$string.privileged_action_disable_sub_dialog_progress));
    ...
    private void handleSwitchToEuiccSubscriptionSidecarStateChange() {
        ...
        if (state == 2) {
            ...
            this.mSwitchToEuiccSubscriptionSidecar.reset();
            dismissProgressDialog();
            showErrorDialog(getString(C1992R$string.privileged_action_disable_fail_title), getString(C1992R$string.privileged_action_disable_fail_text));
        }
    }
    ...
    private void handleSwitchToRemovableSlotSidecarStateChange() {
        ...
        if (state == 2) {
            ...
            this.mSwitchToRemovableSlotSidecar.reset();
            dismissProgressDialog();
            showErrorDialog(getString(C1992R$string.sim_action_enable_sim_fail_title), getString(C1992R$string.sim_action_enable_sim_fail_text));
        }
    }
    ...
    private void handleEnableMultiSimSidecarStateChange() {
        ...
        if (state == 2) {
            ...
            dismissProgressDialog();
            showErrorDialog(getString(C1992R$string.dsds_activation_failure_title), getString(C1992R$string.dsds_activation_failure_body_msg2));
        }
    }
    ...
    private void showEnableDsdsConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 3, getString(C1992R$string.sim_action_enable_dsds_title), getString(C1992R$string.sim_action_enable_dsds_text), getString(C1992R$string.sim_action_yes), getString(C1992R$string.sim_action_no_thanks));
    }

    private void showRebootConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 4, getString(C1992R$string.sim_action_restart_title), getString(C1992R$string.sim_action_enable_dsds_text), getString(C1992R$string.sim_action_reboot), getString(C1992R$string.cancel));
    }
    ...
    private void showDisableSimConfirmDialog() {
        ...
        if (this.mSubInfo == null || TextUtils.isEmpty(uniqueSubscriptionDisplayName)) {
            str = getString(C1992R$string.privileged_action_disable_sub_dialog_title_without_carrier);
        } else {
            str = getString(C1992R$string.privileged_action_disable_sub_dialog_title, new Object[]{uniqueSubscriptionDisplayName});
        }
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 1, str, (String) null, getString(C1992R$string.yes), getString(C1992R$string.cancel));
    }
    ...
    private void showNonSwitchSimConfirmDialog() {
        ConfirmDialogFragment.show(this, ConfirmDialogFragment.OnConfirmListener.class, 2, getEnableSubscriptionTitle(), (String) null, getString(C1992R$string.yes), getString(17039360));
    }

    private String getSwitchDialogPosBtnText() {
        if (!this.mIsEsimOperation) {
            return getString(C1992R$string.sim_switch_button);
        }
        return getString(C1992R$string.sim_action_switch_sub_dialog_confirm, new Object[]{SubscriptionUtil.getUniqueSubscriptionDisplayName(this.mSubInfo, (Context) this)});
    }

    private String getEnableSubscriptionTitle() {
        CharSequence uniqueSubscriptionDisplayName = SubscriptionUtil.getUniqueSubscriptionDisplayName(this.mSubInfo, (Context) this);
        if (this.mSubInfo == null || TextUtils.isEmpty(uniqueSubscriptionDisplayName)) {
            return getString(C1992R$string.sim_action_enable_sub_dialog_title_without_carrier_name);
        }
        return getString(C1992R$string.sim_action_enable_sub_dialog_title, new Object[]{uniqueSubscriptionDisplayName});
    }

    private String getSwitchSubscriptionTitle() {
        if (!this.mIsEsimOperation) {
            return getString(C1992R$string.sim_action_switch_psim_dialog_title);
        }
        return getString(C1992R$string.sim_action_switch_sub_dialog_title, new Object[]{SubscriptionUtil.getUniqueSubscriptionDisplayName(this.mSubInfo, (Context) this)});
    }
    ...
    private String getSwitchDialogBodyMsg(SubscriptionInfo subscriptionInfo, boolean z) {
        ...
        if (z && this.mIsEsimOperation) {
            return getString(C1992R$string.sim_action_switch_sub_dialog_text_downloaded, new Object[]{uniqueSubscriptionDisplayName, uniqueSubscriptionDisplayName2});
        } else if (this.mIsEsimOperation) {
            return getString(C1992R$string.sim_action_switch_sub_dialog_text, new Object[]{uniqueSubscriptionDisplayName, uniqueSubscriptionDisplayName2});
        } else {
            return getString(C1992R$string.sim_action_switch_sub_dialog_text_single_sim, new Object[]{uniqueSubscriptionDisplayName2});
        }
    }
