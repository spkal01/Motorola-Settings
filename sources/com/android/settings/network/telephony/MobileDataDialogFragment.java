...
public class MobileDataDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        int i2 = this.mType;
        if (i2 == 0) {
            return new AlertDialog.Builder(context).setMessage(C1992R$string.data_usage_disable_mobile).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
        }
        if (i2 == 1) {
            ...
            if (activeSubscriptionInfo2 == null) {
                str = getContext().getResources().getString(C1992R$string.sim_selection_required_pref);
            } else {
                str = SubscriptionUtil.getUniqueSubscriptionDisplayName(activeSubscriptionInfo2, getContext()).toString();
            }
            if (activeSubscriptionInfo == null) {
                str2 = getContext().getResources().getString(C1992R$string.sim_selection_required_pref);
            } else {
                str2 = SubscriptionUtil.getUniqueSubscriptionDisplayName(activeSubscriptionInfo, getContext()).toString();
            }
            return new AlertDialog.Builder(context).setTitle((CharSequence) context.getString(C1992R$string.sim_change_data_title, new Object[]{str2})).setMessage((CharSequence) context.getString(C1992R$string.sim_change_data_message, new Object[]{str2, str})).setPositiveButton((CharSequence) context.getString(C1992R$string.sim_change_data_ok, new Object[]{str2}), (DialogInterface.OnClickListener) this).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null).create();
        }
