...
public class DataServiceSetupPreferenceController extends TelephonyBasePreferenceController {
    ...
    public int getAvailabilityStatus(int i) {
        ...
        return (i == -1 || carrierConfigForSubId == null || carrierConfigForSubId.getBoolean("hide_carrier_network_settings_bool") || !this.mTelephonyManager.isLteCdmaEvdoGsmWcdmaEnabled() || TextUtils.isEmpty(this.mSetupUrl)) ? 2 : 0;
    }
