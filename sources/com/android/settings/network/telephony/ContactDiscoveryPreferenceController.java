...
import com.motorola.settings.network.ContactDiscoveryNotification;
...
public class ContactDiscoveryPreferenceController extends TelephonyTogglePreferenceController implements LifecycleObserver {
    ...
    public int getAvailabilityStatus(int i) {
        return MobileNetworkUtils.isContactDiscoveryVisible(this.mContext, i) ? 0 : 2;
    }
    ...
    private void showContentDiscoveryDialog() {
        ...
        ContactDiscoveryNotification.cancelNotification(this.mContext);
    }

    private CharSequence getCarrierDisplayName(Context context) {
        for (SubscriptionInfo next : MotoMnsCache.getIns(context).getAvailableSubInfos()) {
