...
public class ApnPreferenceController extends TelephonyBasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public int getAvailabilityStatus(int i) {
        ...
        boolean z = true;
        boolean z2 = MobileNetworkUtils.isCdmaOptions(this.mContext, i) && carrierConfigForSubId != null && carrierConfigForSubId.getBoolean("show_apn_setting_cdma_bool");
        boolean z3 = MobileNetworkUtils.isGsmOptions(this.mContext, i) && carrierConfigForSubId != null && carrierConfigForSubId.getBoolean("apn_expand_bool");
        if (carrierConfigForSubId != null && !carrierConfigForSubId.getBoolean("hide_carrier_network_settings_bool")) {
            z = false;
        }
        if (z || (!z2 && !z3)) {
            return 2;
