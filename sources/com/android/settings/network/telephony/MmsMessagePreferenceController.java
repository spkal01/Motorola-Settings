...
public class MmsMessagePreferenceController extends TelephonyTogglePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public int getAvailabilityStatus(int i) {
        ...
        if (i == -1 || !isMmsEnabled(i) || createForSubscriptionId.isDataEnabled() || !createForSubscriptionId.isApnMetered(2)) {
            return 2;
        }
        return 0;
    }
    ...
    public boolean isChecked() {
        return this.mMotoExtTm.isMmsDataAlwaysAllowed(this.mSubId);
    }
