...
public class SmsDefaultSubscriptionController extends DefaultSubscriptionController {
    private final boolean mIsAskEverytimeSupported = this.mContext.getResources().getBoolean(17891725);
    ...
    public SubscriptionInfo getDefaultSubscriptionInfo() {
        return MotoMnsCache.getIns(this.mContext).getActiveSubInfo(getDefaultSubscriptionId());
    }
