...
public class Enable2gPreferenceController extends TelephonyTogglePreferenceController {
    ...
    public int getAvailabilityStatus(int i) {
        ...
        if (SubscriptionManager.isUsableSubscriptionId(i) && carrierConfigForSubId != null && !carrierConfigForSubId.getBoolean("hide_enable_2g_bool") && this.mTelephonyManager.isRadioInterfaceCapabilitySupported("CAPABILITY_USES_ALLOWED_NETWORK_TYPES_BITMASK") && !MotoTelephonyFeature.isFtr7454Enabled(this.mContext, i)) {
            return 0;
        }
        return 2;
    }
