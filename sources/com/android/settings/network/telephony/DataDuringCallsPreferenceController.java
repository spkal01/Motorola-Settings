...
public class DataDuringCallsPreferenceController extends TelephonyTogglePreferenceController implements LifecycleObserver, SubscriptionsChangeListener.SubscriptionsChangeListenerClient {
    ...
    public int getAvailabilityStatus(int i) {
        return (!SubscriptionManager.isValidSubscriptionId(i) || SubscriptionManager.getDefaultDataSubscriptionId() == i || !((SubscriptionManager) this.mContext.getSystemService(SubscriptionManager.class)).isActiveSubscriptionId(SubscriptionManager.getDefaultDataSubscriptionId())) ? 2 : 0;
    }
