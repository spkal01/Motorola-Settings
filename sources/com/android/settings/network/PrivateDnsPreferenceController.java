...
public class PrivateDnsPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnStart, OnStop {
    ...
    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(C1980R$bool.config_show_private_dns_settings) ? 0 : 3;
    }
    ...
    public CharSequence getSummary() {
        ...
        if (privateDnsMode == 1) {
            return resources.getString(C1992R$string.private_dns_mode_off);
        }
        if (privateDnsMode != 2) {
            if (privateDnsMode != 3) {
                return "";
            ...
            return resources.getString(C1992R$string.private_dns_mode_provider_failure);
        } else if (z) {
            return resources.getString(C1992R$string.private_dns_mode_on);
        } else {
            return resources.getString(C1992R$string.private_dns_mode_opportunistic);
        }
    }
