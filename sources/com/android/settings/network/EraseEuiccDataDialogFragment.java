...
public class EraseEuiccDataDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setTitle(C1992R$string.reset_esim_title).setMessage(C1992R$string.reset_esim_desc).setPositiveButton(C1992R$string.erase_euicc_data_button, this).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null).setOnDismissListener(this).create();
    }
