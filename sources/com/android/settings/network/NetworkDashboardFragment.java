...
import com.motorola.settings.network.WfcPreferenceController;
...
public class NetworkDashboardFragment extends DashboardFragment implements MobilePlanPreferenceController.MobilePlanPreferenceHost {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.network_and_internet) {
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            if (!Utils.isProviderModelEnabled(context)) {
                return super.getXmlResourcesToIndex(context, z);
            }
            SearchIndexableResource searchIndexableResource = new SearchIndexableResource(context);
            searchIndexableResource.xmlResId = C1994R$xml.network_provider_internet;
    ...
    public int getPreferenceScreenResId() {
        if (Utils.isProviderModelEnabled(getContext())) {
            return C1994R$xml.network_provider_internet;
        }
        return C1994R$xml.network_and_internet;
    }
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_network_dashboard;
    }
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Lifecycle lifecycle, MetricsFeatureProvider metricsFeatureProvider, Fragment fragment, MobilePlanPreferenceController.MobilePlanPreferenceHost mobilePlanPreferenceHost) {
        ...
        arrayList.add(new WfcPreferenceController(context, lifecycle));
        return arrayList;
    }
