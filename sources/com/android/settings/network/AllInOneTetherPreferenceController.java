...
public class AllInOneTetherPreferenceController extends BasePreferenceController implements LifecycleObserver, TetherEnabler.OnTetherStateUpdateListener {
    ...
    public CharSequence getSummary() {
        ...
        switch (i) {
            case 0:
                return this.mContext.getString(C1992R$string.tether_settings_summary_off);
            case 1:
                return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_only);
            case 2:
                return this.mContext.getString(C1992R$string.tether_settings_summary_usb_tethering_only);
            case 3:
                return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_and_usb);
            case 4:
                return this.mContext.getString(C1992R$string.tether_settings_summary_bluetooth_tethering_only);
            case 5:
                return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_and_bluetooth);
            case 6:
                return this.mContext.getString(C1992R$string.tether_settings_summary_usb_and_bluetooth);
            case 7:
                return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_and_usb_and_bluetooth);
            default:
                switch (i) {
                    case 32:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_ethernet_tethering_only);
                    case 33:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_and_ethernet);
                    case 34:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_usb_and_ethernet);
                    case 35:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_and_usb_and_ethernet);
                    case 36:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_bluetooth_and_ethernet);
                    case 37:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_hotspot_and_bluetooth_and_ethernet);
                    case 38:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_usb_and_bluetooth_and_ethernet);
                    case 39:
                        return this.mContext.getString(C1992R$string.tether_settings_summary_all);
                    default:
                        Log.e(TAG, "Unknown tethering state");
                        return this.mContext.getString(C1992R$string.summary_placeholder);
                }
        }
    }
