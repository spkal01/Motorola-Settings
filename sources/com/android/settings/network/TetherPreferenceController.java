...
public class TetherPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnCreate, OnResume, OnPause, OnDestroy {
    ...
    public void updateSummary() {
        ...
        if (this.mPreference != null) {
            ...
            if (!z && !z2) {
                this.mPreference.setSummary(C1992R$string.switch_off_text);
            } else if (z && z2) {
                this.mPreference.setSummary(C1992R$string.tether_settings_summary_hotspot_on_tether_on);
            } else if (z) {
                this.mPreference.setSummary(C1992R$string.tether_settings_summary_hotspot_on_tether_off);
            } else {
                this.mPreference.setSummary(C1992R$string.tether_settings_summary_hotspot_off_tether_on);
            }
        }
    }
    ...
    public void updateSummaryToOff() {
        ...
        if (preference != null) {
            preference.setSummary(C1992R$string.switch_off_text);
        }
    }
