...
import com.motorola.settings.network.MotoSimPreferencesController;
...
public class NetworkProviderCallsSmsFragment extends DashboardFragment {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.network_provider_calls_sms) {
    ...
    public void onAttach(Context context) {
        ...
        Optional.ofNullable((MotoSimPreferencesController) use(MotoSimPreferencesController.class)).ifPresent(new NetworkProviderCallsSmsFragment$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$onAttach$0(MotoSimPreferencesController motoSimPreferencesController) {
        motoSimPreferencesController.init(this);
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.network_provider_calls_sms;
    }
}
