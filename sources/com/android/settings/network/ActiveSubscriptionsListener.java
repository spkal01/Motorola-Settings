...
public abstract class ActiveSubscriptionsListener extends SubscriptionManager.OnSubscriptionsChangedListener implements AutoCloseable {
    ...
    public ActiveSubscriptionsListener(Looper looper, Context context, int i) {
        ...
        this.mSubscriptionChangeIntentFilter.addAction("android.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGED");
        this.mSubscriptionChangeIntentFilter.addAction("android.intent.action.PACKAGE_CHANGED");
    }
            ...
            public void onReceive(Context context, Intent intent) {
                if (!isInitialStickyBroadcast()) {
                    ...
                    if (!TextUtils.isEmpty(action)) {
                        ...
                        ActiveSubscriptionsListener.this.listenerNotify();
                    }
                }
            }
        };
    ...
    private void monitorSubscriptionsChange(boolean z) {
        if (!z) {
            ...
            this.mContext.registerReceiver(this.mSubscriptionChangeReceiver, this.mSubscriptionChangeIntentFilter, (String) null, new Handler(this.mLooper));
