...
public class ApnEditor extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, View.OnKeyListener {
    ...
    public static final String TAG = ApnEditor.class.getSimpleName();
    static final int TYPE_INDEX = 15;
    /* access modifiers changed from: private */
    public static HashMap<String, Integer> sFieldNameToIndexMap = new HashMap<>();
    static String sNotSet;
    private static final String[] sProjection = {"_id", "name", "apn", "proxy", "port", "user", "server", "password", "mmsc", "mcc", "mnc", "numeric", "mmsproxy", "mmsport", "authtype", "type", "protocol", "carrier_enabled", "bearer", "bearer_bitmask", "roaming_protocol", "mvno_type", "mvno_match_data", "edited", "user_editable", "profile_id"};
    ...
    private String[] mDefaultApnValues;
    private boolean mDeletable;
    private boolean mIsHideBearer;
    private boolean mIsHideDelete;
    ...
    static {
        ...
        while (true) {
            ...
            if (i < strArr.length) {
                sFieldNameToIndexMap.put(strArr[i], Integer.valueOf(i));
                i++;
            } else {
                return;
            }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (uri != null) {
            ...
            this.mApnData = new ApnData(sProjection.length, this.mDefaultApnValues);
        }
    ...
    public void fillUI(boolean z) {
        ...
        if (value != null) {
            ...
            this.mAuthType.setSummary(getResources().getStringArray(C1978R$array.apn_auth_entries)[parseInt]);
        } else {
        ...
        if (getResources().getBoolean(C1980R$bool.config_allow_edit_carrier_enabled)) {
    ...
    private String protocolDescription(String str, ListPreference listPreference) {
        ...
        try {
            return String.valueOf(listPreference.getEntries()[findIndexOfValue]);
    ...
    private String bearerMultiDescription(Set<String> set) {
        String[] stringArray = getResources().getStringArray(C1978R$array.bearer_entries);
    ...
    private java.lang.String mvnoDescription(java.lang.String r9) {
        ...
        L_0x0011:
            ...
            int r4 = com.android.settings.C1978R$array.mvno_type_entries
        ...
        L_0x00df:
            ...
            r8.setText(r1)
        L_0x00e4:
            r8 = r3[r0]     // Catch:{ ArrayIndexOutOfBoundsException -> 0x00e7 }
            return r8
        L_0x00e7:
            return r2
        */
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        if (!this.mNewApn && this.mDeletable) {
            menu.add(0, 1, 0, C1992R$string.menu_delete).setIcon(C1983R$drawable.ic_delete);
        }
        if (!this.mReadOnlyApn) {
            menu.add(0, 2, 0, C1992R$string.menu_save).setIcon(17301582);
        }
        menu.add(0, 3, 0, C1992R$string.menu_cancel).setIcon(17301560);
    }
    ...
    public String validateApnData() {
        ...
        if (TextUtils.isEmpty(checkNotSet)) {
            str = getResources().getString(C1992R$string.error_name_empty);
        } else if (TextUtils.isEmpty(checkNotSet2)) {
            str = getResources().getString(C1992R$string.error_apn_empty);
        } else if (checkNotSet3 == null || checkNotSet3.length() != 3) {
            str = getResources().getString(C1992R$string.error_mcc_not3);
        } else if (checkNotSet4 == null || (checkNotSet4.length() & 65534) != 2) {
            str = getResources().getString(C1992R$string.error_mnc_not23);
        } else {
            str = null;
        }
        ...
        return String.format(getResources().getString(C1992R$string.error_adding_apn_type), new Object[]{sb});
    }
    ...
    private String checkNullforMvnoValue(String str) {
        return TextUtils.isEmpty(str) ? getResources().getString(C1992R$string.apn_not_set_for_mvno) : str;
    }
    ...
    private String getEditableApnType(String[] strArr) {
        StringBuilder sb = new StringBuilder();
        List asList = ArrayUtils.isEmpty(this.mReadOnlyApnTypes) ? null : Arrays.asList(this.mReadOnlyApnTypes);
        boolean z = true;
        for (String str : strArr) {
            if ((asList == null || !asList.contains(str)) && !str.equals("ia") && !str.equals("emergency") && !str.equals("mcx")) {
                if (z) {
                    z = false;
                } else {
                    sb.append(",");
    ...
    private void initApnEditorUi() {
        addPreferencesFromResource(C1994R$xml.apn_editor);
        sNotSet = getResources().getString(C1992R$string.apn_not_set);
    ...
    private void getCarrierCustomizedConfig() {
        ...
        this.mIsHideBearer = false;
        this.mIsHideDelete = false;
        this.mDefaultApnValues = null;
        ...
        if (carrierConfigManager != null && (configForSubId = carrierConfigManager.getConfigForSubId(this.mSubId)) != null) {
            ...
            this.mIsHideBearer = configForSubId.getBoolean("hide_bearer_field_for_non_user_edited_apn");
            this.mDefaultApnValues = configForSubId.getStringArray("new_apn_default_value_fields_string_array");
            this.mIsHideDelete = configForSubId.getBoolean("moto_hide_delete_action_for_non_user_deletable_apn");
        }
    }
    ...
    public static class ErrorDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getContext()).setTitle(C1992R$string.error_title).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).setMessage((CharSequence) ((ApnEditor) getTargetFragment()).validateApnData()).create();
        }
    }
    ...
    static class ApnData {
            ...
            if (strArr != null && strArr.length != 0) {
                for (String str : strArr) {
                    ...
                    if (indexOf != -1) {
                        ...
                        Integer num = (Integer) ApnEditor.sFieldNameToIndexMap.get(trim);
                        if (num != null) {
                            this.mData[num.intValue()] = trim2;
                        }
                    }
                }
            }
        ...
        public Integer getInteger(int i) {
            ...
            try {
                ...
                String access$100 = ApnEditor.TAG;
                Log.e(access$100, "Invalid integer at index : " + i, e);
                return null;
            }
        }
    ...
    private boolean isDeletable() {
        ...
        if (!this.mIsHideDelete || (integer = this.mApnData.getInteger(25)) == null || integer.intValue() != 0) {
            return true;
        }
        return false;
    }
