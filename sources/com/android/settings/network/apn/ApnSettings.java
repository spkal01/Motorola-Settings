...
public class ApnSettings extends RestrictedSettingsFragment implements Preference.OnPreferenceChangeListener {
    private static final String[] CARRIERS_PROJECTION = {"_id", "name", "apn", "type", "mvno_type", "mvno_match_data", "edited", "profile_id"};
    ...
    private boolean mAllowResettingApns;
    ...
    private final ContentObserver mObserver = new ContentObserver(new Handler()) {
        public void onChange(boolean z) {
            if (ApnSettings.this.getActivity() != null && !ApnSettings.this.mRestoreDefaultApnMode) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mAllowResettingApns = configForSubId.getBoolean("allow_resetting_apns_bool");
        this.mUserManager = UserManager.get(activity);
    }

    public void onActivityCreated(Bundle bundle) {
        super.onActivityCreated(bundle);
        getEmptyTextView().setText(C1992R$string.apn_settings_not_available);
        boolean isUiRestricted = isUiRestricted();
        this.mUnavailable = isUiRestricted;
        setHasOptionsMenu(!isUiRestricted);
        if (this.mUnavailable) {
            addPreferencesFromResource(C1994R$xml.placeholder_prefs);
        } else {
            addPreferencesFromResource(C1994R$xml.apn_settings);
        }
    }
    ...
    public void onResume() {
        ...
        if (!this.mUnavailable) {
            ...
            getContentResolver().registerContentObserver(Telephony.Carriers.CONTENT_URI, true, this.mObserver);
    ...
    public void fillList() {
        ...
        if (query != null) {
            ...
            while (!query.isAfterLast()) {
                ...
                if (!TextUtils.isEmpty(string4) && !string4.contains("default")) {
                    z = false;
                }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        if (!this.mUnavailable) {
            if (this.mAllowAddingApns) {
                menu.add(0, 1, 0, getResources().getString(C1992R$string.menu_new)).setIcon(C1983R$drawable.ic_add_24dp).setShowAsAction(1);
            }
            if (this.mAllowResettingApns) {
                menu.add(0, 2, 0, getResources().getString(C1992R$string.menu_restore)).setIcon(17301589);
            }
        }
    ...
    private class RestoreApnUiHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what == 2) {
                ...
                Toast.makeText(activity, ApnSettings.this.getResources().getString(C1992R$string.restore_default_apn_completed), 1).show();
            }
        }
    }
    ...
    private class RestoreApnProcessHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                if (i2 >= 10 || ApnSettings.this.getSelectedApnKey() != null) {
                    this.retryCounter = 0;
    ...
    public Dialog onCreateDialog(int i) {
        ...
        C10684 r2 = new ProgressDialog(getActivity()) {
            public boolean onTouchEvent(MotionEvent motionEvent) {
                return true;
            }
        };
        r2.setMessage(getResources().getString(C1992R$string.restore_default_apn));
