...
public class NightDisplayAutoModePreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        dropDownPreference.setEntries(new CharSequence[]{this.mContext.getString(C1992R$string.night_display_auto_mode_never), this.mContext.getString(C1992R$string.night_display_auto_mode_custom), this.mContext.getString(C1992R$string.night_display_auto_mode_twilight)});
