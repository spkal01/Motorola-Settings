...
public class ScreenTimeoutPreferenceController extends BasePreferenceController {
    ...
    public ScreenTimeoutPreferenceController(Context context, String str) {
        super(context, str);
        this.mTimeoutEntries = context.getResources().getStringArray(C1978R$array.screen_timeout_entries);
        this.mTimeoutValues = context.getResources().getStringArray(C1978R$array.screen_timeout_values);
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (preferenceDisablingAdmin != null) {
            ...
            preference.setSummary(this.mContext.getText(C1992R$string.disabled_by_policy_title));
    ...
    private CharSequence getTimeoutSummary(long j) {
        ...
        return this.mContext.getString(C1992R$string.screen_timeout_summary, new Object[]{timeoutDescription});
    }
