...
public class SmartAutoRotateBatterySaverController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        ((BannerMessagePreference) findPreference).setPositiveButtonText(C1992R$string.ambient_camera_battery_saver_off).setPositiveButtonOnClickListener(new SmartAutoRotateBatterySaverController$$ExternalSyntheticLambda0(this));
    }
