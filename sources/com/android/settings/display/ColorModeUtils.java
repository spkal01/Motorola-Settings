...
final class ColorModeUtils {
    static Map<Integer, String> getColorModeMapping(Resources resources) {
        String[] stringArray = resources.getStringArray(C1978R$array.config_color_mode_options_strings);
        int[] intArray = resources.getIntArray(C1978R$array.config_color_mode_options_values);
