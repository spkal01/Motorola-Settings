...
public class SmartAutoRotateCameraStateController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        ((BannerMessagePreference) findPreference).setPositiveButtonText(C1992R$string.allow).setPositiveButtonOnClickListener(new SmartAutoRotateCameraStateController$$ExternalSyntheticLambda1(this));
    }
