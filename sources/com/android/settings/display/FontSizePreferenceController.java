...
public class FontSizePreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        return resources.getStringArray(C1978R$array.entries_font_size)[ToggleFontSizePreferenceFragment.fontSizeValueToIndex(f, resources.getStringArray(C1978R$array.entryvalues_font_size))];
    }
}
