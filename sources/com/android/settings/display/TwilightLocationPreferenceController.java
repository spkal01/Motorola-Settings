...
public class TwilightLocationPreferenceController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        bannerMessagePreference.setPositiveButtonText(C1992R$string.twilight_mode_launch_location).setPositiveButtonOnClickListener(new TwilightLocationPreferenceController$$ExternalSyntheticLambda0(this, bannerMessagePreference));
    }
