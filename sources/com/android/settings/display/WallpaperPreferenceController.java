...
public class WallpaperPreferenceController extends BasePreferenceController {
    ...
    private final String mStylesAndWallpaperClass = this.mContext.getString(C1992R$string.config_styles_and_wallpaper_picker_class);
    private final String mWallpaperClass = this.mContext.getString(C1992R$string.config_wallpaper_picker_class);
    private final String mWallpaperLaunchExtra = this.mContext.getString(C1992R$string.config_wallpaper_picker_launch_extra);
    private final String mWallpaperPackage = this.mContext.getString(C1992R$string.config_wallpaper_picker_package);
    ...
    public String getTitle() {
        return this.mContext.getString(areStylesAvailable() ? C1992R$string.style_and_wallpaper_settings_title : C1992R$string.wallpaper_settings_title);
    }
    ...
    public String getKeywords() {
        StringBuilder sb = new StringBuilder(this.mContext.getString(C1992R$string.keywords_wallpaper));
        if (areStylesAvailable()) {
            sb.append(", ");
            sb.append(this.mContext.getString(C1992R$string.keywords_styles));
        }
        return sb.toString();
    }
