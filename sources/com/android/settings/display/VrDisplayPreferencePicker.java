...
public class VrDisplayPreferencePicker extends RadioButtonPickerFragment {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.vr_display_settings;
    }
    ...
    public List<VrCandidateInfo> getCandidates() {
        ...
        arrayList.add(new VrCandidateInfo(context, 0, C1992R$string.display_vr_pref_low_persistence));
        arrayList.add(new VrCandidateInfo(context, 1, C1992R$string.display_vr_pref_off));
        return arrayList;
    }
