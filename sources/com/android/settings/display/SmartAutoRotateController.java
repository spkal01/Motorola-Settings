...
public class SmartAutoRotateController extends TogglePreferenceController implements LifecycleObserver {
    ...
    public boolean isChecked() {
        if (RotationPolicy.isRotationLocked(this.mContext) || !hasSufficientPermission(this.mContext) || isCameraLocked() || isPowerSaveMode() || Settings.Secure.getInt(this.mContext.getContentResolver(), "camera_autorotate", 0) != 1) {
            return false;
        }
        return true;
    }
