...
public class NightDisplayPreferenceController extends TogglePreferenceController implements NightDisplayListener.Callback, LifecycleObserver, OnStart, OnStop {
    ...
    public static boolean isSuggestionComplete(Context context) {
        if (context.getResources().getBoolean(C1980R$bool.config_night_light_suggestion_enabled) && ((ColorDisplayManager) context.getSystemService(ColorDisplayManager.class)).getNightDisplayAutoMode() == 0) {
            return false;
        }
        return true;
    }
