...
public class NightDisplaySettings extends DashboardFragment implements NightDisplayListener.Callback {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.night_display_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.night_display_settings;
    }

    public int getHelpResource() {
        return C1992R$string.help_url_night_display;
    }
}
