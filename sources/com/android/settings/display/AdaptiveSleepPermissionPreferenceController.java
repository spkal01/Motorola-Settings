...
public class AdaptiveSleepPermissionPreferenceController {
    ...
    private void initializePreference() {
        if (this.mPreference == null) {
            ...
            bannerMessagePreference.setTitle(C1992R$string.adaptive_sleep_title_no_permission);
            this.mPreference.setSummary(C1992R$string.adaptive_sleep_summary_no_permission);
            this.mPreference.setPositiveButtonText(C1992R$string.adaptive_sleep_manage_permission_button);
            this.mPreference.setPositiveButtonOnClickListener(new C0897x32d3df96(this, intent));
        }
    }
