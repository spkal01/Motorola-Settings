...
public class ScreenTimeoutSettings extends RadioButtonPickerFragment implements HelpResourceProvider {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.screen_timeout_settings) {
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean z) {
            ...
            int i = C1992R$string.adaptive_sleep_title;
    ...
    public void onAttach(Context context) {
        ...
        this.mInitialEntries = getResources().getStringArray(C1978R$array.screen_timeout_entries);
        this.mInitialValues = getResources().getStringArray(C1978R$array.screen_timeout_values);
        ...
        footerPreference.setIcon(C1983R$drawable.ic_privacy_shield_24dp);
        this.mPrivacyPreference.setTitle(C1992R$string.adaptive_sleep_privacy);
        this.mPrivacyPreference.setSelectable(false);
        this.mPrivacyPreference.setLayoutResource(C1987R$layout.preference_footer);
    ...
    public void setupDisabledFooterPreference() {
        String string = getResources().getString(C1992R$string.admin_disabled_other_options);
        String string2 = getResources().getString(C1992R$string.admin_more_details);
        SpannableString spannableString = new SpannableString(string + System.lineSeparator() + System.lineSeparator() + string2);
        C09142 r3 = new ClickableSpan() {
        ...
        footerPreference.setLayoutResource(C1987R$layout.preference_footer);
        this.mDisableOptionsPreference.setTitle((CharSequence) spannableString);
        this.mDisableOptionsPreference.setSelectable(false);
        this.mDisableOptionsPreference.setIcon(C1983R$drawable.ic_info_outline_24dp);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.screen_timeout_settings;
    }

    public int getHelpResource() {
        return C1992R$string.help_url_adaptive_sleep;
    }
