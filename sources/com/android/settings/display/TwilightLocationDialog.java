...
public class TwilightLocationDialog {
    ...
    public static void show(Context context) {
        new AlertDialog.Builder(context).setPositiveButton(C1992R$string.twilight_mode_launch_location, new TwilightLocationDialog$$ExternalSyntheticLambda0(context)).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null).setMessage(C1992R$string.twilight_mode_location_off_dialog_message).create().show();
    }
