...
public class ColorModePreferenceFragment extends RadioButtonPickerFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.color_mode_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.color_mode_settings;
    }
    ...
    public void addStaticPreferences(PreferenceScreen preferenceScreen) {
        configureAndInstallPreview(new LayoutPreference(preferenceScreen.getContext(), C1987R$layout.color_mode_preview), preferenceScreen);
    }
    ...
    public List<? extends CandidateInfo> getCandidates() {
        ...
        for (int i : this.mResources.getIntArray(17236004)) {
