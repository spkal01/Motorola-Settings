...
public class DarkModeSettingsFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.dark_mode_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.dark_mode_settings;
    }

    public int getHelpResource() {
        return C1992R$string.help_url_dark_theme;
    }
}
