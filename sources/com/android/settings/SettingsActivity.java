...
public class SettingsActivity extends SettingsBaseActivity implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceFragmentCompat.OnPreferenceStartFragmentCallback, ButtonBarHandler, FragmentManager.OnBackStackChangedListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (((this instanceof SubSettings) || intent.getBooleanExtra(":settings:show_fragment_as_subsetting", false)) && !WizardManagerHelper.isAnySetupWizard(getIntent())) {
            setTheme(C1993R$style.Theme_SubSettings);
            SettingsBaseEndlessLayoutMixin.applyTheme(this);
        }
        setContentView(C1987R$layout.settings_main_prefs);
        ...
        SettingsMainSwitchBar settingsMainSwitchBar = (SettingsMainSwitchBar) findViewById(C1985R$id.switch_bar);
        this.mMainSwitch = settingsMainSwitchBar;
        if (settingsMainSwitchBar != null) {
            settingsMainSwitchBar.setMetricsTag(getMetricsTag());
            this.mMainSwitch.setTranslationZ(findViewById(C1985R$id.main_content).getTranslationZ() + 1.0f);
        }
        if (intent.getBooleanExtra("extra_prefs_show_button_bar", false) && (findViewById = findViewById(C1985R$id.button_bar)) != null) {
            findViewById.setVisibility(0);
            Button button = (Button) findViewById(C1985R$id.back_button);
            button.setOnClickListener(new SettingsActivity$$ExternalSyntheticLambda0(this));
            Button button2 = (Button) findViewById(C1985R$id.skip_button);
            button2.setOnClickListener(new SettingsActivity$$ExternalSyntheticLambda2(this));
            Button button3 = (Button) findViewById(C1985R$id.next_button);
    ...
    public void launchSettingFragment(String str, Intent intent) {
        ...
        this.mInitialTitleResId = C1992R$string.dashboard_title;
    ...
    public void setTaskDescription(ActivityManager.TaskDescription taskDescription) {
        taskDescription.setIcon(Icon.createWithResource(this, C1983R$drawable.ic_launcher_settings));
    ...
    private void switchToFragment(String str, Bundle bundle, boolean z, int i, CharSequence charSequence) {
        ...
        if (!z || isValidFragment(str)) {
            ...
            if (targetFragment != null) {
                ...
                beginTransaction.replace(C1985R$id.main_content, targetFragment);
                if (i > 0) {
