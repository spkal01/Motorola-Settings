...
public class AutomaticStorageManagerSettings extends DashboardFragment implements Preference.OnPreferenceChangeListener {
    ...
    private void initializeDaysToRetainPreference() {
        ...
        String[] stringArray = getResources().getStringArray(C1978R$array.automatic_storage_management_days_values);
    ...
    private void initializeSwitchBar() {
        ...
        switchBar.setTitle(getContext().getString(C1992R$string.automatic_storage_manager_primary_switch_title));
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.automatic_storage_management_settings;
    }
    ...
    public int getHelpResource() {
        return C1992R$string.help_uri_storage;
    }
