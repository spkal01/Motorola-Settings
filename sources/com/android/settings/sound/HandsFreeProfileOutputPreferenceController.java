...
public class HandsFreeProfileOutputPreferenceController extends AudioSwitchPreferenceController implements Preference.OnPreferenceChangeListener {
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        CharSequence text = this.mContext.getText(C1992R$string.media_output_default_summary);
    ...
    public void updateState(Preference preference) {
        if (preference != null) {
            if (!Utils.isAudioModeOngoingCall(this.mContext)) {
                ...
                preference.setSummary(this.mContext.getText(C1992R$string.media_output_default_summary));
                return;
            }
