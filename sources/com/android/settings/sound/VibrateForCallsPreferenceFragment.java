...
public class VibrateForCallsPreferenceFragment extends RadioButtonPickerFragment {
    ...
    private void loadCandidates(Context context) {
        this.mCandidates.put(KEY_NEVER_VIBRATE, new VibrateForCallsCandidateInfo(KEY_NEVER_VIBRATE, C1992R$string.vibrate_when_ringing_option_never_vibrate));
        this.mCandidates.put(KEY_ALWAYS_VIBRATE, new VibrateForCallsCandidateInfo(KEY_ALWAYS_VIBRATE, C1992R$string.vibrate_when_ringing_option_always_vibrate));
        this.mCandidates.put(KEY_RAMPING_RINGER, new VibrateForCallsCandidateInfo(KEY_RAMPING_RINGER, C1992R$string.vibrate_when_ringing_option_ramping_ringer));
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.vibrate_for_calls_settings;
    }
