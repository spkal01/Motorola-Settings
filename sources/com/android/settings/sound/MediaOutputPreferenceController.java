    ...
    public void updateState(Preference preference) {
        ...
        if (preference != null && this.mMediaController != null) {
            if (Utils.isAudioModeOngoingCall(this.mContext)) {
                ...
                preference.setSummary(this.mContext.getText(C1992R$string.media_out_summary_ongoing_call_state));
                return;
            }
            ...
            preference2.setTitle((CharSequence) context.getString(C1992R$string.media_output_label_title, new Object[]{com.android.settings.Utils.getApplicationLabel(context, this.mMediaController.getPackageName())}));
            Preference preference3 = this.mPreference;
            if (bluetoothDevice == null) {
                charSequence = this.mContext.getText(C1992R$string.media_output_default_summary);
            } else {
