...
public class VibrateForCallsPreferenceController extends BasePreferenceController {
    ...
    /* renamed from: ON */
    private static final int f137ON = 1;
    ...
    public CharSequence getSummary() {
        if (Settings.Global.getInt(this.mContext.getContentResolver(), "apply_ramping_ringer", 0) == 1) {
            return this.mContext.getText(C1992R$string.vibrate_when_ringing_option_ramping_ringer);
        }
        if (Settings.System.getInt(this.mContext.getContentResolver(), "vibrate_when_ringing", 0) == 1) {
            return this.mContext.getText(C1992R$string.vibrate_when_ringing_option_always_vibrate);
        }
        return this.mContext.getText(C1992R$string.vibrate_when_ringing_option_never_vibrate);
    }
}
