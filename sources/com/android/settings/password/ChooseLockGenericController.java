...
public class ChooseLockGenericController {
    ...
    public boolean isScreenLockVisible(ScreenLockType screenLockType) {
        ...
        switch (C12161.$SwitchMap$com$android$settings$password$ScreenLockType[screenLockType.ordinal()]) {
            case 1:
                if (this.mHideInsecureScreenLockTypes || this.mContext.getResources().getBoolean(C1980R$bool.config_hide_none_security_option) || isManagedProfile) {
                    return false;
                }
                return true;
            case 2:
                if (this.mHideInsecureScreenLockTypes || this.mContext.getResources().getBoolean(C1980R$bool.config_hide_swipe_security_option) || isManagedProfile) {
                    return false;
                }
                return true;
            case 3:
    ...
    static /* synthetic */ class C12161 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.password.ChooseLockGenericController.C12161.<clinit>():void");
        }
    }
    ...
    public CharSequence getTitle(ScreenLockType screenLockType) {
        switch (C12161.$SwitchMap$com$android$settings$password$ScreenLockType[screenLockType.ordinal()]) {
            case 1:
                return this.mContext.getText(C1992R$string.unlock_set_unlock_off_title);
            case 2:
                return this.mContext.getText(C1992R$string.unlock_set_unlock_none_title);
            case 3:
                return this.mManagedPasswordProvider.getPickerOptionTitle(false);
            case 4:
                return this.mContext.getText(C1992R$string.unlock_set_unlock_pin_title);
            case 5:
                return this.mContext.getText(C1992R$string.unlock_set_unlock_pattern_title);
            case 6:
                return this.mContext.getText(C1992R$string.unlock_set_unlock_password_title);
            default:
                return null;
        }
    }
