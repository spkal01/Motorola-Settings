...
public class ConfirmLockPattern extends ConfirmDeviceCredentialBaseActivity {
    ...
    public static class ConfirmLockPatternFragment extends ConfirmDeviceCredentialBaseFragment implements AppearAnimationCreator<Object>, CredentialCheckResultTracker.Listener {
        ...
        private LockPatternView.OnPatternListener mConfirmExistingLockPatternListener = new LockPatternView.OnPatternListener() {
            ...
            private void startVerifyPattern(LockscreenCredential lockscreenCredential, Intent intent, int i) {
                ...
                C1247x7a417012 confirmLockPattern$ConfirmLockPatternFragment$3$$ExternalSyntheticLambda0 = new C1247x7a417012(this, i, intent, i2);
                if (i2 == i3) {
            ...
            private void startCheckPattern(final LockscreenCredential lockscreenCredential, final Intent intent) {
                ...
                AsyncTask unused = confirmLockPatternFragment2.mPendingLockCheck = LockPatternChecker.checkCredential(confirmLockPatternFragment2.mLockPatternUtils, lockscreenCredential, i, new LockPatternChecker.OnCheckCallback() {
                    public void onChecked(boolean z, int i) {
                        AsyncTask unused = ConfirmLockPatternFragment.this.mPendingLockCheck = null;
                        if (z && C12433.this.isInternalActivity() && ConfirmLockPatternFragment.this.mReturnCredentials) {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            if (((ConfirmLockPattern) getActivity()).getConfirmCredentialTheme() == ConfirmDeviceCredentialBaseActivity.ConfirmCredentialTheme.NORMAL) {
                i = C1987R$layout.confirm_lock_pattern_normal;
            } else {
                i = C1987R$layout.confirm_lock_pattern;
            }
            View inflate = layoutInflater.inflate(i, viewGroup, false);
            this.mGlifLayout = (GlifLayout) inflate.findViewById(C1985R$id.setup_wizard_layout);
            this.mLockPatternView = inflate.findViewById(C1985R$id.lockPattern);
            ...
            inflate.findViewById(C1985R$id.topLayout).setDefaultTouchRecepient(this.mLockPatternView);
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            if (button != null) {
                button.setText(C1992R$string.lockpassword_forgot_pattern);
            }
        }
        ...
        private int getDefaultDetails() {
            if (this.mFrp) {
                return C1992R$string.lockpassword_confirm_your_pattern_details_frp;
            }
            boolean isStrongAuthRequired = isStrongAuthRequired();
            if (this.mIsManagedProfile) {
                if (isStrongAuthRequired) {
                    return C1992R$string.lockpassword_strong_auth_required_work_pattern;
                }
                return C1992R$string.lockpassword_confirm_your_pattern_generic_profile;
            } else if (isStrongAuthRequired) {
                return C1992R$string.lockpassword_strong_auth_required_device_pattern;
            } else {
                return C1992R$string.lockpassword_confirm_your_pattern_generic;
            }
        }
        ...
        public void updateStage(Stage stage) {
            int i = C12401.f131xec47707f[stage.ordinal()];
            if (i == 1) {
                ...
                showError(C1992R$string.lockpattern_need_to_unlock_wrong, 3000);
        ...
        private int getDefaultHeader() {
            if (this.mFrp) {
                return C1992R$string.lockpassword_confirm_your_pattern_header_frp;
            }
            if (this.mIsPrivacyUser) {
                return C1992R$string.lockpassword_confirm_privacy_space_pattern_header;
            }
            if (this.mIsCreatePrivacySpace) {
                return C1992R$string.lockpassword_confirm_main_space_pattern_header;
            }
            if (this.mIsManagedProfile) {
                return C1992R$string.lockpassword_confirm_your_work_pattern_header;
            }
            return C1992R$string.lockpassword_confirm_your_pattern_header;
        }
            ...
            if (!this.mDisappearing) {
                ...
                if (confirmLockPattern != null && !confirmLockPattern.isFinishing()) {
                    if (confirmLockPattern.getConfirmCredentialTheme() == ConfirmDeviceCredentialBaseActivity.ConfirmCredentialTheme.DARK) {
                        this.mLockPatternView.clearPattern();
                        this.mDisappearAnimationUtils.startAnimation2d(getActiveViews(), new C1246x3615d43(confirmLockPattern, intent), this);
                        return;
                    }
        ...
        public static /* synthetic */ void lambda$startDisappearAnimation$0(ConfirmLockPattern confirmLockPattern, Intent intent) {
            confirmLockPattern.setResult(-1, intent);
            confirmLockPattern.finish();
            confirmLockPattern.overridePendingTransition(C1977R$anim.confirm_credential_close_enter, C1977R$anim.confirm_credential_close_exit);
        }
        ...
        public int getLastTryErrorMessage(int i) {
            if (i == 1) {
                return C1992R$string.lock_last_pattern_attempt_before_wipe_device;
            }
            if (i == 2) {
                return C1992R$string.lock_last_pattern_attempt_before_wipe_profile;
            }
            if (i == 3) {
                return C1992R$string.lock_last_pattern_attempt_before_wipe_user;
            }
        ...
        private void handleAttemptLockout(long j) {
            ...
            this.mCountdownTimer = new CountDownTimer(j - SystemClock.elapsedRealtime(), 1000) {
                public void onTick(long j) {
                    ConfirmLockPatternFragment confirmLockPatternFragment = ConfirmLockPatternFragment.this;
                    confirmLockPatternFragment.mErrorTextView.setText(confirmLockPatternFragment.getString(C1992R$string.lockpattern_too_many_failed_confirmation_attempts, Integer.valueOf((int) (j / 1000))));
                }
    ...
    static /* synthetic */ class C12401 {
        ...
        static final /* synthetic */ int[] f131xec47707f;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f131xec47707f     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f131xec47707f     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.password.ConfirmLockPattern.C12401.<clinit>():void");
        }
    }
}
