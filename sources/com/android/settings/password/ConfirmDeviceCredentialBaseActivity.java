...
public abstract class ConfirmDeviceCredentialBaseActivity extends SettingsSetUpActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (UserManager.get(this).isManagedProfile(Utils.getCredentialOwnerUserId(this, Utils.getUserIdFromBundle(this, getIntent().getExtras(), isInternalActivity())))) {
                ...
                setTheme(C1993R$style.Theme_ConfirmDeviceCredentialsDark);
    ...
    public void finish() {
        ...
        if (getIntent().getBooleanExtra("com.android.settings.ConfirmCredentials.useFadeAnimation", false)) {
            overridePendingTransition(0, C1977R$anim.confirm_credential_biometric_transition_exit);
        }
    }
