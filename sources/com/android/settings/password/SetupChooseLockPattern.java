...
public class SetupChooseLockPattern extends ChooseLockPattern {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(C1992R$string.lockpassword_choose_your_pattern_header);
    }
    ...
    public static class SetupChooseLockPatternFragment extends ChooseLockPattern.ChooseLockPatternFragment implements ChooseLockTypeDialogFragment.OnLockTypeSelectedListener {
        ...
        public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            ...
            if (!getResources().getBoolean(C1980R$bool.config_lock_pattern_minimal_ui)) {
                Button button = (Button) onCreateView.findViewById(C1985R$id.screen_lock_options);
                this.mOptionsButton = button;
                button.setOnClickListener(new C1252xdafa044(this));
            }
            this.mSkipOrClearButton.setOnClickListener(new C1251xdafa043(this));
            return onCreateView;
        }
        ...
        public void updateStage(ChooseLockPattern.ChooseLockPatternFragment.Stage stage) {
            ...
            if (!getResources().getBoolean(C1980R$bool.config_lock_pattern_minimal_ui) && (button = this.mOptionsButton) != null) {
            ...
            if (stage.leftMode == ChooseLockPattern.ChooseLockPatternFragment.LeftButtonMode.Gone && stage == ChooseLockPattern.ChooseLockPatternFragment.Stage.Introduction) {
                ...
                this.mSkipOrClearButton.setText(getActivity(), C1992R$string.skip_label);
