...
public class ChooseLockTypeDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setTitle(C1992R$string.setup_lock_settings_options_dialog_title);
    ...
    private static class ScreenLockAdapter extends ArrayAdapter<ScreenLockType> {
        ...
        ScreenLockAdapter(Context context, List<ScreenLockType> list, ChooseLockGenericController chooseLockGenericController) {
            super(context, C1987R$layout.choose_lock_dialog_item, list);
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = LayoutInflater.from(context).inflate(C1987R$layout.choose_lock_dialog_item, viewGroup, false);
            }
        ...
        private static Drawable getIconForScreenLock(Context context, ScreenLockType screenLockType) {
            int i = C12301.$SwitchMap$com$android$settings$password$ScreenLockType[screenLockType.ordinal()];
            if (i == 1) {
                return context.getDrawable(C1983R$drawable.ic_pattern);
            }
            if (i == 2) {
                return context.getDrawable(C1983R$drawable.ic_pin);
            }
            if (i != 3) {
                return null;
            }
            return context.getDrawable(C1983R$drawable.ic_password);
        }
    }
    ...
    static /* synthetic */ class C12301 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.password.ChooseLockTypeDialogFragment.C12301.<clinit>():void");
        }
    }
}
