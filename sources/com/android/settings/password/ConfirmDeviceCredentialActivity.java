    ...
    private String getTitleFromCredentialType(int i, boolean z) {
        if (i != 1) {
            if (i != 3) {
                ...
                if (z) {
                    return getString(C1992R$string.lockpassword_confirm_your_work_password_header);
                }
                return getString(C1992R$string.lockpassword_confirm_your_password_header);
            } else if (z) {
                return getString(C1992R$string.lockpassword_confirm_your_work_pin_header);
            } else {
                return getString(C1992R$string.lockpassword_confirm_your_pin_header);
            }
        } else if (z) {
            return getString(C1992R$string.lockpassword_confirm_your_work_pattern_header);
        } else {
            return getString(C1992R$string.lockpassword_confirm_your_pattern_header);
        }
    }
    ...
    private String getDetailsFromCredentialType(int i, boolean z) {
        if (i != 1) {
            if (i != 3) {
                ...
                if (z) {
                    return getString(C1992R$string.lockpassword_confirm_your_password_generic_profile);
                }
                return getString(C1992R$string.lockpassword_confirm_your_password_generic);
            } else if (z) {
                return getString(C1992R$string.lockpassword_confirm_your_pin_generic_profile);
            } else {
                return getString(C1992R$string.lockpassword_confirm_your_pin_generic);
            }
        } else if (z) {
            return getString(C1992R$string.lockpassword_confirm_your_pattern_generic_profile);
        } else {
            return getString(C1992R$string.lockpassword_confirm_your_pattern_generic);
        }
    }
