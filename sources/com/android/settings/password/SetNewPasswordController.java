...
final class SetNewPasswordController {
    ...
    public static SetNewPasswordController create(Context context, C1249Ui ui, Intent intent, IBinder iBinder) {
        int i;
    ...
    SetNewPasswordController(int i, PackageManager packageManager, FingerprintManager fingerprintManager, FaceManager faceManager, DevicePolicyManager devicePolicyManager, C1249Ui ui) {
        ...
        this.mUi = (C1249Ui) Preconditions.checkNotNull(ui);
    }
