...
public class SetupChooseLockPassword extends ChooseLockPassword {
    ...
    public static class SetupChooseLockPasswordFragment extends ChooseLockPassword.ChooseLockPasswordFragment implements ChooseLockTypeDialogFragment.OnLockTypeSelectedListener {
        ...
        public void onViewCreated(View view, Bundle bundle) {
            ...
            if (booleanExtra && z) {
                Button button = (Button) view.findViewById(C1985R$id.screen_lock_options);
                this.mOptionsButton = button;
                button.setVisibility(0);
                this.mOptionsButton.setOnClickListener(new C1250x8037cc4f(this));
            }
        }
        ...
        public void updateUi() {
            ...
            if (stage == stage2) {
                ...
                this.mSkipOrClearButton.setText(getActivity(), C1992R$string.lockpassword_clear_label);
