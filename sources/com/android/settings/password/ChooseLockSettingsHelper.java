...
public final class ChooseLockSettingsHelper {
    ...
    public static class Builder {
        ...
        /* access modifiers changed from: private */
        public boolean mIsCreatePrivacySpace;
        /* access modifiers changed from: private */
        ...
        public Builder(Activity activity) {
            this.mIsCreatePrivacySpace = false;
            this.mActivity = activity;
        ...
        public Builder setIsCreatePrivacySpace(boolean z) {
            this.mIsCreatePrivacySpace = z;
            return this;
        }
    ...
    public boolean launch() {
        int access$100 = this.mBuilder.mRequestCode;
        CharSequence access$200 = this.mBuilder.mTitle;
        CharSequence access$300 = this.mBuilder.mHeader;
        CharSequence access$400 = this.mBuilder.mDescription;
        boolean access$500 = this.mBuilder.mReturnCredentials;
        boolean access$600 = this.mBuilder.mExternal;
        boolean access$700 = this.mBuilder.mForceVerifyPath;
        int access$800 = this.mBuilder.mUserId;
        CharSequence access$900 = this.mBuilder.mAlternateButton;
        boolean access$1000 = this.mBuilder.mAllowAnyUserId;
        boolean access$1100 = this.mBuilder.mForegroundOnly;
        Builder builder = this.mBuilder;
        return launchConfirmationActivity(access$100, access$200, access$300, access$400, access$500, access$600, access$700, access$800, access$900, access$1000, access$1100, builder.mRequestGatekeeperPasswordHandle, builder.mIsCreatePrivacySpace);
    }

    private boolean launchConfirmationActivity(int i, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, boolean z, boolean z2, boolean z3, int i2, CharSequence charSequence4, boolean z4, boolean z5, boolean z6, boolean z7) {
        Class cls;
        Class cls2;
        ...
        if (keyguardStoredPasswordQuality == 65536) {
            ...
            return launchConfirmationActivity(i, charSequence, charSequence2, charSequence3, cls, z, z2, z3, i2, charSequence4, z4, z5, z6, z7);
            ...
            return launchConfirmationActivity(i, charSequence, charSequence2, charSequence3, cls2, z, z2, z3, i2, charSequence4, z4, z5, z6, z7);
        }
    }

    private boolean launchConfirmationActivity(int i, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, Class<?> cls, boolean z, boolean z2, boolean z3, int i2, CharSequence charSequence4, boolean z4, boolean z5, boolean z6, boolean z7) {
        Intent intent;
        int i3 = i;
        boolean z8 = z2;
        ...
        intent2.putExtra("setting_from_privacy_space", z7);
