...
public class PaymentSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.nfc_payment_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.nfc_payment_settings;
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (isShowEmptyImage(getPreferenceScreen())) {
            ((ViewGroup) view.findViewById(16908351)).addView(getActivity().getLayoutInflater().inflate(C1987R$layout.nfc_payment_empty, (ViewGroup) null, false));
        }
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        MenuItem add = menu.add(C1992R$string.nfc_payment_how_it_works);
