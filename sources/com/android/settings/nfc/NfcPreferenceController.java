...
public class NfcPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnResume, OnPause, OnMainSwitchChangeListener {
    ...
    private boolean hasConfigNFCRestriction() throws NullPointerException {
        ...
        if (devicePolicyManager != null && devicePolicyManager.isDeviceManaged()) {
            ...
            if (motoDevicePolicyManager == null) {
                Log.e(TAG, "MotoDevicePolicyManager not found.");
                return false;
            } else if (motoDevicePolicyManager.hasUserRestriction("no_state_change_nfc")) {
                Intent createMotoAdminSupportIntent = motoDevicePolicyManager.createMotoAdminSupportIntent("no_state_change_nfc");
                if (createMotoAdminSupportIntent == null) {
                    return true;
                }
                this.mContext.startActivity(createMotoAdminSupportIntent);
                return true;
            }
        }
        return false;
