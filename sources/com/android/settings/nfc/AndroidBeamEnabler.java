...
public class AndroidBeamEnabler extends BaseNfcEnabler {
    ...
    public void handleNfcStateChanged(int i) {
        if (i == 1) {
            ...
            this.mPreference.setSummary(C1992R$string.nfc_disabled_summary);
        } else if (i == 2) {
            this.mPreference.setEnabled(false);
        } else if (i == 3) {
            ...
            if (!this.mNfcAdapter.isNdefPushEnabled() || !this.mPreference.isEnabled()) {
                this.mPreference.setSummary(C1992R$string.android_beam_off_summary);
            } else {
                this.mPreference.setSummary(C1992R$string.android_beam_on_summary);
            }
        } else if (i == 4) {
            this.mPreference.setEnabled(false);
        }
