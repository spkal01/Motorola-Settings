...
public class AndroidBeam extends InstrumentedFragment implements OnMainSwitchChangeListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        HelpUtils.prepareHelpMenuItem((Activity) getActivity(), menu, C1992R$string.help_uri_beam, getClass().getName());
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (hasBaseUserRestriction || checkIfRestrictionEnforced == null) {
            View inflate = layoutInflater.inflate(C1987R$layout.preference_footer, viewGroup, false);
            this.mView = inflate;
            ((ImageView) inflate.findViewById(16908294)).setImageResource(C1983R$drawable.ic_info_outline_24dp);
            ((TextView) this.mView.findViewById(16908310)).setText(C1992R$string.android_beam_explained);
            return this.mView;
        }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        settingsActivity.setTitle(C1992R$string.android_beam_settings_title);
    }
