...
public final class WifiDisplaySettings extends SettingsPreferenceFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.wifi_display_settings);
    ...
    private Preference mReadyForPreference;
    ...
    private final Runnable mUpdateRunnable = new Runnable() {
        public void run() {
            int access$1100 = WifiDisplaySettings.this.mPendingChanges;
            int unused = WifiDisplaySettings.this.mPendingChanges = 0;
            WifiDisplaySettings.this.update(access$1100);
        }
    };
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.wifi_display_settings);
        setHasOptionsMenu(true);
    }

    public int getHelpResource() {
        return C1992R$string.help_url_remote_display;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        textView.setText(C1992R$string.wifi_display_no_devices_found);
        setEmptyView(this.mEmptyView);
        if (MotoDesktopManager.isReadyForAvailable(getPrefContext()) && isAvailable(getPrefContext())) {
            this.mEmptyView.setText(C1992R$string.ready_for_discovery);
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.mEmptyView.getLayoutParams();
            Slog.d("WifiDisplaySettings", "mEmptyView params:" + layoutParams);
            layoutParams.height = -2;
            layoutParams.gravity = 17;
            this.mEmptyView.setLayoutParams(layoutParams);
            this.mEmptyView.setOnClickListener(new WifiDisplaySettings$$ExternalSyntheticLambda0(this));
        }
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        if (!(wifiDisplayStatus == null || wifiDisplayStatus.getFeatureState() == 0 || MotoDesktopManager.isReadyForAvailable(getPrefContext()))) {
            MenuItem add = menu.add(0, 1, 0, C1992R$string.wifi_display_enable_menu_item);
    ...
    public void update(int i) {
        ...
        boolean isReadyForAvailable = MotoDesktopManager.isReadyForAvailable(getPrefContext());
        WifiDisplayStatus wifiDisplayStatus = this.mWifiDisplayStatus;
        if (wifiDisplayStatus != null && wifiDisplayStatus.getFeatureState() == 3 && !isReadyForAvailable) {
        ...
        if (isReadyForAvailable && isAvailable(getPrefContext()) && preferenceScreen.getPreferenceCount() > 0) {
            if (this.mReadyForPreference == null) {
                C13361 r0 = new Preference(getPrefContext()) {
                    /* access modifiers changed from: protected */
                    public void onClick() {
                        WifiDisplaySettings.this.startReadyFor();
                    }
                };
                this.mReadyForPreference = r0;
                r0.setOrder(4);
                this.mReadyForPreference.setTitle(C1992R$string.ready_for_discovery);
            }
            preferenceScreen.addPreference(this.mReadyForPreference);
        }
        if (z2) {
    ...
    /* access modifiers changed from: private */
    public void startReadyFor() {
        try {
            Intent intent = new Intent("com.motorola.mobiledesktop.rdp_desktop");
            intent.addFlags(268435456);
            intent.putExtra("INDEX_PAGE", "PAGE_DISPLAY");
            getPrefContext().startActivity(intent);
        } catch (Exception e) {
            Slog.w("WifiDisplaySettings", "startReadyFor", e);
        }
    }
    ...
    private void buildCertificationMenu(PreferenceScreen preferenceScreen) {
        ...
        if (preferenceGroup == null) {
            ...
            preferenceCategory.setTitle(C1992R$string.wifi_display_certification_heading);
        ...
        if (!this.mWifiDisplayStatus.getSessionInfo().getGroupId().isEmpty()) {
            ...
            preference.setTitle(C1992R$string.wifi_display_session_info);
            ...
            if (this.mWifiDisplayStatus.getSessionInfo().getSessionId() != 0) {
                this.mCertCategory.addPreference(new Preference(getPrefContext()) {
                    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
                        ...
                        Button button = (Button) preferenceViewHolder.findViewById(C1985R$id.left_button);
                        button.setText(C1992R$string.wifi_display_pause);
                        button.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                WifiDisplaySettings.this.mDisplayManager.pauseWifiDisplay();
                            }
                        });
                        Button button2 = (Button) preferenceViewHolder.findViewById(C1985R$id.right_button);
                        button2.setText(C1992R$string.wifi_display_resume);
                ...
                this.mCertCategory.setLayoutResource(C1987R$layout.two_buttons_panel);
            }
        }
        C13483 r11 = new SwitchPreference(getPrefContext()) {
            /* access modifiers changed from: protected */
            public void onClick() {
        ...
        r11.setTitle(C1992R$string.wifi_display_listen_mode);
        r11.setChecked(this.mListen);
        this.mCertCategory.addPreference(r11);
        C13494 r112 = new SwitchPreference(getPrefContext()) {
            /* access modifiers changed from: protected */
            public void onClick() {
                WifiDisplaySettings wifiDisplaySettings = WifiDisplaySettings.this;
        ...
        r112.setTitle(C1992R$string.wifi_display_autonomous_go);
        ...
        listPreference.setTitle(C1992R$string.wifi_display_wps_config);
        ...
        listPreference2.setTitle(C1992R$string.wifi_display_listen_channel);
        ...
        listPreference3.setTitle(C1992R$string.wifi_display_operating_channel);
    ...
    public void setListenMode(final boolean z) {
        C133710 r0 = new WifiP2pManager.ActionListener() {
            public void onSuccess() {
            }
    ...
    public void showWifiDisplayOptionsDialog(final WifiDisplay wifiDisplay) {
        View inflate = getActivity().getLayoutInflater().inflate(C1987R$layout.wifi_display_options, (ViewGroup) null);
        final EditText editText = (EditText) inflate.findViewById(C1985R$id.name);
        editText.setText(wifiDisplay.getFriendlyDisplayName());
        C133912 r2 = new DialogInterface.OnClickListener() {
        ...
        new AlertDialog.Builder(getActivity()).setCancelable(true).setTitle(C1992R$string.wifi_display_options_title).setView(inflate).setPositiveButton(C1992R$string.wifi_display_options_done, (DialogInterface.OnClickListener) r2).setNegativeButton(C1992R$string.wifi_display_options_forget, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        public RoutePreference(Context context, MediaRouter.RouteInfo routeInfo) {
            ...
            if (routeInfo.isSelected()) {
                ...
                if (routeInfo.isConnecting()) {
                    setSummary(C1992R$string.wifi_display_status_connecting);
                } else {
                    setSummary(C1992R$string.wifi_display_status_connected);
                }
            } else if (isEnabled()) {
                setOrder(3);
            } else {
                ...
                if (routeInfo.getStatusCode() == 5) {
                    setSummary(C1992R$string.wifi_display_status_in_use);
                } else {
                    setSummary(C1992R$string.wifi_display_status_not_available);
                }
            }
    ...
    private class WifiDisplayRoutePreference extends RoutePreference implements View.OnClickListener {
        ...
        public int getSecondTargetResId() {
            return C1987R$layout.preference_widget_gear;
        }
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            super.onBindViewHolder(preferenceViewHolder);
            ImageView imageView = (ImageView) preferenceViewHolder.findViewById(C1985R$id.settings_button);
            if (imageView != null) {
