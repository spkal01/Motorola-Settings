...
public class RegulatoryInfoDisplayActivity extends Activity implements DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertDialog.Builder positiveButton = new AlertDialog.Builder(this).setTitle(C1992R$string.regulatory_labels).setOnDismissListener(this).setPositiveButton(17039370, (DialogInterface.OnClickListener) null);
        ...
        CharSequence text = getResources().getText(C1992R$string.regulatory_info_text);
        if (z2) {
            View inflate = getLayoutInflater().inflate(C1987R$layout.regulatory_info, (ViewGroup) null);
            ImageView imageView = (ImageView) inflate.findViewById(C1985R$id.regulatoryInfo);
            if (decodeFile != null) {
