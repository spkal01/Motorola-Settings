...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return (!this.mContext.getResources().getBoolean(C1980R$bool.config_show_system_update_settings) || !this.mUm.isAdminUser()) ? 3 : 0;
    }
    ...
    public CharSequence getSummary() {
        ...
        int i = C1992R$string.android_version_summary;
        String string = context.getString(i, new Object[]{Build.VERSION.RELEASE_OR_CODENAME});
        ...
        try {
            ...
            if (i2 == 0) {
                ...
                if (i2 == 2 || i2 == 3 || i2 == 4 || i2 == 5) {
                    return this.mContext.getText(C1992R$string.android_version_pending_update_summary);
                }
                return string;
            }
