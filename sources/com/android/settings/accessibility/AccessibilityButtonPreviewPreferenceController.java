...
public class AccessibilityButtonPreviewPreferenceController extends BasePreferenceController implements LifecycleObserver, OnResume, OnPause {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPreview = (ImageView) ((LayoutPreference) preferenceScreen.findPreference(getPreferenceKey())).findViewById(C1985R$id.preview_image);
    ...
    public void updatePreviewPreference() {
        ...
        if (AccessibilityUtil.isFloatingMenuEnabled(this.mContext)) {
            ...
            if (i2 == 0) {
                i = C1983R$drawable.accessibility_button_preview_small_floating_menu;
            } else {
                i = C1983R$drawable.accessibility_button_preview_large_floating_menu;
            }
            this.mPreview.setImageDrawable(getFloatingMenuPreviewDrawable(i, i3));
            this.mPreview.invalidate();
            return;
        }
        this.mPreview.setImageDrawable(this.mContext.getDrawable(C1983R$drawable.accessibility_button_navigation));
    }
