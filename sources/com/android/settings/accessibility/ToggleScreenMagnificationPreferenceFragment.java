...
public class ToggleScreenMagnificationPreferenceFragment extends ToggleFeaturePreferenceFragment implements MagnificationModePreferenceController.DialogHelper {
    ...
    public void onCreate(Bundle bundle) {
        ...
        getActivity().setTitle(C1992R$string.accessibility_screen_magnification_title);
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.mPackageName = getString(C1992R$string.accessibility_screen_magnification_title);
        this.mImageUri = new Uri.Builder().scheme("android.resource").authority(getPrefContext().getPackageName()).appendPath(String.valueOf(C1991R$raw.accessibility_magnification_banner)).build();
        this.mTouchExplorationStateChangeListener = new C0639xd82fc31f(this);
    ...
    private void updateFooterPreference() {
        String string = getPrefContext().getString(C1992R$string.accessibility_screen_magnification_about_title);
        String string2 = getPrefContext().getString(C1992R$string.f56x1937734d);
    ...
    public Dialog onCreateDialog(int i) {
        ...
        if (i == 1001) {
            AlertDialog showEditShortcutDialog = AccessibilityDialogUtils.showEditShortcutDialog(getPrefContext(), WizardManagerHelper.isAnySetupWizard(getIntent()) ? 3 : 2, getPrefContext().getString(C1992R$string.accessibility_shortcut_title, new Object[]{this.mPackageName}), new C0637xd82fc31d(this));
    ...
    public void initSettingsPreference() {
        if (getContext().getResources().getBoolean(17891647)) {
            Preference preference = new Preference(getPrefContext());
            this.mSettingsPreference = preference;
            preference.setTitle(C1992R$string.accessibility_magnification_mode_title);
    ...
    public void setupMagnificationEditShortcutDialog(AlertDialog alertDialog) {
        View findViewById = alertDialog.findViewById(C1985R$id.software_shortcut);
        ...
        View findViewById2 = alertDialog.findViewById(C1985R$id.hardware_shortcut);
        ...
        View findViewById3 = alertDialog.findViewById(C1985R$id.triple_tap_shortcut);
        ...
        View findViewById4 = alertDialog.findViewById(C1985R$id.advanced_shortcut);
    ...
    private void setDialogTextAreaClickListener(View view, CheckBox checkBox) {
        view.findViewById(C1985R$id.container).setOnClickListener(new C0638xd82fc31e(checkBox));
    }
    ...
    public CharSequence getShortcutTypeSummary(Context context) {
        ...
        if (hasShortcutType(retrieveUserShortcutType, 4)) {
            arrayList.add(context.getText(C1992R$string.accessibility_shortcut_triple_tap_keyword));
        }
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_magnification;
    }
    ...
    public void initShortcutPreference() {
        ...
        this.mShortcutPreference.setTitle((CharSequence) getString(C1992R$string.accessibility_shortcut_title, this.mPackageName));
    ...
    public void updateShortcutTitle(ShortcutPreference shortcutPreference) {
        shortcutPreference.setTitle(C1992R$string.accessibility_screen_magnification_shortcut_title);
    }
    ...
    public static CharSequence getServiceSummary(Context context) {
        if (getUserShortcutTypeFromSettings(context) != 0) {
            return context.getText(C1992R$string.accessibility_summary_shortcut_enabled);
        }
        return context.getText(C1992R$string.accessibility_summary_shortcut_disabled);
    }
}
