...
public class CaptionPropertiesFragment extends DashboardFragment implements Preference.OnPreferenceChangeListener, OnMainSwitchChangeListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.captioning_settings);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.captioning_settings;
    }
    ...
    private void initFontSizeValuesArray() {
        String[] stringArray = getPrefContext().getResources().getStringArray(C1978R$array.captioning_font_size_selector_values);
    ...
    private CharSequence geTextAppearanceSummary(Context context) {
        String[] stringArray = context.getResources().getStringArray(C1978R$array.captioning_font_size_selector_summaries);
