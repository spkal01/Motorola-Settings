...
public class MagnificationGesturesPreferenceController extends TogglePreferenceController {
    ...
    public CharSequence getSummary() {
        int i;
        if (this.mIsFromSUW) {
            i = C1992R$string.accessibility_screen_magnification_short_summary;
        } else if (isChecked()) {
            i = C1992R$string.accessibility_feature_state_on;
        } else {
            i = C1992R$string.accessibility_feature_state_off;
        }
    ...
    static void populateMagnificationGesturesPreferenceExtras(Bundle bundle, Context context) {
        ...
        bundle.putInt("title_res", C1992R$string.accessibility_screen_magnification_gestures_title);
        bundle.putCharSequence("html_description", MessageFormat.format(context.getString(C1992R$string.accessibility_screen_magnification_summary), new Object[]{1, 2, 3, 4, 5}));
        bundle.putInt("video_resource", C1991R$raw.accessibility_screen_magnification);
    }
}
