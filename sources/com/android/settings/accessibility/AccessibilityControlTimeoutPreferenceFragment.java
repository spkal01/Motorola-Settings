...
public final class AccessibilityControlTimeoutPreferenceFragment extends DashboardFragment implements AccessibilityTimeoutController.OnChangeListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.accessibility_control_timeout_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.accessibility_control_timeout_settings;
    }
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Lifecycle lifecycle) {
        if (sControllers.size() == 0) {
            String[] stringArray = context.getResources().getStringArray(C1978R$array.accessibility_timeout_control_selector_keys);
