...
public class ToggleAutoclickPreferenceFragment extends DashboardFragment implements ToggleAutoclickPreferenceController.OnChangeListener {
    private static final int[] AUTOCLICK_PREFERENCE_SUMMARIES = {C1990R$plurals.accessibilty_autoclick_preference_subtitle_short_delay, C1990R$plurals.accessibilty_autoclick_preference_subtitle_medium_delay, C1990R$plurals.accessibilty_autoclick_preference_subtitle_long_delay};
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.accessibility_autoclick_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.accessibility_autoclick_settings;
    }
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Lifecycle lifecycle) {
        for (String toggleAutoclickPreferenceController : context.getResources().getStringArray(C1978R$array.accessibility_autoclick_control_selector_keys)) {
