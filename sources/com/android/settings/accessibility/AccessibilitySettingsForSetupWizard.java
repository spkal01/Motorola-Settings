...
public class AccessibilitySettingsForSetupWizard extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        glifPreferenceLayout.setDescriptionText(C1992R$string.vision_settings_description);
        glifPreferenceLayout.setHeaderText(C1992R$string.vision_settings_title);
        glifPreferenceLayout.setIcon(getPrefContext().getDrawable(C1983R$drawable.ic_accessibility_visibility));
        if (ThemeHelper.shouldApplyExtendedPartnerConfig(getActivity())) {
            LinearLayout linearLayout = (LinearLayout) glifPreferenceLayout.findManagedViewById(C1985R$id.sud_layout_header);
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.accessibility_settings_for_setup_wizard);
    ...
    public void onResume() {
        ...
        updateAccessibilityServicePreference(this.mSelectToSpeakPreference, "com.google.android.marvin.talkback", "com.google.android.accessibility.selecttospeak.SelectToSpeakService", C0641xf12da7d1.class.getName());
