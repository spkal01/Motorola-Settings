...
public class BalanceSeekBar extends SeekBar {
    ...
    public BalanceSeekBar(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        C06091 r6 = new SeekBar.OnSeekBarChangeListener() {
        ...
        this.mCenterMarkerRect = new Rect(0, 0, resources.getDimensionPixelSize(C1982R$dimen.balance_seekbar_center_marker_width), resources.getDimensionPixelSize(C1982R$dimen.balance_seekbar_center_marker_height));
