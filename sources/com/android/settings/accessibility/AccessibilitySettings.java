...
public class AccessibilitySettings extends DashboardFragment {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.accessibility_settings) {
    ...
    public int getHelpResource() {
        return C1992R$string.help_uri_accessibility;
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.accessibility_settings;
    }
    ...
    static CharSequence getServiceSummary(Context context, AccessibilityServiceInfo accessibilityServiceInfo, boolean z) {
        ...
        if (z && accessibilityServiceInfo.crashed) {
            return context.getText(C1992R$string.accessibility_summary_state_stopped);
        }
        if (AccessibilityUtil.getAccessibilityServiceFragmentType(accessibilityServiceInfo) == 1) {
            if (AccessibilityUtil.getUserShortcutTypesFromSettings(context, new ComponentName(accessibilityServiceInfo.getResolveInfo().serviceInfo.packageName, accessibilityServiceInfo.getResolveInfo().serviceInfo.name)) != 0) {
                charSequence = context.getText(C1992R$string.accessibility_summary_shortcut_enabled);
            } else {
                charSequence = context.getText(C1992R$string.accessibility_summary_shortcut_disabled);
            }
        } else if (z) {
            charSequence = context.getText(C1992R$string.accessibility_summary_state_enabled);
        } else {
            charSequence = context.getText(C1992R$string.accessibility_summary_state_disabled);
        }
        CharSequence loadSummary = accessibilityServiceInfo.loadSummary(context.getPackageManager());
        return TextUtils.isEmpty(loadSummary) ? charSequence : context.getString(C1992R$string.preference_summary_default_combination, new Object[]{charSequence, loadSummary});
    }
    ...
    static CharSequence getServiceDescription(Context context, AccessibilityServiceInfo accessibilityServiceInfo, boolean z) {
        ...
        return context.getText(C1992R$string.accessibility_description_state_stopped);
    }
    ...
    public void updateServicePreferences() {
        ...
        initializePreBundledServicesMapFromArray("screen_reader_category", C1978R$array.config_preinstalled_screen_reader_services);
        initializePreBundledServicesMapFromArray("captions_category", C1978R$array.config_preinstalled_captions_services);
        initializePreBundledServicesMapFromArray("audio_category", C1978R$array.config_preinstalled_audio_services);
        initializePreBundledServicesMapFromArray("display_category", C1978R$array.config_preinstalled_display_services);
        initializePreBundledServicesMapFromArray("interaction_control_category", C1978R$array.config_preinstalled_interaction_control_services);
        ...
        updateCategoryOrderFromArray("screen_reader_category", C1978R$array.config_order_screen_reader_services);
        updateCategoryOrderFromArray("captions_category", C1978R$array.config_order_captions_services);
        updateCategoryOrderFromArray("audio_category", C1978R$array.config_order_audio_services);
        updateCategoryOrderFromArray("interaction_control_category", C1978R$array.config_order_interaction_control_services);
        updateCategoryOrderFromArray("display_category", C1978R$array.config_order_display_services);
    ...
    static class RestrictedPreferenceHelper {
        ...
        private String mHandwritingPkg = null;
        ...
        RestrictedPreferenceHelper(Context context) {
            ...
            if (context.getResources().getBoolean(17891841)) {
                this.mHandwritingPkg = context.getResources().getString(17041749);
            }
        }
        ...
        public List<RestrictedPreference> createAccessibilityServicePreferenceList(List<AccessibilityServiceInfo> list) {
            ...
            while (i2 < size) {
                ...
                String str2 = this.mHandwritingPkg;
                if (str2 == null || !str2.equals(str) || !isSystem(resolveInfo)) {
                    ...
                    if (resolveInfo.getIconResource() == 0) {
                        loadIcon = ContextCompat.getDrawable(this.mContext, C1983R$drawable.ic_accessibility_generic);
                    }
                    boolean z = contains;
                    ...
                    setRestrictedPreferenceEnabled(createRestrictedPreference, str3, permittedAccessibilityServices == null || permittedAccessibilityServices.contains(str3), z);
                    ...
                    putBasicExtras(restrictedPreference, key, charSequence2, serviceDescription, i3, loadHtmlDescription, componentName2);
                    putServiceExtras(restrictedPreference2, resolveInfo, Boolean.valueOf(z));
                    putSettingsExtras(restrictedPreference2, str3, settingsActivityName);
        ...
        public List<RestrictedPreference> createAccessibilityActivityPreferenceList(List<AccessibilityShortcutInfo> list) {
            ...
            while (i < size) {
                ...
                RestrictedPreference createRestrictedPreference = createRestrictedPreference(flattenToString, loadLabel, accessibilityShortcutInfo.loadSummary(this.mPm), activityInfo.getIconResource() == 0 ? ContextCompat.getDrawable(this.mContext, C1983R$drawable.ic_accessibility_generic) : activityInfo.loadIcon(this.mPm), LaunchAccessibilityActivityPreferenceFragment.class.getName());
        ...
        private void putSettingsExtras(RestrictedPreference restrictedPreference, String str, String str2) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                extras.putString("settings_title", this.mContext.getText(C1992R$string.accessibility_menu_item_settings).toString());
