...
public class LaunchAccessibilityActivityPreferenceFragment extends ToggleFeaturePreferenceFragment {
    ...
    private void initLaunchPreference() {
        ...
        if (accessibilityShortcutInfo == null) {
            ...
            str = getString(C1992R$string.accessibility_service_primary_open_title, accessibilityShortcutInfo.getActivityInfo().loadLabel(getPackageManager()));
        }
        preference.setTitle((CharSequence) str);
        preference.setOnPreferenceClickListener(new C0616xd3ae02e4(this));
