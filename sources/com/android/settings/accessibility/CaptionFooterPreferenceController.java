...
public class CaptionFooterPreferenceController extends AccessibilityFooterPreferenceController {
    ...
    public String getLearnMoreContentDescription() {
        return this.mContext.getString(C1992R$string.accessibility_captioning_footer_learn_more_content_description);
    }

    /* access modifiers changed from: protected */
    public String getIntroductionTitle() {
        return this.mContext.getString(C1992R$string.accessibility_captioning_about_title);
    }
