...
public class AccessibilityButtonLocationPreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener {
    ...
    private void initValueTitleMap() {
        if (this.mValueTitleMap.size() == 0) {
            String[] stringArray = this.mContext.getResources().getStringArray(C1978R$array.accessibility_button_location_selector_values);
            String[] stringArray2 = this.mContext.getResources().getStringArray(C1978R$array.accessibility_button_location_selector_titles);
