...
public final class MagnificationPreferenceFragment extends DashboardFragment {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.accessibility_magnification_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.accessibility_magnification_settings;
    }
    ...
    static boolean isApplicable(Resources resources) {
        return resources.getBoolean(17891715);
    }
}
