...
public class CaptionAppearanceFragment extends DashboardFragment implements Preference.OnPreferenceChangeListener, ListDialogPreference.OnValueChangedListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.captioning_appearance);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.captioning_appearance;
    }
    ...
    public void refreshPreviewText() {
        ...
        if (activity != null && (subtitleView = this.mPreviewText) != null) {
            ...
            if (locale != null) {
                subtitleView.setText(AccessibilityUtils.getTextForLocale(activity, locale, C1992R$string.captioning_preview_text));
            } else {
                subtitleView.setText(C1992R$string.captioning_preview_text);
            }
    ...
    public static void applyCaptionProperties(CaptioningManager captioningManager, SubtitleView subtitleView, View view, int i) {
        ...
        if (view != null) {
            ...
            subtitleView.setTextSize(context.getResources().getDimension(C1982R$dimen.caption_preview_text_size) * fontScale);
        }
        Locale locale = captioningManager.getLocale();
        if (locale != null) {
            subtitleView.setText(AccessibilityUtils.getTextForLocale(context, locale, C1992R$string.captioning_preview_characters));
        } else {
            subtitleView.setText(C1992R$string.captioning_preview_characters);
        }
    }

    private void initializeAllPreferences() {
        LayoutPreference layoutPreference = (LayoutPreference) findPreference("caption_preview");
        this.mPreviewText = layoutPreference.findViewById(C1985R$id.preview_text);
        this.mPreviewWindow = layoutPreference.findViewById(C1985R$id.preview_window);
        View findViewById = layoutPreference.findViewById(C1985R$id.preview_viewport);
        this.mPreviewViewport = findViewById;
        findViewById.addOnLayoutChangeListener(this.mLayoutChangeListener);
        Resources resources = getResources();
        int[] intArray = resources.getIntArray(C1978R$array.captioning_preset_selector_values);
        String[] stringArray = resources.getStringArray(C1978R$array.captioning_preset_selector_titles);
        ...
        int[] intArray2 = resources.getIntArray(C1978R$array.captioning_color_selector_values);
        String[] stringArray2 = resources.getStringArray(C1978R$array.captioning_color_selector_titles);
        ...
        int[] intArray3 = resources.getIntArray(C1978R$array.captioning_opacity_selector_values);
        String[] stringArray3 = resources.getStringArray(C1978R$array.captioning_opacity_selector_titles);
        ...
        iArr[0] = 0;
        strArr[0] = getString(C1992R$string.color_none);
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_caption;
    }
}
