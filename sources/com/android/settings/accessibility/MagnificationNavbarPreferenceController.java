...
public class MagnificationNavbarPreferenceController extends TogglePreferenceController {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        extras.putInt("title_res", C1992R$string.accessibility_screen_magnification_navbar_title);
        extras.putCharSequence("html_description", this.mContext.getText(C1992R$string.accessibility_screen_magnification_navbar_summary));
    ...
    public CharSequence getSummary() {
        int i;
        if (this.mIsFromSUW) {
            i = C1992R$string.accessibility_screen_magnification_navbar_short_summary;
        } else if (isChecked()) {
