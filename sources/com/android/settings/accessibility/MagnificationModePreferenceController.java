...
public class MagnificationModePreferenceController extends BasePreferenceController implements DialogCreatable, LifecycleObserver, OnCreate, OnResume, OnSaveInstanceState {
    ...
    private void initModeInfos() {
        this.mModeInfos.add(new MagnificationModeInfo(this.mContext.getText(C1992R$string.accessibility_magnification_mode_dialog_option_full_screen), (CharSequence) null, C1983R$drawable.ic_illustration_fullscreen, 1));
        this.mModeInfos.add(new MagnificationModeInfo(this.mContext.getText(C1992R$string.accessibility_magnification_mode_dialog_option_window), (CharSequence) null, C1983R$drawable.ic_illustration_window, 2));
        this.mModeInfos.add(new MagnificationModeInfo(this.mContext.getText(C1992R$string.accessibility_magnification_mode_dialog_option_switch), this.mContext.getText(C1992R$string.accessibility_magnification_area_settings_mode_switch_summary), C1983R$drawable.ic_illustration_switch, 3));
    }
    ...
    private Dialog createMagnificationModeDialog() {
        this.mMagnificationModesListView = AccessibilityDialogUtils.createSingleChoiceListView(this.mContext, this.mModeInfos, new MagnificationModePreferenceController$$ExternalSyntheticLambda1(this));
        this.mMagnificationModesListView.addHeaderView(LayoutInflater.from(this.mContext).inflate(C1987R$layout.accessibility_magnification_mode_header, this.mMagnificationModesListView, false), (Object) null, false);
        this.mMagnificationModesListView.setItemChecked(computeSelectionIndex(), true);
        return AccessibilityDialogUtils.createCustomDialog(this.mContext, this.mContext.getString(C1992R$string.accessibility_magnification_mode_dialog_title), this.mMagnificationModesListView, new MagnificationModePreferenceController$$ExternalSyntheticLambda0(this));
    }
    ...
    private Dialog createMagnificationShortCutConfirmDialog() {
        return AccessibilityDialogUtils.createMagnificationSwitchShortcutDialog(this.mContext, new MagnificationModePreferenceController$$ExternalSyntheticLambda3(this));
    }
