...
public class ToggleAutoclickCustomSeekbarController extends BasePreferenceController implements LifecycleObserver, OnResume, OnPause, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (isAvailable()) {
            ...
            SeekBar seekBar = (SeekBar) layoutPreference.findViewById(C1985R$id.autoclick_delay);
            ...
            TextView textView = (TextView) layoutPreference.findViewById(C1985R$id.current_label);
            this.mDelayLabel = textView;
            textView.setText(delayTimeToString(sharedPreferenceForDelayValue));
            ImageView imageView = (ImageView) layoutPreference.findViewById(C1985R$id.shorter);
            ...
            ImageView imageView2 = (ImageView) layoutPreference.findViewById(C1985R$id.longer);
    ...
    private CharSequence delayTimeToString(int i) {
        ...
        return this.mContext.getResources().getQuantityString(C1990R$plurals.accessibilty_autoclick_delay_unit_second, i2, new Object[]{String.format(f == 1.0f ? "%.0f" : "%.1f", new Object[]{Float.valueOf(f)})});
    }
}
