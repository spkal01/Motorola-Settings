...
public class ShortcutPreference extends Preference {
    ...
    ShortcutPreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(C1987R$layout.accessibility_shortcut_secondary_action);
        setWidgetLayoutResource(C1987R$layout.preference_widget_primary_switch);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        LinearLayout linearLayout = (LinearLayout) preferenceViewHolder.itemView.findViewById(C1985R$id.main_frame);
        int i = 0;
        ...
        Switch switchR = (Switch) preferenceViewHolder.itemView.findViewById(C1985R$id.switchWidget);
        if (switchR != null) {
            switchR.setOnTouchListener(ShortcutPreference$$ExternalSyntheticLambda3.INSTANCE);
            switchR.setContentDescription(getContext().getText(C1992R$string.accessibility_shortcut_settings));
        ...
        View findViewById = preferenceViewHolder.itemView.findViewById(C1985R$id.divider);
