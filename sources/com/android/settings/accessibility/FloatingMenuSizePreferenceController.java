...
public class FloatingMenuSizePreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener, LifecycleObserver, OnResume, OnPause {
    ...
    private void initValueTitleMap() {
        if (this.mValueTitleMap.size() == 0) {
            String[] stringArray = this.mContext.getResources().getStringArray(C1978R$array.accessibility_button_size_selector_values);
            String[] stringArray2 = this.mContext.getResources().getStringArray(C1978R$array.accessibility_button_size_selector_titles);
