...
public class FloatingMenuLayerDrawable extends LayerDrawable {
    ...
    public static FloatingMenuLayerDrawable createLayerDrawable(Context context, int i, int i2) {
        FloatingMenuLayerDrawable floatingMenuLayerDrawable = new FloatingMenuLayerDrawable(new Drawable[]{context.getDrawable(C1983R$drawable.accessibility_button_preview_base), null});
