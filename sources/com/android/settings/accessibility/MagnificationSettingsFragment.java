...
public class MagnificationSettingsFragment extends DashboardFragment implements MagnificationModePreferenceController.DialogHelper {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.accessibility_magnification_service_settings);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.accessibility_magnification_service_settings;
    }
