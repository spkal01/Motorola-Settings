...
public class RestrictedListPreference extends CustomListPreference {
    ...
    public class RestrictedArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public RestrictedArrayAdapter(Context context, CharSequence[] charSequenceArr, int i) {
            super(context, C1987R$layout.restricted_dialog_singlechoice, C1985R$id.text1, charSequenceArr);
            this.mSelectedIndex = i;
        }

        public View getView(int i, View view, ViewGroup viewGroup) {
            View view2 = super.getView(i, view, viewGroup);
            CheckedTextView checkedTextView = (CheckedTextView) view2.findViewById(C1985R$id.text1);
            ImageView imageView = (ImageView) view2.findViewById(C1985R$id.restricted_lock_icon);
            boolean z = false;
