...
public class BackupSettingsHelper {
    ...
    public String getSummary() {
        ...
        try {
            if (this.mBackupManager.isBackupEnabled()) {
                i = C1992R$string.backup_summary_state_on;
            } else {
                i = C1992R$string.backup_summary_state_off;
            }
    ...
    public CharSequence getLabelForBackupSettings() {
        ...
        return TextUtils.isEmpty(labelFromBackupTransport) ? this.mContext.getString(C1992R$string.privacy_settings_title) : labelFromBackupTransport;
    }

    public String getSummaryForBackupSettings() {
        String summaryFromBackupTransport = getSummaryFromBackupTransport();
        return summaryFromBackupTransport == null ? this.mContext.getString(C1992R$string.backup_configure_account_default_summary) : summaryFromBackupTransport;
    }
    ...
    public boolean isBackupProvidedByManufacturer() {
        ...
        String string = this.mContext.getResources().getString(C1992R$string.config_backup_settings_intent);
        return string != null && !string.isEmpty();
    }

    public String getLabelProvidedByManufacturer() {
        return this.mContext.getResources().getString(C1992R$string.config_backup_settings_label);
    }
