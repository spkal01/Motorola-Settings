...
public class ToggleBackupSettingFragment extends SettingsPreferenceFragment implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        C07341 r0 = new Preference(getPrefContext()) {
        ...
        this.mSummaryPreference.setLayoutResource(C1987R$layout.text_description_preference);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (Settings.Secure.getInt(getContentResolver(), "user_full_data_backup_aware", 0) != 0) {
            this.mSummaryPreference.setSummary(C1992R$string.fullbackup_data_summary);
        } else {
            this.mSummaryPreference.setSummary(C1992R$string.backup_data_summary);
        }
        try {
        ...
        getActivity().setTitle(C1992R$string.backup_data_title);
    }
    ...
    public void showEraseBackupDialog() {
        ...
        if (Settings.Secure.getInt(getContentResolver(), "user_full_data_backup_aware", 0) != 0) {
            charSequence = getResources().getText(C1992R$string.fullbackup_erase_dialog_message);
        } else {
            charSequence = getResources().getText(C1992R$string.backup_erase_dialog_message);
        }
        this.mWaitingForConfirmationDialog = true;
        this.mConfirmDialog = new AlertDialog.Builder(getActivity()).setMessage(charSequence).setTitle(C1992R$string.backup_erase_dialog_title).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) this).setOnDismissListener(this).show();
    }
