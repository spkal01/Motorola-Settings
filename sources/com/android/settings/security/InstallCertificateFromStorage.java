...
public class InstallCertificateFromStorage extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.install_certificate_from_storage) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.install_certificate_from_storage;
    }
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_install_certificate;
    }
}
