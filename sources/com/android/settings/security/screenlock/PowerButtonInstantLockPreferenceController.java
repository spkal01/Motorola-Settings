...
public class PowerButtonInstantLockPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, Preference.OnPreferenceChangeListener {
    ...
    public void updateState(Preference preference) {
        ...
        if (!TextUtils.isEmpty(activeTrustAgentLabel)) {
            preference.setSummary((CharSequence) this.mContext.getString(C1992R$string.lockpattern_settings_power_button_instantly_locks_summary, new Object[]{activeTrustAgentLabel}));
            return;
        }
        preference.setSummary(C1992R$string.summary_empty);
    }
