...
public class ScreenLockSettings extends DashboardFragment implements OwnerInfoPreferenceController.OwnerInfoCallback {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.screen_lock_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.screen_lock_settings;
    }
