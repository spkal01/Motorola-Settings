...
public class CredentialManagementAppHeaderController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mExecutor.execute(new C1277x6bf2149f(this, preferenceScreen));
    }
    ...
    public /* synthetic */ void lambda$displayPreference$1(PreferenceScreen preferenceScreen) {
        ...
        this.mHandler.post(new C1278x6bf214a0(this, preferenceScreen));
    }
    ...
    public void lambda$displayPreference$0(PreferenceScreen preferenceScreen) {
        ...
        ImageView imageView = (ImageView) layoutPreference.findViewById(C1985R$id.entity_header_icon);
        TextView textView = (TextView) layoutPreference.findViewById(C1985R$id.entity_header_title);
        TextView textView2 = (TextView) layoutPreference.findViewById(C1985R$id.entity_header_summary);
        ((TextView) layoutPreference.findViewById(C1985R$id.entity_header_second_summary)).setVisibility(8);
        try {
            ...
            textView2.setText(C1992R$string.certificate_management_app_description);
