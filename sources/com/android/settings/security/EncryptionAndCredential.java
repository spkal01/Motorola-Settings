...
public class EncryptionAndCredential extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.encryption_and_credential) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.encryption_and_credential;
    }
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_encryption;
    }
}
