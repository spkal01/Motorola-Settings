...
public class CredentialManagementAppAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View view) {
            super(view);
            this.mAppIconView = (ImageView) view.findViewById(C1985R$id.credential_management_app_icon);
            this.mTitleView = (TextView) view.findViewById(C1985R$id.credential_management_app_title);
        }
        ...
        public void bindView() {
            try {
                ...
                this.mTitleView.setText(TextUtils.expandTemplate(CredentialManagementAppAdapter.this.mContext.getText(C1992R$string.request_manage_credentials_title), new CharSequence[]{applicationInfo.loadLabel(CredentialManagementAppAdapter.this.mPackageManager)}));
            } catch (PackageManager.NameNotFoundException unused) {
                this.mAppIconView.setImageDrawable((Drawable) null);
                this.mTitleView.setText(TextUtils.expandTemplate(CredentialManagementAppAdapter.this.mContext.getText(C1992R$string.request_manage_credentials_title), new CharSequence[]{CredentialManagementAppAdapter.this.mCredentialManagerPackage}));
            }
        }
    }
    ...
    public class AppAuthenticationViewHolder extends RecyclerView.ViewHolder {
        ...
        public AppAuthenticationViewHolder(View view) {
            super(view);
            int i = C1985R$id.app_icon;
            this.mAppIconView = (ImageView) view.findViewById(i);
            this.mAppNameView = (TextView) view.findViewById(C1985R$id.app_name);
            this.mNumberOfUrisView = (TextView) view.findViewById(C1985R$id.number_of_uris);
            int i2 = C1985R$id.expand;
            ImageView imageView = (ImageView) view.findViewById(i2);
            this.mExpanderIconView = imageView;
            this.mChildRecyclerView = (RecyclerView) view.findViewById(C1985R$id.uris);
            if (CredentialManagementAppAdapter.this.mIsLayoutRtl) {
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ((RelativeLayout) view.findViewById(C1985R$id.app_details)).getLayoutParams();
                layoutParams.addRule(0, i);
                layoutParams.addRule(1, i2);
                view.setLayoutParams(layoutParams);
            }
            imageView.setOnClickListener(new C1268xabc7f6bd(this));
        }
        ...
        private void bindPolicyView(String str) {
            if (CredentialManagementAppAdapter.this.mIncludeExpander) {
                ...
                if (this.mExpandedApps.contains(str)) {
                    ...
                    this.mExpanderIconView.setImageResource(C1983R$drawable.ic_expand_less);
                ...
                this.mExpanderIconView.setImageResource(17303311);
                return;
            }
            this.mNumberOfUrisView.setVisibility(8);
        ...
        private String getNumberOfUrlsText(Map<Uri, String> map) {
            return CredentialManagementAppAdapter.this.mContext.getResources().getQuantityString(C1990R$plurals.number_of_urls, map.size(), new Object[]{Integer.valueOf(map.size())});
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i != 1) {
            return new AppAuthenticationViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(C1987R$layout.app_authentication_item, viewGroup, false));
        }
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(C1987R$layout.request_manage_credentials_header, viewGroup, false);
