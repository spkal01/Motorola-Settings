...
public final class CredentialStorage extends FragmentActivity {
    ...
    private class ResetDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
        ...
        private ResetDialog() {
            AlertDialog create = new AlertDialog.Builder(CredentialStorage.this).setTitle(17039380).setMessage(C1992R$string.credentials_reset_hint).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) this).create();
    ...
    private class ResetKeyStoreAndKeyChain extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPostExecute(Boolean bool) {
            if (bool.booleanValue()) {
                Toast.makeText(CredentialStorage.this, C1992R$string.credentials_erased, 0).show();
                CredentialStorage.this.clearLegacyVpnIfEstablished();
            } else {
                Toast.makeText(CredentialStorage.this, C1992R$string.credentials_not_erased, 0).show();
            }
            CredentialStorage.this.finish();
        }
    }
    ...
    public void clearLegacyVpnIfEstablished() {
        if (VpnUtils.disconnectLegacyVpn(getApplicationContext())) {
            Toast.makeText(this, C1992R$string.vpn_disconnected, 0).show();
        }
    }
    ...
    public boolean confirmKeyGuard(int i) {
        return new ChooseLockSettingsHelper.Builder(this).setRequestCode(i).setTitle(getResources().getText(C1992R$string.credentials_title)).show();
    }
