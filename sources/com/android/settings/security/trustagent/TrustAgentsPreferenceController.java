...
public class TrustAgentsPreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener, LifecycleObserver, OnStart {
    ...
    private final String NO_TRUST_AGENTS_KEY = "no_trust_agents";
    ...
    private void updateAgents() {
        ...
        Preference findPreference = this.mScreen.findPreference("no_trust_agents");
        if (this.mAvailableAgents.isEmpty()) {
            if (findPreference == null) {
                Preference preference = new Preference(this.mScreen.getContext());
                preference.setKey("no_trust_agents");
                preference.setTitle((CharSequence) this.mScreen.getContext().getResources().getString(C1992R$string.no_trust_agents));
