...
public class ManageTrustAgentsPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(C1980R$bool.config_show_manage_trust_agents) ? 0 : 3;
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (!this.mLockPatternUtils.isSecure(MY_USER_ID)) {
            ...
            preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C1990R$plurals.manage_trust_agents_summary_on, trustAgentCount, new Object[]{Integer.valueOf(trustAgentCount)}));
        } else {
            preference.setEnabled(true);
            preference.setSummary(C1992R$string.manage_trust_agents_summary);
        }
    }
