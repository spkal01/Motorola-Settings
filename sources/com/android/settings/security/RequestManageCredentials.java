...
public class RequestManageCredentials extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!"android.security.MANAGE_CREDENTIALS".equals(getIntent().getAction())) {
            ...
            setContentView(C1987R$layout.request_manage_credentials);
    ...
    private void loadRecyclerView() {
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(C1985R$id.apps_list);
    ...
    private void loadButtons() {
        this.mButtonPanel = (LinearLayout) findViewById(C1985R$id.button_panel);
        ((Button) findViewById(C1985R$id.dont_allow_button)).setOnClickListener(new RequestManageCredentials$$ExternalSyntheticLambda0(this));
        ((Button) findViewById(C1985R$id.allow_button)).setOnClickListener(new RequestManageCredentials$$ExternalSyntheticLambda2(this));
    }
    ...
    private void loadExtendedFloatingActionButton() {
        ExtendedFloatingActionButton extendedFloatingActionButton = (ExtendedFloatingActionButton) findViewById(C1985R$id.extended_fab);
    ...
    private void loadHeader() {
        ImageView imageView = (ImageView) findViewById(C1985R$id.credential_management_app_icon);
        TextView textView = (TextView) findViewById(C1985R$id.credential_management_app_title);
        try {
            ...
            textView.setText(TextUtils.expandTemplate(getText(C1992R$string.request_manage_credentials_title), new CharSequence[]{applicationInfo.loadLabel(getPackageManager())}));
        } catch (PackageManager.NameNotFoundException unused) {
            imageView.setImageDrawable((Drawable) null);
            textView.setText(TextUtils.expandTemplate(getText(C1992R$string.request_manage_credentials_title), new CharSequence[]{this.mCredentialManagerPackage}));
        }
    }
