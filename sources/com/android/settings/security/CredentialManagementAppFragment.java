...
public class CredentialManagementAppFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.credential_management_app_fragment);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.credential_management_app_fragment;
    }
