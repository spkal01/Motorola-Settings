...
public class ScreenPinningPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(C1980R$bool.config_show_screen_pinning_settings) ? 0 : 3;
    }

    public CharSequence getSummary() {
        if (Settings.System.getInt(this.mContext.getContentResolver(), "lock_to_app_enabled", 0) != 0) {
            return this.mContext.getText(C1992R$string.screen_pinning_switch_on_text);
        }
        return this.mContext.getText(C1992R$string.screen_pinning_switch_off_text);
    }
}
