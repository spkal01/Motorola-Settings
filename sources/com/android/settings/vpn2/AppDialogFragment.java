...
public class AppDialogFragment extends InstrumentedDialogFragment implements AppDialog.Listener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog.Builder negativeButton = new AlertDialog.Builder(getActivity()).setTitle((CharSequence) string).setMessage((CharSequence) getActivity().getString(C1992R$string.vpn_disconnect_confirm)).setNegativeButton((CharSequence) getActivity().getString(C1992R$string.vpn_cancel), (DialogInterface.OnClickListener) null);
        if (z2 && !isUiRestricted()) {
            negativeButton.setPositiveButton((CharSequence) getActivity().getString(C1992R$string.vpn_disconnect), (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
