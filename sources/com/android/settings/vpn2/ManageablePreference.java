...
public abstract class ManageablePreference extends GearPreference {
    ...
    public void updateSummary() {
        ...
        String[] stringArray = resources.getStringArray(C1978R$array.vpn_states);
        int i = this.mState;
        String str = i == STATE_NONE ? "" : stringArray[i];
        if (this.mIsInsecureVpn) {
            String string = resources.getString(C1992R$string.vpn_insecure_summary);
            ...
            String string2 = resources.getString(C1992R$string.vpn_always_on_summary_active);
            if (!TextUtils.isEmpty(str)) {
                string2 = str + " / " + string2;
            }
