...
class AppDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setMessage(getContext().getString(C1992R$string.vpn_version, new Object[]{this.mPackageInfo.versionName}));
        createButtons();
    ...
    public void createButtons() {
        ...
        setButton(-2, context.getString(C1992R$string.vpn_forget), this);
        setButton(-1, context.getString(C1992R$string.vpn_done), this);
    }
