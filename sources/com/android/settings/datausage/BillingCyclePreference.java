...
public class BillingCyclePreference extends Preference implements TemplatePreference, MobileDataEnabledListener.Client {
    ...
    public Intent getIntent() {
        ...
        return new SubSettingLauncher(getContext()).setDestination(BillingCycleSettings.class.getName()).setArguments(bundle).setTitleRes(C1992R$string.billing_cycle).setSourceMetricsCategory(0).toIntent();
    }
