...
public class CellDataPreference extends CustomDialogPreferenceCompat implements TemplatePreference, MobileDataEnabledListener.Client {
    ...
    private void showDisableDialog(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        builder.setTitle((CharSequence) null).setMessage(C1992R$string.data_usage_disable_mobile).setPositiveButton(17039370, onClickListener).setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
    }
    ...
    private void showMultiSimDialog(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setTitle(C1992R$string.sim_change_data_title);
        Context context = getContext();
        int i = C1992R$string.sim_change_data_message;
        ...
        objArr[1] = str;
        builder.setMessage((CharSequence) context.getString(i, objArr));
        builder.setPositiveButton(C1992R$string.okay, onClickListener);
