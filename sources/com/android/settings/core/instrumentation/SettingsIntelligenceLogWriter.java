...
public class SettingsIntelligenceLogWriter implements LogWriter {
    ...
    public /* synthetic */ void lambda$new$1() {
        ...
        String string = appContext.getString(C1992R$string.config_settingsintelligence_log_action);
        if (!TextUtils.isEmpty(string) && !this.mSettingsLogList.isEmpty()) {
            Intent intent = new Intent();
            intent.setPackage(appContext.getString(C1992R$string.config_settingsintelligence_package_name));
