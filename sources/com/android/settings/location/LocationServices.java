...
public class LocationServices extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.location_services) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.location_services;
    }
