...
public class LocationSettingsFooterPreferenceController extends LocationBasePreferenceController {
    ...
    private void updateFooterPreference() {
        String string = this.mContext.getString(C1992R$string.location_settings_footer_general);
        if (!this.mLocationEnabled) {
            string = this.mContext.getString(C1992R$string.location_settings_footer_location_off) + PARAGRAPH_SEPARATOR + string;
        ...
        if (footerPreference != null) {
            ...
            this.mFooterPreference.setLearnMoreAction(new C1027x1c41a299(this));
            this.mFooterPreference.setLearnMoreContentDescription(this.mContext.getString(C1992R$string.location_settings_footer_learn_more_content_description));
        }
    }
    ...
    private void openLocationLearnMoreLink() {
        ...
        dashboardFragment.startActivityForResult(HelpUtils.getHelpIntent(context, context.getString(C1992R$string.location_settings_footer_learn_more_link), ""), 0);
    }
