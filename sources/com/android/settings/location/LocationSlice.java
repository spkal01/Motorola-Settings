...
public class LocationSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, 17303730);
        CharSequence text = this.mContext.getText(C1992R$string.location_settings_title);
    ...
    public Intent getIntent() {
        String charSequence = this.mContext.getText(C1992R$string.location_settings_title).toString();
