...
public class LocationForWorkPreferenceController extends LocationBasePreferenceController {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        this.mPreference.setSummary(isChecked ? C1992R$string.switch_on_text : C1992R$string.switch_off_text);
        return true;
    }
    ...
    public void onLocationModeChanged(int i, boolean z) {
        ...
        if (this.mPreference.isVisible() && isAvailable()) {
            ...
            if (this.mLocationEnabler.isManagedProfileRestrictedByBase() || !isEnabled) {
                ...
                if (isEnabled) {
                    i2 = C1992R$string.switch_off_text;
                } else {
                    i2 = C1992R$string.location_app_permission_summary_location_off;
                }
            } else {
                this.mPreference.setChecked(true);
                i2 = C1992R$string.switch_on_text;
            }
