...
public class LocationServicesForWork extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.location_services_workprofile) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.location_services_workprofile;
    }
