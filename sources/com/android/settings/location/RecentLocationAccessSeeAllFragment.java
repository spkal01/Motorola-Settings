...
public class RecentLocationAccessSeeAllFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.location_recent_access_see_all);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.location_recent_access_see_all;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        this.mShowSystemMenu = menu.add(0, 2, 0, C1992R$string.menu_show_system);
        this.mHideSystemMenu = menu.add(0, 3, 0, C1992R$string.menu_hide_system);
        updateMenu();
    }
}
