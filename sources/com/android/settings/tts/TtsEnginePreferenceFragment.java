...
public class TtsEnginePreferenceFragment extends RadioButtonPickerFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.tts_engine_picker);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.tts_engine_picker;
    }
    ...
    private void displayDataAlert(EngineCandidateInfo engineCandidateInfo, DialogInterface.OnClickListener onClickListener) {
        ...
        new AlertDialog.Builder(getPrefContext()).setTitle(17039380).setMessage((CharSequence) this.mContext.getString(C1992R$string.tts_engine_security_warning, new Object[]{engineCandidateInfo.loadLabel()})).setCancelable(true).setPositiveButton(17039370, onClickListener).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create().show();
    }
