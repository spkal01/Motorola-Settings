...
public class ContextualCardFeedbackDialog extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mMessage = getText(C1992R$string.contextual_card_feedback_confirm_message);
        alertParams.mPositiveButtonText = getText(C1992R$string.contextual_card_feedback_send);
        alertParams.mPositiveButtonListener = this;
        alertParams.mNegativeButtonText = getText(C1992R$string.skip_label);
        setupAlert();
    }
