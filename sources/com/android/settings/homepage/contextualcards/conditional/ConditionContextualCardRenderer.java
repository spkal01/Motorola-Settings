...
public class ConditionContextualCardRenderer implements ContextualCardRenderer {
    public static final int VIEW_TYPE_FULL_WIDTH = C1987R$layout.conditional_card_full_tile;
    public static final int VIEW_TYPE_HALF_WIDTH = C1987R$layout.conditional_card_half_tile;
    ...
    private void initializePrimaryClick(ConditionalCardHolder conditionalCardHolder, ConditionalContextualCard conditionalContextualCard, MetricsFeatureProvider metricsFeatureProvider) {
        conditionalCardHolder.itemView.findViewById(C1985R$id.content).setOnClickListener(new ConditionContextualCardRenderer$$ExternalSyntheticLambda1(this, metricsFeatureProvider, conditionalContextualCard));
    }
    ...
    private void initializeActionButton(ConditionalCardHolder conditionalCardHolder, ConditionalContextualCard conditionalContextualCard, MetricsFeatureProvider metricsFeatureProvider) {
        ...
        Button button = (Button) conditionalCardHolder.itemView.findViewById(C1985R$id.first_action);
        if (z) {
