...
public class CellularDataConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f109ID = Objects.hash(new Object[]{"CellularDataConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f109ID).setMetricsConstant(380).setActionText(this.mAppContext.getText(C1992R$string.condition_turn_on));
        StringBuilder sb = new StringBuilder();
        sb.append(this.mAppContext.getPackageName());
        sb.append("/");
        Context context = this.mAppContext;
        int i = C1992R$string.condition_cellular_title;
        sb.append(context.getText(i));
        return actionText.setName(sb.toString()).setTitleText(this.mAppContext.getText(i).toString()).setSummaryText(this.mAppContext.getText(C1992R$string.condition_cellular_summary).toString()).setIconDrawable(this.mAppContext.getDrawable(C1983R$drawable.ic_cellular_off)).setViewType(ConditionContextualCardRenderer.VIEW_TYPE_HALF_WIDTH).build();
    }
