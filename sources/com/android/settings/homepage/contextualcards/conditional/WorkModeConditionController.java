...
public class WorkModeConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f116ID = Objects.hash(new Object[]{"WorkModeConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f116ID).setMetricsConstant(383).setActionText(this.mAppContext.getText(C1992R$string.condition_turn_on));
        StringBuilder sb = new StringBuilder();
        sb.append(this.mAppContext.getPackageName());
        sb.append("/");
        Context context = this.mAppContext;
        int i = C1992R$string.condition_work_title;
        sb.append(context.getText(i));
        return actionText.setName(sb.toString()).setTitleText(this.mAppContext.getText(i).toString()).setSummaryText(this.mAppContext.getText(C1992R$string.condition_work_summary).toString()).setIconDrawable(this.mAppContext.getDrawable(C1983R$drawable.ic_signal_workmode_enable)).setViewType(ConditionContextualCardRenderer.VIEW_TYPE_HALF_WIDTH).build();
    }
