...
public class ConditionHeaderContextualCardRenderer implements ContextualCardRenderer {
    public static final int VIEW_TYPE = C1987R$layout.conditional_card_header;
    ...
    public /* synthetic */ void lambda$bindView$0(ConditionHeaderCardHolder conditionHeaderCardHolder, ContextualCard contextualCard) {
        ImageView imageView = (ImageView) LayoutInflater.from(this.mContext).inflate(C1987R$layout.conditional_card_header_icon, conditionHeaderCardHolder.icons, false);
    ...
    public static class ConditionHeaderCardHolder extends RecyclerView.ViewHolder {
        ...
        public ConditionHeaderCardHolder(View view) {
            super(view);
            this.icons = (LinearLayout) view.findViewById(C1985R$id.header_icons_container);
            this.expandIndicator = (ImageView) view.findViewById(C1985R$id.expand_indicator);
        }
    }
}
