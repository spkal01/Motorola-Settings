...
public class DarkThemeSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        ...
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C1983R$drawable.dark_theme);
        ...
        return new ListBuilder(this.mContext, CustomSliceRegistry.DARK_THEME_SLICE_URI, -1).setAccentColor(colorAccentDefaultColor).addRow(new ListBuilder.RowBuilder().setTitle(this.mContext.getText(C1992R$string.dark_theme_slice_title)).setTitleItem(createWithResource, 0).setSubtitle(this.mContext.getText(C1992R$string.dark_theme_slice_subtitle)).setPrimaryAction(SliceAction.createToggle(broadcastIntent, (CharSequence) null, isNightMode))).build();
    }
