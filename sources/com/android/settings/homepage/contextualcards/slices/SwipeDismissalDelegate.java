...
public class SwipeDismissalDelegate extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        if ((viewHolder.getItemViewType() == SliceContextualCardRenderer.VIEW_TYPE_FULL_WIDTH || viewHolder.getItemViewType() == SliceContextualCardRenderer.VIEW_TYPE_HALF_WIDTH) && viewHolder.itemView.findViewById(C1985R$id.dismissal_view).getVisibility() != 0) {
    ...
    public void onChildDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float f, float f2, int i, boolean z) {
        ...
        View findViewById = viewHolder.itemView.findViewById(C1985R$id.dismissal_icon_start);
        View findViewById2 = viewHolder.itemView.findViewById(C1985R$id.dismissal_icon_end);
        if (f > 0.0f) {
