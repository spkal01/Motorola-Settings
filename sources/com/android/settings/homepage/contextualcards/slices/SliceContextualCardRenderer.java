...
public class SliceContextualCardRenderer implements ContextualCardRenderer, LifecycleObserver {
    public static final int VIEW_TYPE_FULL_WIDTH = C1987R$layout.contextual_slice_full_tile;
    public static final int VIEW_TYPE_HALF_WIDTH = C1987R$layout.contextual_slice_half_tile;
    public static final int VIEW_TYPE_STICKY = C1987R$layout.contextual_slice_sticky_tile;
    ...
    public void bindView(RecyclerView.ViewHolder viewHolder, ContextualCard contextualCard) {
        ...
        View findViewById = viewHolder.itemView.findViewById(C1985R$id.dismissal_swipe_background);
    ...
    private void initDismissalActions(RecyclerView.ViewHolder viewHolder, final ContextualCard contextualCard) {
        ((Button) viewHolder.itemView.findViewById(C1985R$id.keep)).setOnClickListener(new SliceContextualCardRenderer$$ExternalSyntheticLambda0(this, viewHolder));
        ((Button) viewHolder.itemView.findViewById(C1985R$id.remove)).setOnClickListener(new SliceContextualCardRenderer$$ExternalSyntheticLambda1(this, contextualCard, viewHolder));
    ...
    public void lambda$onStop$5(RecyclerView.ViewHolder viewHolder) {
        viewHolder.itemView.findViewById(C1985R$id.dismissal_view).setVisibility(8);
        getInitialView(viewHolder).setVisibility(0);
    }

    private void showDismissalView(RecyclerView.ViewHolder viewHolder) {
        viewHolder.itemView.findViewById(C1985R$id.dismissal_view).setVisibility(0);
