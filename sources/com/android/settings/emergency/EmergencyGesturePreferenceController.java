...
public class EmergencyGesturePreferenceController extends BasePreferenceController implements OnMainSwitchChangeListener {
    ...
    public int getAvailabilityStatus() {
        return !this.mContext.getResources().getBoolean(C1980R$bool.config_show_emergency_gesture_settings) ? 3 : 0;
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        mainSwitchPreference.setTitle(this.mContext.getString(C1992R$string.emergency_gesture_switchbar_title));
