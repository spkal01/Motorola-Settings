...
public class EmergencyGestureSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.emergency_gesture_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.emergency_gesture_settings;
    }
}
