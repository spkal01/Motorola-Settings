...
public class EmergencyGestureNumberOverridePreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(C1980R$bool.config_show_emergency_gesture_settings) ? 0 : 3;
    }
    ...
    public CharSequence getSummary() {
        ...
        String string = this.mContext.getString(C1992R$string.emergency_gesture_call_for_help_summary, new Object[]{policeNumber});
