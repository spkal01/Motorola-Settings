...
public class MoreSettingsPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        Button button = (Button) layoutPreference.findViewById(C1985R$id.button);
    ...
    private Drawable getIcon() {
        try {
            ApplicationInfo applicationInfo = this.mContext.getPackageManager().getApplicationInfo(this.mContext.getResources().getString(C1992R$string.config_emergency_package_name), 33280);
    ...
    private CharSequence getButtonText() {
        String string = this.mContext.getResources().getString(C1992R$string.config_emergency_package_name);
        try {
            PackageManager packageManager = this.mContext.getPackageManager();
            ApplicationInfo applicationInfo = packageManager.getApplicationInfo(string, 33280);
            return this.mContext.getString(C1992R$string.open_app_button, new Object[]{applicationInfo.loadLabel(packageManager)});
    ...
    public void updateState(Preference preference) {
        ...
        updateIntent();
        this.mPreference.setVisible(this.mIntent != null);
    }
}
