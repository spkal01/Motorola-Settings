...
public class EmergencyActionContentProvider extends ContentProvider {
    ...
    private static boolean isEmergencyInfo(Context context) {
        return TextUtils.equals(context.getPackageManager().getPackagesForUid(Binder.getCallingUid())[0], context.getString(C1992R$string.config_aosp_emergency_package_name));
    }
