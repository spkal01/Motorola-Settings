...
public class AppMemoryPreferenceController extends BasePreferenceController implements LifecycleObserver, OnResume {
        ...
        public void onPostExecute(ProcStatsPackageEntry procStatsPackageEntry) {
            if (AppMemoryPreferenceController.this.mParent.getActivity() != null) {
                if (procStatsPackageEntry != null) {
                    ...
                    AppMemoryPreferenceController.this.mPreference.setSummary((CharSequence) AppMemoryPreferenceController.this.mContext.getString(C1992R$string.memory_use_summary, new Object[]{Formatter.formatShortFileSize(AppMemoryPreferenceController.this.mContext, (long) max)}));
                    return;
                }
                AppMemoryPreferenceController.this.mPreference.setEnabled(false);
                AppMemoryPreferenceController.this.mPreference.setSummary((CharSequence) AppMemoryPreferenceController.this.mContext.getString(C1992R$string.no_memory_use_summary));
            }
        }
    }
    ...
    public int getAvailabilityStatus() {
        if (!this.mContext.getResources().getBoolean(C1980R$bool.config_show_app_info_settings_memory)) {
            return 3;
        }
