...
public class AppHeaderViewPreferenceController extends BasePreferenceController implements AppInfoDashboardFragment.Callback, LifecycleObserver {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mEntityHeaderController = EntityHeaderController.newInstance(this.mParent.getActivity(), this.mParent, this.mHeader.findViewById(C1985R$id.entity_header)).setRecyclerView(this.mParent.getListView(), this.mLifecycle).setPackageName(this.mPackageName).setButtonActions(0, 0).bindHeaderButtons();
    }
