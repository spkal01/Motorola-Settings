...
public class AppDataUsagePreferenceController extends AppInfoPreferenceControllerBase implements LoaderManager.LoaderCallbacks<List<NetworkCycleDataForUid>>, LifecycleObserver, OnResume, OnPause {
    ...
    private CharSequence getDataSummary() {
        if (this.mAppUsageData == null) {
            return this.mContext.getString(C1992R$string.computing_size);
        }
        ...
        if (j == 0) {
            return this.mContext.getString(C1992R$string.no_data_usage);
        }
        Context context = this.mContext;
        return context.getString(C1992R$string.data_summary_format, new Object[]{Formatter.formatFileSize(context, j, 8), DateUtils.formatDateTime(this.mContext, currentTimeMillis, 65552)});
    }
