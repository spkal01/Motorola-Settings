...
public class ExternalSourceDetailPreferenceController extends AppInfoPreferenceControllerBase {
    ...
    public CharSequence getPreferenceSummary() {
        return (this.mParent.getAppEntry() == null || this.mParent.getAppEntry().info == null) ? "" : ExternalSourcesDetails.getPreferenceSummary(this.mContext, this.mParent.getAppEntry());
    }
