...
public abstract class DefaultAppShortcutPreferenceControllerBase extends BasePreferenceController {
    ...
    public DefaultAppShortcutPreferenceControllerBase(Context context, String str, String str2, String str3) {
        ...
        roleManager.isRoleVisible(str2, mainExecutor, new C0702x5368185e(this));
        roleManager.isApplicationVisibleForRole(str2, str3, mainExecutor, new C0701x5368185d(this));
    }
    ...
    public CharSequence getSummary() {
        return this.mContext.getText(isDefaultApp() ? C1992R$string.yes : C1992R$string.f61no);
    }
