...
public class InstantAppButtonsPreferenceController extends BasePreferenceController implements LifecycleObserver, OnCreateOptionsMenu, OnPrepareOptionsMenu, OnOptionsItemSelected {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        initButtons(layoutPreference.findViewById(C1985R$id.instant_app_button_container));
    }

    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        if (!TextUtils.isEmpty(this.mLaunchUri)) {
            menu.add(0, 3, 2, C1992R$string.install_text).setShowAsAction(0);
        }
    }
    ...
    private void initButtons(View view) {
        Button button = (Button) view.findViewById(C1985R$id.install);
        Button button2 = (Button) view.findViewById(C1985R$id.clear_data);
        Button button3 = (Button) view.findViewById(C1985R$id.launch);
        if (!TextUtils.isEmpty(this.mLaunchUri)) {
