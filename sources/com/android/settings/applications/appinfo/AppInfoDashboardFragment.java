...
public class AppInfoDashboardFragment extends DashboardFragment implements ApplicationsState.Callbacks, ButtonActionDialogFragment.AppButtonsDialogListener {
    ...
    public void onAttach(Context context) {
        Class cls = AppPermissionPreferenceController.class;
        ...
        ((AppPermissionPreferenceController) use(cls)).setParentFragment(this);
        ((AppPermissionPreferenceController) use(cls)).setPackageName(packageName);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.app_info_settings;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        menu.add(0, 2, 0, C1992R$string.app_factory_reset).setShowAsAction(0);
        menu.add(0, 1, 1, C1992R$string.uninstall_all_users_text).setShowAsAction(0);
    }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        if (!this.mFinishing) {
            ...
            boolean z2 = getContext().getResources().getBoolean(C1980R$bool.config_disable_uninstall_update);
    ...
    public void retrieveAppEntry() {
        ...
        if (activity != null && !this.mFinishing) {
            ...
            int uid = getUid();
            boolean isCloneAppByUid = CloneAppUtils.isCloneAppByUid(uid);
            this.mUserId = isCloneAppByUid ? UserHandle.getUserId(uid) : UserHandle.myUserId();
            ApplicationsState.AppEntry entry = this.mState.getEntry(getPackageName(), this.mUserId);
            this.mAppEntry = entry;
            if (entry != null) {
                entry.extraInfo = null;
                if (isCloneAppByUid) {
                    try {
                        this.mPackageInfo = activity.getPackageManager().getPackageInfoAsUser(this.mAppEntry.info.packageName, 4198976, this.mUserId);
