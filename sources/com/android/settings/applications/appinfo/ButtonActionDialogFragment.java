...
public class ButtonActionDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    private AlertDialog createDialog(int i) {
        ...
        if (i == 0 || i == 1) {
            return new AlertDialog.Builder(context).setMessage(C1992R$string.app_disable_dlg_text).setPositiveButton(C1992R$string.app_disable_dlg_positive, (DialogInterface.OnClickListener) this).setNegativeButton(C1992R$string.dlg_cancel, (DialogInterface.OnClickListener) null).create();
        }
        if (i != 2) {
            return null;
        }
        return new AlertDialog.Builder(context).setTitle(C1992R$string.force_stop_dlg_title).setMessage(C1992R$string.force_stop_dlg_text).setPositiveButton(C1992R$string.dlg_ok, (DialogInterface.OnClickListener) this).setNegativeButton(C1992R$string.dlg_cancel, (DialogInterface.OnClickListener) null).create();
    }
}
