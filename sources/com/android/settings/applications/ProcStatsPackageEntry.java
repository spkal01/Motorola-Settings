...
public class ProcStatsPackageEntry implements Parcelable {
    ...
    public void retrieveUiData(Context context, PackageManager packageManager) {
        ...
        try {
            if ("os".equals(str)) {
                ...
                this.mUiLabel = context.getString(C1992R$string.process_stats_os_label);
                return;
            }
    ...
    public static CharSequence getFrequency(float f, Context context) {
        if (f > 0.95f) {
            return context.getString(C1992R$string.always_running, new Object[]{Utils.formatPercentage((int) (f * 100.0f))});
        } else if (f > 0.25f) {
            return context.getString(C1992R$string.sometimes_running, new Object[]{Utils.formatPercentage((int) (f * 100.0f))});
        } else {
            return context.getString(C1992R$string.rarely_running, new Object[]{Utils.formatPercentage((int) (f * 100.0f))});
        }
    }
