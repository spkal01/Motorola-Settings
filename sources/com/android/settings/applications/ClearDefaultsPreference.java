...
public class ClearDefaultsPreference extends Preference {
    ...
    public ClearDefaultsPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setLayoutResource(C1987R$layout.app_preferred_settings);
    ...
    public void onBindViewHolder(final PreferenceViewHolder preferenceViewHolder) {
        ...
        Button button = (Button) preferenceViewHolder.findViewById(C1985R$id.clear_activities_button);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (ClearDefaultsPreference.this.mAppsControlDisallowedAdmin != null && !ClearDefaultsPreference.this.mAppsControlDisallowedBySystem) {
                    ...
                    ClearDefaultsPreference.this.resetLaunchDefaultsUi((TextView) preferenceViewHolder.findViewById(C1985R$id.auto_launch));
                }
            }
        });
    ...
    public boolean updateUI(PreferenceViewHolder preferenceViewHolder) {
        ...
        TextView textView = (TextView) preferenceViewHolder.findViewById(C1985R$id.auto_launch);
        ...
        if (z || hasBindAppWidgetPermission) {
            ...
            if (hasBindAppWidgetPermission) {
                textView.setText(C1992R$string.auto_launch_label_generic);
            } else {
                textView.setText(C1992R$string.auto_launch_label);
            }
            Context context = getContext();
            CharSequence charSequence = null;
            int dimensionPixelSize = context.getResources().getDimensionPixelSize(C1982R$dimen.installed_app_details_bullet_offset);
            if (z) {
                CharSequence text = context.getText(C1992R$string.auto_launch_enable_text);
            ...
            if (hasBindAppWidgetPermission) {
                CharSequence text2 = context.getText(C1992R$string.always_allow_bind_appwidgets_text);
    ...
    public void resetLaunchDefaultsUi(TextView textView) {
        textView.setText(C1992R$string.auto_launch_disable_text);
