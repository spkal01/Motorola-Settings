...
public class UsageAccessDetails extends AppInfoWithHeader implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.app_ops_permissions_details);
        ...
        getPreferenceScreen().setTitle(C1992R$string.usage_access);
        this.mSwitchPref.setTitle(C1992R$string.permit_usage_access);
        this.mUsageDesc.setTitle(C1992R$string.usage_access_description);
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if (!(this.mUsageState == null || ((Boolean) obj).booleanValue() == this.mUsageState.isPermissible())) {
            if (this.mUsageState.isPermissible() && this.mDpm.isProfileOwnerApp(this.mPackageName)) {
                new AlertDialog.Builder(getContext()).setIcon(17303280).setTitle(17039380).setMessage(C1992R$string.work_profile_usage_access_warning).setPositiveButton(C1992R$string.okay, (DialogInterface.OnClickListener) null).show();
            }
