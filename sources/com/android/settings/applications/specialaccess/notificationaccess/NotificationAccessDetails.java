...
public class NotificationAccessDetails extends DashboardFragment {
    ...
    public void onResume() {
        ...
        getPreferenceScreen().findPreference("notification_top_intro").setTitle((CharSequence) getString(C1992R$string.notification_listener_security_warning_summary, this.mPackageInfo.applicationInfo.loadLabel(this.mPm)));
    ...
    public /* synthetic */ boolean lambda$onResume$2(Preference preference) {
        ...
        new SubSettingLauncher(getContext()).setDestination(BridgedAppsSettings.class.getName()).setSourceMetricsCategory(getMetricsCategory()).setTitleRes(C1992R$string.notif_listener_excluded_app_screen_title).setArguments(bundle).setUserHandle(UserHandle.of(this.mUserId)).launch();
        return true;
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.notification_access_permission_details;
    }
}
