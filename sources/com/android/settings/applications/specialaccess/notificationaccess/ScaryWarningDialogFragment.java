...
public class ScaryWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(C1992R$string.notification_listener_security_warning_summary, new Object[]{charSequence})).setTitle((CharSequence) getResources().getString(C1992R$string.notification_listener_security_warning_title, new Object[]{charSequence})).setCancelable(true).setPositiveButton(C1992R$string.allow, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                notificationAccessDetails.enable(unflattenFromString);
            }
        }).setNegativeButton(C1992R$string.deny, (DialogInterface.OnClickListener) ScaryWarningDialogFragment$$ExternalSyntheticLambda0.INSTANCE).create();
    }
}
