...
public class FriendlyWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(C1992R$string.notification_listener_disable_warning_summary, new Object[]{charSequence})).setCancelable(true).setPositiveButton(C1992R$string.notification_listener_disable_warning_confirm, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                notificationAccessDetails.disable(unflattenFromString);
            }
        }).setNegativeButton(C1992R$string.notification_listener_disable_warning_cancel, (DialogInterface.OnClickListener) FriendlyWarningDialogFragment$$ExternalSyntheticLambda0.INSTANCE).create();
    }
}
