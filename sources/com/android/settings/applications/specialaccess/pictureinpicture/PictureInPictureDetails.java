...
public class PictureInPictureDetails extends AppInfoWithHeader implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.picture_in_picture_permissions_details);
        ...
        switchPreference.setTitle(C1992R$string.picture_in_picture_app_detail_switch);
