...
public class PictureInPictureSettings extends EmptyTextSettings {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.picture_in_picture_settings);
        ...
        while (it.hasNext()) {
            ...
            appPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    int i = C1992R$string.picture_in_picture_app_detail_title;
                    String str = str;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setEmptyText(C1992R$string.picture_in_picture_empty_text);
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.picture_in_picture_settings;
    }
