...
public class InteractAcrossProfilesSettings extends EmptyTextSettings {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.interact_across_profiles);
        ...
        while (it.hasNext()) {
            ...
            appPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    int i = C1992R$string.interact_across_profiles_title;
                    String str = str;
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setEmptyText(C1992R$string.interact_across_profiles_empty_text);
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.interact_across_profiles;
    }
    ...
    static ArrayList<Pair<ApplicationInfo, UserHandle>> collectConfigurableApps(PackageManager packageManager, UserManager userManager, CrossProfileApps crossProfileApps) {
        ...
        List<PackageInfo> allInstalledPackages = getAllInstalledPackages(packageManager, profileParent, workProfile);
        CloneAppUtils.collectCloneApps(userManager, packageManager, allInstalledPackages);
        for (PackageInfo next : allInstalledPackages) {
