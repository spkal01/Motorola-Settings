...
public class InteractAcrossProfilesController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (numberOfEnabledApps == 0) {
            return this.mContext.getResources().getString(C1992R$string.interact_across_profiles_number_of_connected_apps_none);
        }
        return this.mContext.getResources().getQuantityString(C1990R$plurals.interact_across_profiles_number_of_connected_apps, numberOfEnabledApps, new Object[]{Integer.valueOf(numberOfEnabledApps)});
    }
}
