...
public class VrListenerSettings extends ManagedServiceSettings {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.vr_listeners_settings);
    ...
    static {
        ...
        TAG = simpleName;
        CONFIG = new ManagedServiceSettings.Config.Builder().setTag(simpleName).setSetting("enabled_vr_listeners").setIntentAction("android.service.vr.VrListenerService").setPermission("android.permission.BIND_VR_LISTENER_SERVICE").setNoun("vr listener").setWarningDialogTitle(C1992R$string.vr_listener_security_warning_title).setWarningDialogSummary(C1992R$string.vr_listener_security_warning_summary).setEmptyText(C1992R$string.no_vr_listeners).build();
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.vr_listeners_settings;
    }
