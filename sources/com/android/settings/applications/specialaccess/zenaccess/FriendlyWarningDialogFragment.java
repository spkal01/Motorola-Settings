...
public class FriendlyWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(C1992R$string.zen_access_revoke_warning_dialog_summary)).setTitle((CharSequence) getResources().getString(C1992R$string.zen_access_revoke_warning_dialog_title, new Object[]{string2})).setCancelable(true).setPositiveButton(C1992R$string.okay, (DialogInterface.OnClickListener) new FriendlyWarningDialogFragment$$ExternalSyntheticLambda0(this, string, (ZenAccessDetails) getTargetFragment())).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) FriendlyWarningDialogFragment$$ExternalSyntheticLambda1.INSTANCE).create();
    }
