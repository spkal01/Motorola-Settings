...
public class SupportedLinksDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(activity).setTitle((CharSequence) IntentPickerUtils.getCentralizedDialogTitle(getSupportedLinksTitle())).setAdapter(new SupportedLinksAdapter(activity, this.mSupportedLinkWrapperList), (DialogInterface.OnClickListener) null).setCancelable(true).setPositiveButton(C1992R$string.app_launch_supported_links_add, (DialogInterface.OnClickListener) new SupportedLinksDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(C1992R$string.app_launch_dialog_cancel, (DialogInterface.OnClickListener) null).create();
    }
    ...
    private String getSupportedLinksTitle() {
        ...
        return getResources().getQuantityString(C1990R$plurals.app_launch_supported_links_title, size, new Object[]{Integer.valueOf(size)});
    }
