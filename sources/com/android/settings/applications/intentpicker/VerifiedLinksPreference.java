...
public class VerifiedLinksPreference extends TwoTargetPreference {
    ...
    private void init(Context context) {
        ...
        setWidgetLayoutResource(C1987R$layout.verified_links_widget);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        int i = 0;
        preferenceViewHolder.findViewById(C1985R$id.two_target_divider).setVisibility(0);
        findViewById.setVisibility(0);
        View.OnClickListener onClickListener = this.mOnWidgetClickListener;
        if (onClickListener != null) {
            findViewById.setOnClickListener(onClickListener);
        }
        View findViewById2 = preferenceViewHolder.findViewById(C1985R$id.checkbox_container);
