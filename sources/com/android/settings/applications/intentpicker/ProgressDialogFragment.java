...
public class ProgressDialogFragment extends InstrumentedDialogFragment {
    ...
    private ProgressAlertDialog createProgressAlertDialog() {
        ...
        progressAlertDialog.setTitle(IntentPickerUtils.getCentralizedDialogTitle(activity.getResources().getString(C1992R$string.app_launch_checking_links_title)));
        progressAlertDialog.setButton(-2, activity.getText(C1992R$string.app_launch_dialog_cancel), ProgressDialogFragment$$ExternalSyntheticLambda0.INSTANCE);
    ...
    static class ProgressAlertDialog extends AlertDialog {
        ...
        private void init(Context context) {
            View inflate = LayoutInflater.from(context).inflate(C1987R$layout.app_launch_progress, (ViewGroup) null);
            ProgressBar progressBar = (ProgressBar) inflate.findViewById(C1985R$id.scan_links_progressbar);
