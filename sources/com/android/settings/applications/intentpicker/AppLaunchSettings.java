...
public class AppLaunchSettings extends AppInfoBase implements Preference.OnPreferenceChangeListener, OnMainSwitchChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.installed_app_launch_settings);
    ...
    private AlertDialog createVerifiedLinksDialog() {
        int linksNumber = getLinksNumber(2);
        View inflate = LayoutInflater.from(this.mContext).inflate(C1987R$layout.app_launch_verified_links_title, (ViewGroup) null);
        ((TextView) inflate.findViewById(C1985R$id.dialog_title)).setText(getVerifiedLinksTitle(linksNumber));
        ((TextView) inflate.findViewById(C1985R$id.dialog_message)).setText(getVerifiedLinksMessage(linksNumber));
        return new AlertDialog.Builder(this.mContext).setCustomTitle(inflate).setCancelable(true).setItems((CharSequence[]) IntentPickerUtils.getLinksList(this.mDomainVerificationManager, this.mPackageName, 2).toArray(new String[0]), (DialogInterface.OnClickListener) null).setPositiveButton(C1992R$string.app_launch_dialog_ok, (DialogInterface.OnClickListener) null).create();
    }

    /* access modifiers changed from: package-private */
    public String getVerifiedLinksTitle(int i) {
        return getResources().getQuantityString(C1990R$plurals.app_launch_verified_links_title, i, new Object[]{Integer.valueOf(i)});
    }

    private String getVerifiedLinksMessage(int i) {
        return getResources().getQuantityString(C1990R$plurals.app_launch_verified_links_message, i, new Object[]{Integer.valueOf(i)});
    }
    ...
    private void initFooter() {
        CharSequence text = this.mContext.getText(C1992R$string.app_launch_footer);
    ...
    private String getLabelName() {
        return this.mContext.getString(C1992R$string.launch_by_default);
    }
