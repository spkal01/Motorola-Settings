...
public class RunningState {
    ...
    final Handler mHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message r3) {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.applications.RunningState.C06932.handleMessage(android.os.Message):void");
        }
    };
    boolean mHaveData;
    ...
    static class ProcessItem extends BaseItem {
        ...
        public ProcessItem(Context context, int i, String str) {
            ...
            this.mDescription = context.getResources().getString(C1992R$string.service_process_name, new Object[]{str});
            this.mUid = i;
        ...
        public boolean updateService(Context context, ActivityManager.RunningServiceInfo runningServiceInfo) {
            ...
            if (str == null || runningServiceInfo.clientLabel == 0) {
                ...
                serviceItem.mDescription = context.getResources().getString(C1992R$string.service_started_by_app);
                return z2;
            }
            if (serviceItem.mShownAsStarted) {
            ...
            try {
                serviceItem.mDescription = context.getResources().getString(C1992R$string.service_client_name, new Object[]{packageManager.getResourcesForApplication(str).getString(runningServiceInfo.clientLabel)});
                return z;
            } catch (PackageManager.NameNotFoundException unused2) {
    ...
    static class MergedItem extends BaseItem {
        ...
        private void setDescription(Context context, int i, int i2) {
            if (this.mLastNumProcesses != i || this.mLastNumServices != i2) {
                ...
                int i3 = C1992R$string.running_processes_item_description_s_s;
                if (i != 1) {
                    if (i2 != 1) {
                        i3 = C1992R$string.running_processes_item_description_p_p;
                    } else {
                        i3 = C1992R$string.running_processes_item_description_p_s;
                    }
                } else if (i2 != 1) {
                    i3 = C1992R$string.running_processes_item_description_s_p;
                }
        ...
        public Drawable loadIcon(Context context, RunningState runningState) {
            ...
            if (drawable == null) {
                return context.getDrawable(17303581);
            }
