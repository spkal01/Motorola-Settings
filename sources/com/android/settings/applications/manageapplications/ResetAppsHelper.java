        ...
        if (this.mResetDialog == dialogInterface) {
            AsyncTask.execute(new Runnable() {
                public void run() {
                    ...
                    List asList = Arrays.asList(ResetAppsHelper.this.mContext.getResources().getStringArray(C1978R$array.config_skip_reset_apps_package_name));
