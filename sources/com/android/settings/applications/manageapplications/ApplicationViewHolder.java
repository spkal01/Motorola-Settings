...
public class ApplicationViewHolder extends RecyclerView.ViewHolder {
    ...
    ApplicationViewHolder(View view) {
        ...
        this.mDisabled = (TextView) view.findViewById(C1985R$id.appendix);
        this.mSwitch = (Switch) view.findViewById(C1985R$id.switchWidget);
        this.mWidgetContainer = (ViewGroup) view.findViewById(16908312);
    }

    static View newView(ViewGroup viewGroup, boolean z) {
        ViewGroup viewGroup2 = (ViewGroup) LayoutInflater.from(viewGroup.getContext()).inflate(C1987R$layout.preference_app, viewGroup, false);
        ViewGroup viewGroup3 = (ViewGroup) viewGroup2.findViewById(16908312);
        if (z) {
            if (viewGroup3 != null) {
                LayoutInflater.from(viewGroup.getContext()).inflate(C1987R$layout.preference_widget_primary_switch, viewGroup3, true);
                viewGroup2.addView(LayoutInflater.from(viewGroup.getContext()).inflate(C1987R$layout.preference_two_target_divider, viewGroup2, false), viewGroup2.getChildCount() - 1);
            }
    ...
    static View newViewWithoutDivider(ViewGroup viewGroup, boolean z) {
        View newView = newView(viewGroup, z);
        View findViewById = newView.findViewById(C1985R$id.two_target_divider);
    ...
    public void updateDisableView(ApplicationInfo applicationInfo) {
        if ((applicationInfo.flags & 8388608) == 0) {
            ...
            this.mDisabled.setText(C1992R$string.not_installed);
        } else if (!applicationInfo.enabled || applicationInfo.enabledSetting == 4) {
            this.mDisabled.setVisibility(0);
            this.mDisabled.setText(C1992R$string.disabled);
        } else {
