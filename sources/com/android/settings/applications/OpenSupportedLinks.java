...
public class OpenSupportedLinks extends AppInfoWithHeader implements RadioButtonPreference.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.open_supported_links);
    ...
    public void initRadioPreferencesGroup() {
        ...
        this.mAllowOpening = makeRadioPreference("app_link_open_always", C1992R$string.app_link_open_always);
        int entriesNo = getEntriesNo();
        this.mAllowOpening.setAppendixVisibility(8);
        this.mAllowOpening.setSummary((CharSequence) getResources().getQuantityString(C1990R$plurals.app_link_open_always_summary, entriesNo, new Object[]{Integer.valueOf(entriesNo)}));
        this.mAskEveryTime = makeRadioPreference("app_link_open_ask", C1992R$string.app_link_open_ask);
        this.mNotAllowed = makeRadioPreference("app_link_open_never", C1992R$string.app_link_open_never);
