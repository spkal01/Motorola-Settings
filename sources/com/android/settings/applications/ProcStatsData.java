...
public class ProcStatsData {
    ...
    private void distributeZRam(double d) {
        ...
        while (size3 >= 0 && j3 > j2) {
            ...
            if (j7 > j2) {
                j -= j7;
                j3 -= j4;
                ProcStatsEntry procStatsEntry = new ProcStatsEntry(procStatsPackageEntry2.mPackage, 0, this.mContext.getString(C1992R$string.process_stats_os_zram), j5, j7, this.memTotalTime);
    ...
    private ProcStatsPackageEntry createOsEntry(ProcessStats.ProcessDataCollection processDataCollection, ProcessStats.ProcessDataCollection processDataCollection2, ProcessStats.TotalMemoryUseCollection totalMemoryUseCollection, long j) {
        ...
        if (totalMemoryUseCollection2.sysMemNativeWeight > 0.0d) {
            String string = this.mContext.getString(C1992R$string.process_stats_os_native);
        ...
        if (totalMemoryUseCollection2.sysMemKernelWeight > 0.0d) {
            String string2 = this.mContext.getString(C1992R$string.process_stats_os_kernel);
        ...
        if (j > 0) {
            String string3 = this.mContext.getString(C1992R$string.process_stats_os_cache);
