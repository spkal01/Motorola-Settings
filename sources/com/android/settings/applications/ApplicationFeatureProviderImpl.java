...
public class ApplicationFeatureProviderImpl implements ApplicationFeatureProvider {
    ...
    public void calculateNumberOfAppsWithAdminGrantedPermissions(String[] strArr, boolean z, ApplicationFeatureProvider.NumberOfAppsCallback numberOfAppsCallback) {
        C0675xa96aca6e currentUserAndManagedProfileAppWithAdminGrantedPermissionsCounter = new C0675xa96aca6e(this.mContext, strArr, this.mPm, this.mPms, this.mDpm, numberOfAppsCallback);
        if (z) {
    ...
    private Set<String> getEnabledPackageAllowlist() {
        ArraySet arraySet = new ArraySet();
        arraySet.add(this.mContext.getString(C1992R$string.config_settingsintelligence_package_name));
        arraySet.add(this.mContext.getString(C1992R$string.config_package_installer_package_name));
    ...
    private static class C0675xa96aca6e extends AppWithAdminGrantedPermissionsCounter {
        private ApplicationFeatureProvider.NumberOfAppsCallback mCallback;

        C0675xa96aca6e(Context context, String[] strArr, PackageManager packageManager, IPackageManager iPackageManager, DevicePolicyManager devicePolicyManager, ApplicationFeatureProvider.NumberOfAppsCallback numberOfAppsCallback) {
