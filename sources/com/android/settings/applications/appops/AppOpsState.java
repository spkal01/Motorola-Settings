...
public class AppOpsState {
    ...
    public AppOpsState(Context context) {
        ...
        this.mOpSummaries = context.getResources().getTextArray(C1978R$array.app_ops_summaries);
        this.mOpLabels = context.getResources().getTextArray(C1978R$array.app_ops_labels);
    }
    ...
    public static class AppOpEntry {
        ...
        public CharSequence getTimeText(Resources resources, boolean z) {
            if (isRunning()) {
                return resources.getText(C1992R$string.app_ops_running);
            }
            if (getTime() > 0) {
                return DateUtils.getRelativeTimeSpanString(getTime(), System.currentTimeMillis(), 60000, 262144);
            }
            return z ? resources.getText(C1992R$string.app_ops_never_used) : "";
        }
