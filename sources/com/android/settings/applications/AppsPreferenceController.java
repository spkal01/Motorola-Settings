...
public class AppsPreferenceController extends BasePreferenceController implements LifecycleObserver {
        ...
        new InstalledAppCounter(context, -1, context.getPackageManager()) {
            ...
            public void onCountComplete(int i) {
                if (!AppsPreferenceController.this.mRecentApps.isEmpty()) {
                    ...
                    appsPreferenceController.mSeeAllPref.setTitle((CharSequence) appsPreferenceController.mContext.getResources().getQuantityString(C1990R$plurals.see_all_apps_title, i, new Object[]{Integer.valueOf(i)}));
                    return;
                }
                AppsPreferenceController appsPreferenceController2 = AppsPreferenceController.this;
                appsPreferenceController2.mAllAppsInfoPref.setSummary((CharSequence) appsPreferenceController2.mContext.getString(C1992R$string.apps_summary, new Object[]{Integer.valueOf(i)}));
            }
        }.execute(new Void[0]);
    }
    ...
    public /* synthetic */ boolean lambda$displayRecentApps$0(String str, ApplicationsState.AppEntry appEntry, Preference preference) {
        AppInfoBase.startAppInfoFragment(AppInfoDashboardFragment.class, C1992R$string.application_info_label, str, appEntry.info.uid, this.mHost, 1001, getMetricsCategory());
        return true;
    }
}
