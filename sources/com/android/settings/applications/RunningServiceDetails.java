...
public class RunningServiceDetails extends InstrumentedFragment implements RunningState.OnRefreshUiListener {
    ...
    public void addServicesHeader() {
        if (this.mNumServices == 0) {
            TextView textView = (TextView) this.mInflater.inflate(C1987R$layout.preference_category, this.mAllDetails, false);
            this.mServicesHeader = textView;
            textView.setText(C1992R$string.runningservicedetails_services_title);
    ...
    public void addProcessesHeader() {
        if (this.mNumProcesses == 0) {
            ...
            textView.setText(C1992R$string.runningservicedetails_processes_title);
    ...
    public void addServiceDetailsView(com.android.settings.applications.RunningState.ServiceItem r8, com.android.settings.applications.RunningState.MergedItem r9, boolean r10, boolean r11) {
        ...
        L_0x0016:
            ...
            int r3 = com.android.settings.C1987R$layout.running_service_details_service
            ...
            int r11 = com.android.settings.C1985R$id.service
        ...
        L_0x005f:
            int r11 = com.android.settings.C1985R$id.comp_description
            android.view.View r11 = r2.findViewById(r11)
            android.widget.TextView r11 = (android.widget.TextView) r11
            int r3 = com.android.settings.C1985R$id.left_button
            android.view.View r3 = r2.findViewById(r3)
            android.widget.Button r3 = (android.widget.Button) r3
            r1.mStopButton = r3
            int r3 = com.android.settings.C1985R$id.right_button
            android.view.View r3 = r2.findViewById(r3)
            android.widget.Button r3 = (android.widget.Button) r3
            r1.mReportButton = r3
            ...
            r11.setVisibility(r0)
            int r8 = com.android.settings.C1985R$id.control_buttons_panel
        ...
        L_0x00b4:
            ...
            int r9 = com.android.settings.C1992R$string.background_process_stop_description
            r11.setText(r9)
            goto L_0x00fe
        L_0x00be:
            ...
            int r2 = com.android.settings.C1992R$string.service_manage_description     // Catch:{ NameNotFoundException -> 0x00fe }
        ...
        L_0x00ec:
            ...
            int r0 = com.android.settings.C1992R$string.service_stop_description
            goto L_0x00f7
        L_0x00f5:
            int r0 = com.android.settings.C1992R$string.heavy_weight_stop_description
        L_0x00f7:
        ...
        L_0x00fe:
            ...
            int r0 = com.android.settings.C1992R$string.service_manage
            goto L_0x0112
        L_0x0110:
            int r0 = com.android.settings.C1992R$string.service_stop
        L_0x0112:
            ...
            r9.setOnClickListener(r1)
            android.widget.Button r9 = r1.mReportButton
            r11 = 17041325(0x10407ad, float:2.4250078E-38)
            r9.setText(r11)
            androidx.fragment.app.FragmentActivity r9 = r7.getActivity()
    ...
    public void addProcessDetailsView(RunningState.ProcessItem processItem, boolean z) {
        ...
        View inflate = this.mInflater.inflate(C1987R$layout.running_service_details_process, this.mAllDetails, false);
        ...
        TextView textView = (TextView) inflate.findViewById(C1985R$id.comp_description);
        if (processItem.mUserId != UserHandle.myUserId()) {
            textView.setVisibility(8);
        } else if (z) {
            textView.setText(C1992R$string.main_running_process_description);
        } else {
            ...
            if (i2 == 1) {
                i = C1992R$string.process_provider_in_use_description;
                ...
                i = C1992R$string.process_service_in_use_description;
                if (componentName != null) {
                    try {
        ...
        if (z) {
            ...
            if (mergedItem != null) {
                ...
                if (activeItem != null) {
                    ...
                    this.mSnippetActiveItem.mHolder.description.setText(C1992R$string.no_services);
                } else {
                    finish();
                    return;
                }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C1987R$layout.running_service_details, viewGroup, false);
        Utils.prepareCustomPreferencesList(viewGroup, inflate, inflate, false);
        this.mRootView = inflate;
        this.mAllDetails = (ViewGroup) inflate.findViewById(C1985R$id.all_details);
        ViewGroup viewGroup2 = (ViewGroup) inflate.findViewById(C1985R$id.snippet);
    ...
    public static class MyAlertDialogFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            if (i == 1) {
                ...
                return new AlertDialog.Builder(getActivity()).setTitle((CharSequence) getActivity().getString(C1992R$string.runningservicedetails_stop_dlg_title)).setMessage((CharSequence) getActivity().getString(C1992R$string.runningservicedetails_stop_dlg_text)).setPositiveButton(C1992R$string.dlg_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
