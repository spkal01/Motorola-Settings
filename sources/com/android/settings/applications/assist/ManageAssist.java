...
public class ManageAssist extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.manage_assist) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.manage_assist;
    }
