...
public class WhenToDreamPicker extends RadioButtonPickerFragment {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.when_to_dream_settings;
    }
    ...
    private String[] entries() {
        return getResources().getStringArray(C1978R$array.when_to_start_screensaver_entries);
    }

    private String[] keys() {
        return getResources().getStringArray(C1978R$array.when_to_start_screensaver_values);
    }
