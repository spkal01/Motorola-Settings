...
import com.motorola.settings.utils.MotoWipeBpUtils;
...
public class MainClearConfirm extends InstrumentedFragment {
    ...
    private View.OnClickListener mFinalClickListener = new View.OnClickListener() {
                ...
                if (MainClearConfirm.this.shouldWipePersistentDataBlock(persistentDataBlockManager)) {
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        public void onPreExecute() {
                            ProgressDialog access$100 = C05561.this.getProgressDialog();
        ...
        public ProgressDialog getProgressDialog() {
            ...
            progressDialog.setTitle(MainClearConfirm.this.getActivity().getString(C1992R$string.main_clear_progress_title));
            progressDialog.setMessage(MainClearConfirm.this.getActivity().getString(C1992R$string.main_clear_progress_text));
    ...
    public void doMainClear() {
        if (MotoWipeBpUtils.doBpWipeAndMasterClear(getActivity(), this.mEraseEsims, this.mEraseSdCard)) {
            Log.d("MainClearConfirm", "doMainClear(): diverted to do BP reset");
            return;
        }
    ...
    private void establishFinalConfirmationState() {
        ((FooterBarMixin) ((GlifLayout) this.mContentView.findViewById(C1985R$id.setup_wizard_layout)).getMixin(FooterBarMixin.class)).setPrimaryButton(new FooterButton.Builder(getActivity()).setText(C1992R$string.main_clear_button_text).setListener(this.mFinalClickListener).setButtonType(0).setTheme(C1993R$style.SudGlifButton_Primary).build());
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mContentView = layoutInflater.inflate(C1987R$layout.main_clear_confirm, (ViewGroup) null);
    ...
    private void setAccessibilityTitle() {
        ...
        TextView textView = (TextView) this.mContentView.findViewById(C1985R$id.sud_layout_description);
        if (textView != null) {
    ...
    public void setSubtitle() {
        if (this.mEraseEsims) {
            ((TextView) this.mContentView.findViewById(C1985R$id.sud_layout_description)).setText(C1992R$string.main_clear_final_desc_esim);
        }
    }
