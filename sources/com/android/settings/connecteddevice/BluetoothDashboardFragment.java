...
public class BluetoothDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.bluetooth_screen);
    ...
    public int getHelpResource() {
        return C1992R$string.help_uri_bluetooth_screen;
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.bluetooth_screen;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        switchBar.setTitle(getContext().getString(C1992R$string.bluetooth_main_switch_title));
