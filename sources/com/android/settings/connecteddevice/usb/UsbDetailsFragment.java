...
public class UsbDetailsFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.usb_details_fragment) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.usb_details_fragment;
    }
    ...
    public static List<UsbDetailsController> createControllerList(Context context, UsbBackend usbBackend, UsbDetailsFragment usbDetailsFragment) {
        ...
        arrayList.add(new UsbDetailsBottomChooseController(context, usbDetailsFragment, usbBackend));
