...
public class PreviouslyConnectedDeviceDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.previously_connected_devices);
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_previously_connected_devices;
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.previously_connected_devices;
    }
