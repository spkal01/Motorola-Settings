...
public class DiscoverableFooterPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public void updateFooterPreferenceTitle(int i) {
        if (i == 12) {
            ...
            this.mPreference.setTitle(C1992R$string.bluetooth_off_footer);
        }
    }
    ...
    private CharSequence getPreferenceTitle() {
        ...
        return TextUtils.expandTemplate(this.mContext.getText(C1992R$string.bluetooth_device_name_summary), new CharSequence[]{BidiFormatter.getInstance().unicodeWrap(name)});
    }
