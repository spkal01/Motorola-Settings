        ...
        if (telephonyManager.isDataCapable()) {
            ...
            for (SubscriptionInfo subscriptionInfo : subscriptionManager.getAvailableSubscriptionInfoList()) {
                ...
                if (subscriberId != null) {
                    networkTemplate = NetworkTemplate.buildTemplateCarrierMetered(subscriberId);
                } else {
                    networkTemplate = NetworkTemplate.buildTemplateMobileAll(subscriberId);
                }
                JSONObject dumpDataUsage = dumpDataUsage(networkTemplate, dataUsageController);
