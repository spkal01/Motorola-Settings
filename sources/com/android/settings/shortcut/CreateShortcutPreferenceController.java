...
import com.android.settings.C1989R$mipmap;
...
public class CreateShortcutPreferenceController extends BasePreferenceController {
    ...
    public Intent createResultIntent(Intent intent, ResolveInfo resolveInfo, CharSequence charSequence) {
        ...
        createShortcutResultIntent.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(this.mContext, C1989R$mipmap.ic_launcher_settings)).putExtra("android.intent.extra.shortcut.INTENT", intent).putExtra("android.intent.extra.shortcut.NAME", charSequence);
        ActivityInfo activityInfo = resolveInfo.activityInfo;
        int i = activityInfo.icon;
        if (i != 0) {
            Context context = this.mContext;
            createShortcutResultIntent.putExtra("android.intent.extra.shortcut.ICON", createIcon(context, activityInfo.applicationInfo, i, C1987R$layout.shortcut_badge, context.getResources().getDimensionPixelSize(C1982R$dimen.shortcut_size)));
        }
    ...
    private static ShortcutInfo createShortcutInfo(Context context, Intent intent, ResolveInfo resolveInfo, CharSequence charSequence) {
        ...
        if (i == 0 || (applicationInfo = activityInfo.applicationInfo) == null) {
            icon = Icon.createWithResource(context, C1983R$drawable.ic_launcher_settings);
        } else {
            icon = Icon.createWithAdaptiveBitmap(createIcon(context, applicationInfo, i, C1987R$layout.shortcut_badge_maskable, context.getResources().getDimensionPixelSize(C1982R$dimen.shortcut_size_maskable)));
        }
    ...
    private static Bitmap createIcon(Context context, ApplicationInfo applicationInfo, int i, int i2, int i3) {
        ...
        try {
            ...
            ((ImageView) inflate.findViewById(16908294)).setImageIcon(Icon.createWithResource(context, C1983R$drawable.ic_launcher_settings));
        }
