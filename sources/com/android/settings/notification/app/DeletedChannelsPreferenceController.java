...
public class DeletedChannelsPreferenceController extends NotificationPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        ...
        if (appRow != null) {
            ...
            preference.setTitle((CharSequence) this.mContext.getResources().getQuantityString(C1990R$plurals.deleted_channels, deletedChannelCount, new Object[]{Integer.valueOf(deletedChannelCount)}));
        }
