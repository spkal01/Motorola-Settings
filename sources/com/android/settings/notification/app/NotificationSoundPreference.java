    ...
    private void updateRingtoneName(final Uri uri) {
        new AsyncTask<Object, Void, CharSequence>() {
            ...
            public CharSequence doInBackground(Object... objArr) {
                Uri uri = uri;
                if (uri == null) {
                    return NotificationSoundPreference.this.getContext().getString(17041356);
                }
                if (RingtoneManager.isDefault(uri)) {
                    return NotificationSoundPreference.this.getContext().getString(C1992R$string.notification_sound_default);
                }
                if ("android.resource".equals(uri.getScheme())) {
                    return NotificationSoundPreference.this.getContext().getString(C1992R$string.notification_unknown_sound_title);
                }
