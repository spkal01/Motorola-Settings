...
public class BubbleSummaryPreferenceController extends NotificationPreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (i == 0 || !isGloballyEnabled()) {
            return resources.getString(C1992R$string.bubble_app_setting_none);
        }
        if (i == 1) {
            return resources.getString(C1992R$string.bubble_app_setting_all);
        }
        return resources.getString(C1992R$string.bubble_app_setting_selected);
    }
