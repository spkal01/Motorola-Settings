...
public class AppChannelsBypassingDndPreferenceController extends NotificationPreferenceController implements PreferenceControllerMixin, LifecycleObserver {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        restrictedSwitchPreference.setTitle(C1992R$string.zen_mode_bypassing_app_channels_toggle_all);
    ...
    public void populateList() {
        ...
        if (preferenceCategory != null) {
            ...
            for (final NotificationChannel next : this.mChannels) {
                ...
                primarySwitchPreference.setOnPreferenceClickListener(new C1121x5981a397(this, bundle));
    ...
    public /* synthetic */ boolean lambda$populateList$0(Bundle bundle, Preference preference) {
        new SubSettingLauncher(this.mContext).setDestination(ChannelNotificationSettings.class.getName()).setArguments(bundle).setUserHandle(UserHandle.of(this.mAppRow.userId)).setTitleRes(C1992R$string.notification_channel_title).setSourceMetricsCategory(1840).launch();
        return true;
    }
