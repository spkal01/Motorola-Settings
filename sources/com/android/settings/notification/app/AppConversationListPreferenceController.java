...
public class AppConversationListPreferenceController extends NotificationPreferenceController {
    protected Comparator<ConversationChannelWrapper> mConversationComparator = C1123x9ff9dd68.INSTANCE;
    ...
    public int getTitleResId() {
        return C1992R$string.conversations_category_title;
    }
    ...
    public void populateConversationPreference(ConversationChannelWrapper conversationChannelWrapper, Preference preference) {
        ...
        if (conversationChannelWrapper.getNotificationChannel().getGroup() != null) {
            charSequence2 = this.mContext.getString(C1992R$string.notification_conversation_summary, new Object[]{conversationChannelWrapper.getParentChannelLabel(), conversationChannelWrapper.getGroupLabel()});
        } else {
