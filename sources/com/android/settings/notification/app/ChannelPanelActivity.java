...
public class ChannelPanelActivity extends FragmentActivity {
    ...
    private void createOrUpdatePanel() {
        ...
        setContentView(C1987R$layout.notification_channel_panel);
        Window window = getWindow();
        window.setGravity(80);
        window.setLayout(-1, -2);
        findViewById(C1985R$id.done).setOnClickListener(new ChannelPanelActivity$$ExternalSyntheticLambda1(this));
        findViewById(C1985R$id.see_more).setOnClickListener(new ChannelPanelActivity$$ExternalSyntheticLambda0(this));
