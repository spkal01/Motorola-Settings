    ...
    public void updateState(Preference preference) {
        if (this.mAppRow != null) {
            if (this.mChannel != null) {
                preference.setTitle(C1992R$string.channel_notifications_off_desc);
            } else if (this.mChannelGroup != null) {
                preference.setTitle(C1992R$string.channel_group_notifications_off_desc);
            } else {
                preference.setTitle(C1992R$string.app_notifications_off_desc);
            }
        }
