...
public class ImportanceResetPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public void updateState(Preference preference) {
        ...
        Button button = (Button) ((LayoutPreference) preference).findViewById(C1985R$id.reset_importance_button);
        this.mButton = button;
    ...
    public void onClick(View view) {
        ...
        Toast.makeText(this.mContext, C1992R$string.reset_importance_completed, 0).show();
    }
}
