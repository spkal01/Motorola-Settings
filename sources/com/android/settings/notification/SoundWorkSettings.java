...
public class SoundWorkSettings extends DashboardFragment implements OnActivityResultListener {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.sound_work_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.sound_work_settings;
    }
