...
public class VolumeSeekBarPreference extends SeekBarPreference {
    ...
    public interface Callback {
        ...
        void onStreamValueChanged(int i, int i2, boolean z);
    ...
    public VolumeSeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setLayoutResource(C1987R$layout.preference_volume_slider);
    ...
    public void updateWhenAppVolumeChanged(int i) {
        setProgress(i);
    }

    public void updateUserAttemptTime(long j) {
        SeekBarVolumizer seekBarVolumizer = this.mVolumizer;
        if (seekBarVolumizer != null) {
            seekBarVolumizer.updateUserAttempTime(j);
        }
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSeekBar = (SeekBar) preferenceViewHolder.findViewById(16909418);
        this.mIconView = (ImageView) preferenceViewHolder.findViewById(16908294);
        this.mSuppressionTextView = (TextView) preferenceViewHolder.findViewById(C1985R$id.suppression_text);
        init();
    }
    ...
    public void init() {
        if (this.mSeekBar != null) {
            C11161 r0 = new SeekBarVolumizer.Callback() {
                ...
                public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                    if (VolumeSeekBarPreference.this.mCallback != null) {
                        VolumeSeekBarPreference.this.mCallback.onStreamValueChanged(VolumeSeekBarPreference.this.mStream, i, z);
                    }
                }
                ...
                public void onTouchStateChanged(boolean z) {
                    if (VolumeSeekBarPreference.this.mCallback != null) {
                        VolumeSeekBarPreference.this.mCallback.onTouchStateChanged(z);
                    }
                }
            };
    ...
    private Uri getMediaVolumeUri() {
        return Uri.parse("android.resource://" + getContext().getPackageName() + "/" + C1991R$raw.media_volume);
    }
    ...
    public void setSafeVolume(int i) {
