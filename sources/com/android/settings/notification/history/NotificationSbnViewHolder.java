...
public class NotificationSbnViewHolder extends RecyclerView.ViewHolder {
    ...
    NotificationSbnViewHolder(View view) {
        super(view);
        this.mPkgName = (TextView) view.findViewById(C1985R$id.pkgname);
        this.mIcon = (ImageView) view.findViewById(C1985R$id.icon);
        this.mTime = view.findViewById(C1985R$id.timestamp);
        this.mTitle = (TextView) view.findViewById(C1985R$id.title);
        this.mSummary = (TextView) view.findViewById(C1985R$id.text);
        this.mProfileBadge = (ImageView) view.findViewById(C1985R$id.profile_badge);
        this.mDivider = view.findViewById(C1985R$id.divider);
    }
        ...
        if (z3 || launchIntentForPackage != null) {
            ...
            ViewCompat.setAccessibilityDelegate(this.itemView, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(16, view.getResources().getText(C1992R$string.notification_history_open_notification)));
                }
            });
        }
    }
