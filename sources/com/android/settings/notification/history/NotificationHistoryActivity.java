...
public class NotificationHistoryActivity extends CollapsingToolbarBaseActivity {
    ...
    private final NotificationListenerService mListener = new NotificationListenerService() {
        ...
        public void onListenerConnected() {
            ...
            L_0x0028:
                ...
                int r4 = com.android.settings.C1985R$id.notification_list
            ...
            L_0x00f7:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.notification.history.NotificationHistoryActivity.C11362.onListenerConnected():void");
        }
    ...
    public /* synthetic */ void lambda$new$2(List list) {
        ...
        int i = 8;
        boolean z = false;
        findViewById(C1985R$id.today_list).setVisibility(list.isEmpty() ? 8 : 0);
        this.mCountdownLatch.countDown();
        this.mTodayView.findViewById(C1985R$id.apps).setClipToOutline(true);
        ...
        while (i2 < size) {
            ...
            View inflate = LayoutInflater.from(this).inflate(C1987R$layout.notification_history_app_layout, (ViewGroup) null);
            int i3 = C1985R$id.notification_list;
            View findViewById = inflate.findViewById(i3);
            findViewById.setVisibility(i);
            View findViewById2 = inflate.findViewById(C1985R$id.app_header);
            NotificationExpandButton findViewById3 = inflate.findViewById(16908955);
            ...
            if (findViewById.getVisibility() == 0) {
                str = getString(C1992R$string.condition_expand_hide);
            } else {
                str = getString(C1992R$string.condition_expand_show);
            }
            ...
            TextView textView = (TextView) inflate.findViewById(C1985R$id.label);
            ...
            ((ImageView) inflate.findViewById(C1985R$id.icon)).setImageDrawable(notificationHistoryPackage.icon);
            TextView textView2 = (TextView) inflate.findViewById(C1985R$id.count);
            textView2.setText(getResources().getQuantityString(C1990R$plurals.notification_history_count, notificationHistoryPackage.notifications.size(), new Object[]{Integer.valueOf(notificationHistoryPackage.notifications.size())}));
            NotificationHistoryRecyclerView notificationHistoryRecyclerView = (NotificationHistoryRecyclerView) inflate.findViewById(i4);
    ...
    public /* synthetic */ void lambda$new$1(TextView textView, View view, int i) {
        textView.setText(getResources().getQuantityString(C1990R$plurals.notification_history_count, i, new Object[]{Integer.valueOf(i)}));
        if (i == 0) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(C1992R$string.notification_history);
        setContentView(C1987R$layout.notification_history);
        this.mTodayView = (ViewGroup) findViewById(C1985R$id.apps);
        this.mSnoozeView = (ViewGroup) findViewById(C1985R$id.snoozed_list);
        ViewGroup viewGroup = (ViewGroup) findViewById(C1985R$id.recently_dismissed_list);
        this.mDismissView = viewGroup;
        int i = C1985R$id.notification_list;
        configureNotificationList(viewGroup.findViewById(i));
        configureNotificationList(this.mSnoozeView.findViewById(i));
        this.mHistoryOff = (ViewGroup) findViewById(C1985R$id.history_off);
        this.mHistoryOn = (ViewGroup) findViewById(C1985R$id.history_on);
        this.mHistoryEmpty = (ViewGroup) findViewById(C1985R$id.history_on_empty);
        this.mSwitchBar = (MainSwitchBar) findViewById(C1985R$id.main_switch_bar);
    ...
    public /* synthetic */ void lambda$onResume$3() {
        if (this.mSwitchBar.isChecked() && findViewById(C1985R$id.today_list).getVisibility() == 8 && this.mSnoozeView.getVisibility() == 8 && this.mDismissView.getVisibility() == 8) {
    ...
    private void bindSwitch() {
        ...
        if (mainSwitchBar != null) {
            mainSwitchBar.show();
            this.mSwitchBar.setTitle(getString(C1992R$string.notification_history_toggle));
            try {
