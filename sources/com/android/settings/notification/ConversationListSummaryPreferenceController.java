...
public class ConversationListSummaryPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (size == 0) {
            return this.mContext.getText(C1992R$string.priority_conversation_count_zero);
        }
        return this.mContext.getResources().getQuantityString(C1990R$plurals.priority_conversation_count, size, new Object[]{Integer.valueOf(size)});
    }
