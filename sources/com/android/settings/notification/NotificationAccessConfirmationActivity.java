...
public class NotificationAccessConfirmationActivity extends Activity implements DialogInterface {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getString(C1992R$string.notification_listener_security_warning_title, new Object[]{stringExtra});
        alertParams.mMessage = getString(C1992R$string.notification_listener_security_warning_summary, new Object[]{stringExtra});
