...
public class NotificationAssistantPicker extends DefaultAppPickerFragment implements ServiceListing.Callback {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.notification_assistant_settings);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.notification_assistant_settings;
    }
    ...
    public CharSequence getConfirmationMessage(CandidateInfo candidateInfo) {
        ...
        return this.mContext.getString(C1992R$string.notification_assistant_security_warning_summary, new Object[]{candidateInfo.loadLabel()});
    }
    ...
    public static class CandidateNone extends CandidateInfo {
        ...
        public CharSequence loadLabel() {
            return this.mContext.getString(C1992R$string.no_notification_assistant);
        }
    }
}
