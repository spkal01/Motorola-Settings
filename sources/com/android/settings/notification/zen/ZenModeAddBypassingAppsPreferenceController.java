    ...
    public void updateAppList(List<ApplicationsState.AppEntry> list) {
        if (list != null) {
            if (this.mPreferenceCategory == null) {
                ...
                preferenceCategory.setTitle(C1992R$string.zen_mode_bypassing_apps_add_header);
            ...
            for (ApplicationsState.AppEntry next : list) {
                ...
                if (this.mNotificationBackend.getNotificationChannelsBypassingDnd(str, next.info.uid).getList().size() == 0 && channelCount > 0) {
                    ...
                    if (findPreference == null) {
                        ...
                        findPreference.setOnPreferenceClickListener(new C1148x33e36a97(this, next));
                    }
            ...
            if (arrayList.size() == 0) {
                ...
                if (findPreference2 == null) {
                    ...
                    findPreference2.setTitle(C1992R$string.zen_mode_bypassing_apps_subtext_none);
                }
