...
public class ZenModeSettings extends ZenModeSettingsBase {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.zen_mode_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.zen_mode_settings;
    }
    ...
    public static class SummaryBuilder {
        ...
        public String getOtherSoundCategoriesSummary(NotificationManager.Policy policy) {
            ...
            MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C1992R$string.zen_mode_other_sounds_summary), Locale.getDefault());
        ...
        public String getCallsSettingSummary(NotificationManager.Policy policy) {
            ...
            int size = enabledCategories.size();
            if (size == 0) {
                return this.mContext.getString(C1992R$string.zen_mode_none_calls);
            }
            if (size == 1) {
                return this.mContext.getString(C1992R$string.zen_mode_calls_summary_one, new Object[]{enabledCategories.get(0)});
            }
            return this.mContext.getString(C1992R$string.zen_mode_calls_summary_two, new Object[]{enabledCategories.get(0), enabledCategories.get(1)});
        }
        ...
        public String getMessagesSettingSummary(NotificationManager.Policy policy) {
            ...
            if (enabledCategories.size() == 0) {
                return this.mContext.getString(C1992R$string.zen_mode_none_messages);
            }
        ...
        public String getSoundSummary() {
            if (NotificationManager.from(this.mContext).getZenMode() != 0) {
                ...
                if (description == null) {
                    return this.mContext.getString(C1992R$string.zen_mode_sound_summary_on);
                }
                return this.mContext.getString(C1992R$string.zen_mode_sound_summary_on_with_info, new Object[]{description});
            }
            MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C1992R$string.zen_mode_sound_summary_off), Locale.getDefault());
            HashMap hashMap = new HashMap();
        ...
        public String getBlockedEffectsSummary(NotificationManager.Policy policy) {
            ...
            if (i == 0) {
                return this.mContext.getResources().getString(C1992R$string.zen_mode_restrict_notifications_summary_muted);
            }
            if (NotificationManager.Policy.areAllVisualEffectsSuppressed(i)) {
                return this.mContext.getResources().getString(C1992R$string.zen_mode_restrict_notifications_summary_hidden);
            }
            return this.mContext.getResources().getString(C1992R$string.zen_mode_restrict_notifications_summary_custom);
        }

        /* access modifiers changed from: package-private */
        public String getAutomaticRulesSummary() {
            MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C1992R$string.zen_mode_settings_schedules_summary), Locale.getDefault());
            HashMap hashMap = new HashMap();
            hashMap.put("count", Integer.valueOf(getEnabledAutomaticRulesCount()));
            return messageFormat.format(hashMap);
        }
        ...
        private String getCategory(int i, NotificationManager.Policy policy, boolean z) {
            if (i == 32) {
                if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_alarms_list_first);
                }
                return this.mContext.getString(C1992R$string.zen_mode_alarms_list);
            } else if (i == 64) {
                if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_media_list_first);
                }
                return this.mContext.getString(C1992R$string.zen_mode_media_list);
            } else if (i == 128) {
                if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_system_list_first);
                }
                return this.mContext.getString(C1992R$string.zen_mode_system_list);
            } else if (i == 4) {
                int i2 = policy.priorityMessageSenders;
                if (i2 == 0) {
                    return this.mContext.getString(C1992R$string.zen_mode_from_anyone);
                }
                if (i2 == 1) {
                    return this.mContext.getString(C1992R$string.zen_mode_from_contacts);
                }
                return this.mContext.getString(C1992R$string.zen_mode_from_starred);
            } else if (i == 2) {
                if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_events_list_first);
                }
                return this.mContext.getString(C1992R$string.zen_mode_events_list);
            } else if (i == 1) {
                if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_reminders_list_first);
                }
                return this.mContext.getString(C1992R$string.zen_mode_reminders_list);
            } else if (i == 8) {
                ...
                if (i3 == 0) {
                    ...
                    return this.mContext.getString(C1992R$string.zen_mode_all_callers);
                } else if (i3 == 1) {
                    if (z) {
                        return this.mContext.getString(C1992R$string.zen_mode_from_contacts);
                    }
                    return this.mContext.getString(C1992R$string.zen_mode_contacts_callers);
                } else if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_from_starred);
                } else {
                    return this.mContext.getString(C1992R$string.zen_mode_starred_callers);
                }
            } else if (i != 16) {
                return "";
            } else {
                if (z) {
                    return this.mContext.getString(C1992R$string.zen_mode_repeat_callers);
                }
                return this.mContext.getString(C1992R$string.zen_mode_repeat_callers_list);
            }
        }
    }
}
