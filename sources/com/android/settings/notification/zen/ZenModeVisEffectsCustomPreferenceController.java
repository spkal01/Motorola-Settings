...
public class ZenModeVisEffectsCustomPreferenceController extends AbstractZenModePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        radioButtonPreference.setExtraWidgetOnClickListener(new C1187xe31d5eff(this));
        this.mPreference.setOnClickListener(new C1188xe31d5f00(this));
    }
    ...
    private void launchCustomSettings() {
        select();
        new SubSettingLauncher(this.mContext).setDestination(ZenModeBlockedEffectsSettings.class.getName()).setTitleRes(C1992R$string.zen_mode_what_to_block_title).setSourceMetricsCategory(1400).launch();
    }
}
