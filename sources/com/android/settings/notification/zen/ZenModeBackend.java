...
public class ZenModeBackend {
    ...
    public int getAlarmsTotalSilencePeopleSummary(int i) {
        if (i == 4) {
            return C1992R$string.zen_mode_none_messages;
        }
        if (i == 8) {
            return C1992R$string.zen_mode_none_calls;
        }
        if (i == 256) {
            return C1992R$string.zen_mode_from_no_conversations;
        }
        return C1992R$string.zen_mode_from_no_conversations;
    }
    ...
    public int getConversationSummary() {
        ...
        if (priorityConversationSenders == 1) {
            return C1992R$string.zen_mode_from_all_conversations;
        }
        if (priorityConversationSenders == 2) {
            return C1992R$string.zen_mode_from_important_conversations;
        }
    ...
    public int getContactsCallsSummary(ZenPolicy zenPolicy) {
        ...
        if (priorityCallSenders == 1) {
            return C1992R$string.zen_mode_from_anyone;
        }
        if (priorityCallSenders == 2) {
            return C1992R$string.zen_mode_from_contacts;
        }
        if (priorityCallSenders != 3) {
            return C1992R$string.zen_mode_none_calls;
        }
        return C1992R$string.zen_mode_from_starred;
    }
    ...
    public List<String> getStarredContacts(Cursor cursor) {
        ...
        do {
            ...
            if (string == null) {
                string = this.mContext.getString(C1992R$string.zen_mode_starred_contacts_empty_name);
            }
    ...
    public String getStarredContactsSummary(Context context) {
        ...
        MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C1992R$string.zen_mode_starred_contacts_summary_contacts), Locale.getDefault());
    ...
    public String getContactsNumberSummary(Context context) {
        MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C1992R$string.zen_mode_contacts_count), Locale.getDefault());
        HashMap hashMap = new HashMap();
