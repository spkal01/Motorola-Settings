...
public class ZenModeScheduleDaysSelection extends ScrollView {
    ...
    public ZenModeScheduleDaysSelection(Context context, int[] iArr) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(C1982R$dimen.zen_schedule_day_margin);
        ...
        for (final int i : daysOfWeekForLocale) {
            CheckBox checkBox = (CheckBox) from.inflate(C1987R$layout.zen_schedule_rule_day, this, false);
            instance.set(7, i);
