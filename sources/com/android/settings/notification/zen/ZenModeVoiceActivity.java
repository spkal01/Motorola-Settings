...
public class ZenModeVoiceActivity extends VoiceSettingsActivity {
    ...
    private CharSequence getChangeSummary(int i, int i2) {
        ...
        if (i == 0) {
            i4 = -1;
            i3 = -1;
            i6 = C1992R$string.zen_mode_summary_always;
            i5 = -1;
        } else if (i != 3) {
            i5 = -1;
            i4 = -1;
            ...
            i6 = C1992R$string.zen_mode_summary_alarms_only_indefinite;
            i5 = C1990R$plurals.zen_mode_summary_alarms_only_by_minute;
            i4 = C1990R$plurals.zen_mode_summary_alarms_only_by_hour;
            i3 = C1992R$string.zen_mode_summary_alarms_only_by_time;
        }
        if (i2 < 0 || i == 0) {
            return getString(i6);
        }
