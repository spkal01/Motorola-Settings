...
public class ZenModeSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        CharSequence text = context.getText(C1992R$string.zen_mode_settings_title);
        CharSequence text2 = context.getText(C1992R$string.zen_mode_slice_subtitle);
    ...
    public static Intent getIntent(Context context) {
        return SliceBuilderUtils.buildSearchResultPageIntent(context, ZenModeSettings.class.getName(), "zen_mode_toggle", context.getText(C1992R$string.zen_mode_settings_title).toString(), 76).setClassName(context.getPackageName(), SubSettings.class.getName()).setData(new Uri.Builder().appendPath("zen_mode_toggle").build());
    }
