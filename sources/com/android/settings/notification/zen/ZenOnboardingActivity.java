...
public class ZenOnboardingActivity extends Activity {
    ...
    /* access modifiers changed from: protected */
    public void setupUI() {
        setContentView(C1987R$layout.zen_onboarding);
        this.mNewSetting = findViewById(C1985R$id.zen_onboarding_new_setting);
        this.mKeepCurrentSetting = findViewById(C1985R$id.zen_onboarding_current_setting);
        this.mNewSettingButton = (RadioButton) findViewById(C1985R$id.zen_onboarding_new_setting_button);
        this.mKeepCurrentSettingButton = (RadioButton) findViewById(C1985R$id.zen_onboarding_current_setting_button);
        C11891 r0 = new View.OnClickListener() {
        ...
        C11902 r1 = new View.OnClickListener() {
            public void onClick(View view) {
