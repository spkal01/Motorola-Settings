    ...
    public void updateState(Preference preference) {
        ...
        if (this.mRule != null && (preferenceFragmentCompat = this.mFragment) != null) {
            if (this.mController == null) {
                this.mController = EntityHeaderController.newInstance(preferenceFragmentCompat.getActivity(), this.mFragment, ((LayoutPreference) preference).findViewById(C1985R$id.entity_header));
            }
        ...
        try {
            ...
            if (applicationInfo.isSystemApp()) {
                if (ZenModeConfig.isValidScheduleConditionId(this.mRule.getConditionId())) {
                    return this.mContext.getDrawable(C1983R$drawable.ic_timelapse);
                }
                if (ZenModeConfig.isValidEventConditionId(this.mRule.getConditionId())) {
                    return this.mContext.getDrawable(C1983R$drawable.ic_event);
                }
            }
