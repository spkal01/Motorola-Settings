...
public class ZenAutomaticRuleSwitchPreferenceController extends AbstractZenModeAutomaticRulePreferenceController implements OnMainSwitchChangeListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (mainSwitchPreference != null) {
            mainSwitchPreference.setTitle(this.mContext.getString(C1992R$string.zen_mode_use_automatic_rule));
            try {
                findPreference.setOnPreferenceClickListener(new C1141x7484d15e(this));
