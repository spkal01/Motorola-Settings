...
public class ZenDeleteRuleDialog extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog create = new AlertDialog.Builder(getContext()).setMessage((CharSequence) getString(C1992R$string.zen_mode_delete_rule_confirmation, string)).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(C1992R$string.zen_mode_delete_rule_button, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
