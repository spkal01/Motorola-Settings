...
public class ZenRulePreference extends TwoTargetPreference {
    ...
    public ZenRulePreference(Context context, Map.Entry<String, AutomaticZenRule> entry, Fragment fragment, MetricsFeatureProvider metricsFeatureProvider) {
        super(context);
        setLayoutResource(C1987R$layout.preference_checkable_two_target);
    ...
    public int getSecondTargetResId() {
        if (this.mIntent != null) {
            return C1987R$layout.zen_rule_widget;
        }
        return 0;
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        View findViewById2 = preferenceViewHolder.findViewById(C1985R$id.two_target_divider);
        if (this.mIntent != null) {
        ...
        View findViewById3 = preferenceViewHolder.findViewById(C1985R$id.checkbox_container);
    ...
    private String computeRuleSummary(AutomaticZenRule automaticZenRule) {
        if (automaticZenRule == null || !automaticZenRule.isEnabled()) {
            return this.mContext.getResources().getString(C1992R$string.switch_off_text);
        }
        return this.mContext.getResources().getString(C1992R$string.switch_on_text);
    }
}
