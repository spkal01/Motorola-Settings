...
public class ZenModePriorityConversationsPreferenceController extends AbstractZenModePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (preferenceCategory.findPreference(KEY_ALL) == null) {
            makeRadioPreference(KEY_ALL, C1992R$string.zen_mode_from_all_conversations);
            makeRadioPreference(KEY_IMPORTANT, C1992R$string.zen_mode_from_important_conversations);
            makeRadioPreference(KEY_NONE, C1992R$string.zen_mode_from_no_conversations);
            updateChannelCounts();
        }
    ...
    private String getSummary(String str) {
        ...
        MessageFormat messageFormat = new MessageFormat(this.mContext.getString(C1992R$string.zen_mode_conversations_count), Locale.getDefault());
