...
public class ZenModeScheduleRuleSettings extends ZenModeRuleSettingsBase {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.zen_mode_schedule_rule_settings;
    }
    ...
    public void onCreateInternal() {
        ...
        this.mStart.setTitle(C1992R$string.zen_mode_start_time);
        ...
        this.mEnd.setTitle(C1992R$string.zen_mode_end_time);
    ...
    public void updateDays() {
            ...
            for (int i : daysOfWeekForLocale) {
                ...
                while (true) {
                    if (i2 >= iArr.length) {
                        ...
                        instance.set(7, i);
                        if (sb.length() > 0) {
                            sb.append(this.mContext.getString(C1992R$string.summary_divider_text));
                        }
        ...
        this.mDays.setSummary(C1992R$string.zen_mode_schedule_rule_days_none);
    ...
    private void updateEndSummary() {
        ...
        int i3 = 0;
        if (i >= i2) {
            i3 = C1992R$string.zen_mode_end_time_next_day_summary_format;
        }
    ...
    public void showDaysDialog() {
        this.mDayDialog = new AlertDialog.Builder(this.mContext).setTitle(C1992R$string.zen_mode_schedule_rule_days).setView((View) new ZenModeScheduleDaysSelection(this.mContext, this.mSchedule.days) {
            /* access modifiers changed from: protected */
        ...
        }).setPositiveButton(C1992R$string.done_button, (DialogInterface.OnClickListener) null).show();
    }
