...
public class ZenRuleButtonsPreferenceController extends AbstractZenModePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        if (isAvailable()) {
            this.mButtonsPref = ((ActionButtonsPreference) preferenceScreen.findPreference("zen_action_buttons")).setButton1Text(C1992R$string.zen_mode_rule_name_edit).setButton1Icon(17303644).setButton1OnClickListener(new EditRuleNameClickListener()).setButton2Text(C1992R$string.zen_mode_delete_rule_button).setButton2Icon(C1983R$drawable.ic_settings_delete).setButton2OnClickListener(new DeleteRuleClickListener());
        }
    }
