...
public abstract class ZenModeRuleSettingsBase extends ZenModeSettingsBase {
    ...
    private void toastAndFinish() {
        Toast.makeText(this.mContext, C1992R$string.zen_mode_rule_not_found_text, 0).show();
        getActivity().finish();
    }
    ...
    private void updateControls() {
        ...
        if (this.mRule.getZenPolicy() == null) {
            this.mCustomBehaviorPreference.setSummary(C1992R$string.zen_mode_custom_behavior_summary_default);
        } else {
            this.mCustomBehaviorPreference.setSummary(C1992R$string.zen_mode_custom_behavior_summary);
        }
