...
public class ZenModeMessagesSettings extends ZenModeSettingsBase {
    public static final Indexable$SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            ...
            searchIndexableResource.xmlResId = C1994R$xml.zen_mode_messages_settings;
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Lifecycle lifecycle) {
        ...
        arrayList.add(new ZenModeBehaviorFooterPreferenceController(context, lifecycle, C1992R$string.zen_mode_messages_footer));
        return arrayList;
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.zen_mode_messages_settings;
    }
}
