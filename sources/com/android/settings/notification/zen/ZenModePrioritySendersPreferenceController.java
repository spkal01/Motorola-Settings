...
public class ZenModePrioritySendersPreferenceController extends AbstractZenModePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (preferenceCategory.findPreference(KEY_ANY) == null) {
            makeRadioPreference(KEY_STARRED, C1992R$string.zen_mode_from_starred);
            makeRadioPreference(KEY_CONTACTS, C1992R$string.zen_mode_from_contacts);
            makeRadioPreference(KEY_ANY, C1992R$string.zen_mode_from_anyone);
            if (this.mIsMessages) {
                i = C1992R$string.zen_mode_none_messages;
            } else {
                i = C1992R$string.zen_mode_none_calls;
            }
    ...
    private java.lang.String getSummary(java.lang.String r4) {
        ...
        L_0x003b:
            ...
            int r3 = com.android.settings.C1992R$string.zen_mode_all_messages_summary
            goto L_0x004a
        L_0x0048:
            int r3 = com.android.settings.C1992R$string.zen_mode_all_calls_summary
        L_0x004a:
