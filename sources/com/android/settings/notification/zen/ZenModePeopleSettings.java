...
public class ZenModePeopleSettings extends ZenModeSettingsBase {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.zen_mode_people_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.zen_mode_people_settings;
    }
}
