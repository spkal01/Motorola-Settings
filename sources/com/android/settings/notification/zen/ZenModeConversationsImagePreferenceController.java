...
public class ZenModeConversationsImagePreferenceController extends AbstractZenModePreferenceController {
    ...
    public ZenModeConversationsImagePreferenceController(Context context, String str, Lifecycle lifecycle, NotificationBackend notificationBackend) {
        ...
        this.mIconSizePx = this.mContext.getResources().getDimensionPixelSize(C1982R$dimen.zen_conversations_icon_size);
        this.mIconOffsetPx = this.mContext.getResources().getDimensionPixelSize(C1982R$dimen.zen_conversations_icon_offset);
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mViewGroup = (ViewGroup) layoutPreference.findViewById(C1985R$id.zen_mode_settings_senders_overlay_view);
        loadConversations();
    }
    ...
    public void updateState(Preference preference) {
        ...
        if (priorityConversationSenders == 1) {
            this.mViewGroup.setContentDescription(this.mContext.getResources().getString(C1992R$string.zen_mode_from_all_conversations));
        } else if (priorityConversationSenders == 2) {
            this.mViewGroup.setContentDescription(this.mContext.getResources().getString(C1992R$string.zen_mode_from_important_conversations));
        } else {
