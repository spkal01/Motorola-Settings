...
public class ZenModeEventRuleSettings extends ZenModeRuleSettingsBase {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.zen_mode_event_rule_settings;
    }
    ...
    private void reloadCalendar() {
        ...
        arrayList.add(getString(C1992R$string.zen_mode_event_rule_calendar_any));
        String str = null;
    ...
    public void onCreateInternal() {
        ...
        dropDownPreference2.setEntries(new CharSequence[]{getString(C1992R$string.zen_mode_event_rule_reply_any_except_no), getString(C1992R$string.zen_mode_event_rule_reply_yes_or_maybe), getString(C1992R$string.zen_mode_event_rule_reply_yes)});
