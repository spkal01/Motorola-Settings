...
public class ZenModeSettingsFooterPreferenceController extends AbstractZenModePreferenceController {
        ...
        if (!Objects.equals(this.mBackend.getConsolidatedPolicy(), zenModeConfig.toNotificationPolicy())) {
            ...
            if (arrayList.size() > 0) {
                ...
                if (!format.isEmpty()) {
                    ...
                    return TextUtils.concat(new CharSequence[]{this.mContext.getResources().getString(C1992R$string.zen_mode_settings_dnd_custom_settings_footer, new Object[]{format}), AnnotationSpan.linkify(this.mContext.getResources().getText(C1992R$string.zen_mode_settings_dnd_custom_settings_footer_link), linkInfo)});
                }
            }
        }
        ...
        if (zenRule != null) {
            ...
            if (str2 != null) {
                ...
                if (!ownerCaption.isEmpty()) {
                    str = this.mContext.getString(C1992R$string.zen_mode_settings_dnd_automatic_rule_app, new Object[]{ownerCaption});
                }
            } else if (uri == null) {
                return this.mContext.getString(C1992R$string.zen_mode_settings_dnd_manual_indefinite);
            } else {
                ...
                if (j > 0) {
                    ...
                    str = this.mContext.getString(C1992R$string.zen_mode_settings_dnd_manual_end_time, new Object[]{formattedTime});
                }
            }
        }
        for (ZenModeConfig.ZenRule zenRule2 : zenModeConfig.automaticRules.values()) {
            if (zenRule2.isAutomaticActive()) {
                if (!AbstractZenModePreferenceController.mZenModeConfigWrapper.isTimeRule(zenRule2.conditionId)) {
                    return this.mContext.getString(C1992R$string.zen_mode_settings_dnd_automatic_rule, new Object[]{zenRule2.name});
                }
                ...
                if (parseAutomaticRuleEndTime > j) {
                    str = this.mContext.getString(C1992R$string.zen_mode_settings_dnd_automatic_rule, new Object[]{zenRule2.name});
    ...
    public static class ZenCustomSettingsDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            final AlertDialog create = new AlertDialog.Builder(activity).setTitle(C1992R$string.zen_custom_settings_dialog_title).setNeutralButton(C1992R$string.zen_custom_settings_dialog_review_schedule, new DialogInterface.OnClickListener() {
            ...
            }).setPositiveButton(C1992R$string.zen_custom_settings_dialog_ok, (DialogInterface.OnClickListener) null).setView(LayoutInflater.from(activity).inflate(activity.getResources().getLayout(C1987R$layout.zen_custom_settings_dialog), (ViewGroup) null, false)).create();
            create.setOnShowListener(new DialogInterface.OnShowListener() {
                public void onShow(DialogInterface dialogInterface) {
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_calls_allow)).setText(ZenCustomSettingsDialog.this.mSummaryBuilder.getCallsSettingSummary(ZenCustomSettingsDialog.this.mPolicy));
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_messages_allow)).setText(ZenCustomSettingsDialog.this.mSummaryBuilder.getMessagesSettingSummary(ZenCustomSettingsDialog.this.mPolicy));
                    ZenCustomSettingsDialog zenCustomSettingsDialog = ZenCustomSettingsDialog.this;
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_alarms_allow)).setText(zenCustomSettingsDialog.getAllowRes(zenCustomSettingsDialog.mPolicy.allowAlarms()));
                    ZenCustomSettingsDialog zenCustomSettingsDialog2 = ZenCustomSettingsDialog.this;
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_media_allow)).setText(zenCustomSettingsDialog2.getAllowRes(zenCustomSettingsDialog2.mPolicy.allowMedia()));
                    ZenCustomSettingsDialog zenCustomSettingsDialog3 = ZenCustomSettingsDialog.this;
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_system_allow)).setText(zenCustomSettingsDialog3.getAllowRes(zenCustomSettingsDialog3.mPolicy.allowSystem()));
                    ZenCustomSettingsDialog zenCustomSettingsDialog4 = ZenCustomSettingsDialog.this;
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_reminders_allow)).setText(zenCustomSettingsDialog4.getAllowRes(zenCustomSettingsDialog4.mPolicy.allowReminders()));
                    ZenCustomSettingsDialog zenCustomSettingsDialog5 = ZenCustomSettingsDialog.this;
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_events_allow)).setText(zenCustomSettingsDialog5.getAllowRes(zenCustomSettingsDialog5.mPolicy.allowEvents()));
                    ((TextView) create.findViewById(C1985R$id.zen_custom_settings_dialog_show_notifications)).setText(ZenCustomSettingsDialog.this.mSummaryBuilder.getBlockedEffectsSummary(ZenCustomSettingsDialog.this.mPolicy));
                }
            });
            return create;
        }
        ...
        public int getAllowRes(boolean z) {
            return z ? C1992R$string.zen_mode_sound_summary_on : C1992R$string.switch_off_text;
        }
