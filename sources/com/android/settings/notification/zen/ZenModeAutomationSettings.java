...
public class ZenModeAutomationSettings extends ZenModeSettingsBase {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.zen_mode_automation_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.zen_mode_automation_settings;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 1, 0, C1992R$string.zen_mode_delete_automatic_rules);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        new AlertDialog.Builder(this.mContext).setTitle(C1992R$string.zen_mode_delete_automatic_rules).setMultiChoiceItems(this.mDeleteDialogRuleNames, (boolean[]) null, new DialogInterface.OnMultiChoiceClickListener() {
            public void onClick(DialogInterface dialogInterface, int i, boolean z) {
                ZenModeAutomationSettings.this.mDeleteDialogChecked[i] = z;
            }
        }).setPositiveButton(C1992R$string.zen_mode_schedule_delete, new DialogInterface.OnClickListener() {
