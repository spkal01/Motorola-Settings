...
public class LockScreenNotificationPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, Preference.OnPreferenceChangeListener, LifecycleObserver, OnResume, OnPause {
    ...
    private void initLockScreenNotificationPrefDisplay() {
        ...
        int i = C1992R$string.lock_screen_notifications_summary_show;
        ...
        if (this.mSecure) {
            ...
            int i2 = C1992R$string.lock_screen_notifications_summary_hide;
        ...
        int i3 = C1992R$string.lock_screen_notifications_summary_disable;
    ...
    private void initLockscreenNotificationPrefForProfile() {
        ...
        ArrayList arrayList2 = new ArrayList();
        Context context = this.mContext;
        int i = C1992R$string.lock_screen_notifications_summary_show_profile;
        String string = context.getString(i);
        String num = Integer.toString(i);
        arrayList.add(string);
        arrayList2.add(num);
        ...
        if (this.mSecureProfile) {
            Context context2 = this.mContext;
            int i2 = C1992R$string.lock_screen_notifications_summary_hide_profile;
            String string2 = context2.getString(i2);
            String num2 = Integer.toString(i2);
            arrayList.add(string2);
            arrayList2.add(num2);
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if (TextUtils.equals(this.mWorkSettingKey, key)) {
            ...
            if (parseInt2 == C1992R$string.lock_screen_notifications_summary_show_profile) {
                i = 1;
            }
            ...
            int i2 = parseInt != C1992R$string.lock_screen_notifications_summary_disable ? 1 : 0;
            if (parseInt == C1992R$string.lock_screen_notifications_summary_show) {
                i = 1;
            }
    ...
    public static int getSummaryResource(Context context) {
        ...
        if (!lockscreenNotificationsEnabled) {
            return C1992R$string.lock_screen_notifications_summary_disable;
        }
        if (z) {
            return C1992R$string.lock_screen_notifications_summary_show;
        }
        return C1992R$string.lock_screen_notifications_summary_hide;
    }
    ...
    public void updateLockscreenNotificationsForProfile() {
        ...
        if (i2 != -10000 && this.mLockscreenProfile != null) {
            ...
            if (z) {
                i = C1992R$string.lock_screen_notifications_summary_show_profile;
            } else {
                i = C1992R$string.lock_screen_notifications_summary_hide_profile;
            }
