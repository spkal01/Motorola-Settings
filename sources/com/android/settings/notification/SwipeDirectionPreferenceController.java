...
public class SwipeDirectionPreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener {
    ...
    public CharSequence getSummary() {
        ...
        String[] stringArray = this.mContext.getResources().getStringArray(C1978R$array.swipe_direction_values);
        String[] stringArray2 = this.mContext.getResources().getStringArray(C1978R$array.swipe_direction_titles);
        if (stringArray == null) {
            return null;
        }
