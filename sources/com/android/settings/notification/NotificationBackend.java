...
public class NotificationBackend {
    ...
    public void recordCanBeBlocked(Context context, PackageManager packageManager, RoleManager roleManager, PackageInfo packageInfo, AppRow appRow) {
        ...
        if (InstalledAppUtils.get(context).isPackageRemoveBlockAll(packageInfo.packageName)) {
            appRow.lockedImportance = true;
            appRow.systemApp = true;
        }
        markAppRowWithBlockables(context.getResources().getStringArray(17236118), appRow, packageInfo.packageName);
    }
