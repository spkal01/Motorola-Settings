...
public class NotificationLockscreenPreference extends RestrictedListPreference {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setView(C1987R$layout.lockscreen_remote_input);
    }
    ...
    public void onDialogCreated(Dialog dialog) {
        ...
        dialog.create();
        CheckBox checkBox = (CheckBox) dialog.findViewById(C1985R$id.lockscreen_remote_input);
        boolean z = true;
        ...
        dialog.findViewById(C1985R$id.restricted_lock_icon_remote_input).setVisibility(this.mAdminRestrictingRemoteInput == null ? 8 : 0);
        if (this.mAdminRestrictingRemoteInput != null) {
