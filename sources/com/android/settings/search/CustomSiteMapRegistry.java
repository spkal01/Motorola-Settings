...
import com.motorola.settings.gestures.ThreeButtonNavSettingsFragment;
...
public class CustomSiteMapRegistry {
    ...
    static {
        ...
        arrayMap.put(ThreeButtonNavSettingsFragment.class.getName(), SystemNavigationGestureSettings.class.getName());
    }
}
