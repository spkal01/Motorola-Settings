...
abstract class BluetoothNameDialogFragment extends InstrumentedDialogFragment implements TextWatcher, TextView.OnEditorActionListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog create = new AlertDialog.Builder(getActivity()).setTitle(getDialogTitle()).setView(createDialogView(deviceName)).setPositiveButton(C1992R$string.bluetooth_rename_button, (DialogInterface.OnClickListener) new BluetoothNameDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
    ...
    private View createDialogView(String str) {
        View inflate = ((LayoutInflater) getActivity().getSystemService("layout_inflater")).inflate(C1987R$layout.dialog_edittext, (ViewGroup) null);
