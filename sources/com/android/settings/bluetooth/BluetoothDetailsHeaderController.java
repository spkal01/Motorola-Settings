...
public class BluetoothDetailsHeaderController extends BluetoothDetailsController {
    ...
    public void init(PreferenceScreen preferenceScreen) {
        ...
        this.mHeaderController = EntityHeaderController.newInstance(this.mFragment.getActivity(), this.mFragment, layoutPreference.findViewById(C1985R$id.entity_header));
