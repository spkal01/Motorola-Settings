...
public class RequestPermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    private void createDialog() {
        ...
        if (this.mReceiver != null) {
            int i = this.mRequest;
            if (i == 1 || i == 2) {
                builder.setMessage((CharSequence) getString(C1992R$string.bluetooth_turning_on));
            } else {
                builder.setMessage((CharSequence) getString(C1992R$string.bluetooth_turning_off));
            }
            ...
            if (i2 == 0) {
                ...
                if (charSequence != null) {
                    str2 = getString(C1992R$string.bluetooth_ask_lasting_discovery, new Object[]{charSequence});
                } else {
                    str2 = getString(C1992R$string.bluetooth_ask_lasting_discovery_no_name);
                }
                builder.setMessage((CharSequence) str2);
            } else {
                CharSequence charSequence2 = this.mAppLabel;
                if (charSequence2 != null) {
                    str = getString(C1992R$string.bluetooth_ask_discovery, new Object[]{charSequence2, Integer.valueOf(i2)});
                } else {
                    str = getString(C1992R$string.bluetooth_ask_discovery_no_name, new Object[]{Integer.valueOf(i2)});
                }
                builder.setMessage((CharSequence) str);
            }
            builder.setPositiveButton((CharSequence) getString(C1992R$string.allow), (DialogInterface.OnClickListener) this);
            builder.setNegativeButton((CharSequence) getString(C1992R$string.deny), (DialogInterface.OnClickListener) this);
        }
    ...
    private final class StateChangeReceiver extends BroadcastReceiver {
        public StateChangeReceiver() {
            RequestPermissionActivity.this.getWindow().getDecorView().postDelayed(new C0802xfa9b1fc8(this), 10000);
        }
