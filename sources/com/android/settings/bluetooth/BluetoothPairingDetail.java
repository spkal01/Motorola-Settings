...
public class BluetoothPairingDetail extends DeviceListPreferenceFragment {
    ...
    public void updateContent(int i) {
        if (i == 10) {
            ...
            this.mBluetoothAdapter.enable();
            addDeviceCategory(this.mAvailableDevicesCategory, C1992R$string.bluetooth_preference_found_media_devices, BluetoothDeviceFilter.ALL_FILTER, this.mInitialScanStarted);
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_bluetooth;
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.bluetooth_pairing_detail;
    }

    /* access modifiers changed from: package-private */
    public void showBluetoothTurnedOnToast() {
        Toast.makeText(getContext(), C1992R$string.connected_device_bluetooth_turned_on_toast, 0).show();
    }
}
