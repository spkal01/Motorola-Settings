...
public final class BluetoothDevicePreference extends GearPreference {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (this.mCachedDevice.getBondState() == 12 && (imageView = (ImageView) preferenceViewHolder.findViewById(C1985R$id.settings_button)) != null) {
        ...
        if (imageView2 != null) {
            ...
            imageView2.setElevation(getContext().getResources().getDimension(C1982R$dimen.bt_icon_elevation));
        }
    ...
    private void askDisconnect() {
        ...
        if (TextUtils.isEmpty(name)) {
            name = context.getString(C1992R$string.bluetooth_device);
        }
        String string = context.getString(C1992R$string.bluetooth_disconnect_all_profiles, new Object[]{name});
        String string2 = context.getString(C1992R$string.bluetooth_disconnect_title);
    ...
    private void pair() {
        if (!this.mCachedDevice.startPairing()) {
            Utils.showError(getContext(), this.mCachedDevice.getName(), C1992R$string.bluetooth_pairing_error_message);
        }
    }
}
