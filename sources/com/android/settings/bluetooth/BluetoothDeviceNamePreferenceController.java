...
public class BluetoothDeviceNamePreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public CharSequence getSummary() {
        ...
        return TextUtils.expandTemplate(this.mContext.getText(C1992R$string.bluetooth_device_name_summary), new CharSequence[]{BidiFormatter.getInstance().unicodeWrap(deviceName)}).toString();
    }
