...
public final class Utils {
    ...
    static void showConnectingError(Context context, String str, LocalBluetoothManager localBluetoothManager) {
        ...
        showError(context, str, C1992R$string.bluetooth_connecting_error_message, localBluetoothManager);
    }
    ...
    private static void showError(Context context, String str, int i, LocalBluetoothManager localBluetoothManager) {
        ...
        if (localBluetoothManager.isForegroundActivity()) {
            try {
                new AlertDialog.Builder(foregroundActivity).setTitle(C1992R$string.bluetooth_error_title).setMessage((CharSequence) string).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).show();
            } catch (Exception e) {
    ...
    public static String createRemoteName(Context context, BluetoothDevice bluetoothDevice) {
        ...
        return alias == null ? context.getString(C1992R$string.unknown) : alias;
    }
