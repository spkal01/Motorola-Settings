...
public class BluetoothDetailsMacAddressController extends BluetoothDetailsController {
    ...
    public void init(PreferenceScreen preferenceScreen) {
        ...
        footerPreference.setTitle((CharSequence) this.mContext.getString(C1992R$string.bluetooth_device_mac_address, new Object[]{this.mCachedDevice.getAddress()}));
    }

    /* access modifiers changed from: protected */
    public void refresh() {
        this.mFooterPreference.setTitle((CharSequence) this.mContext.getString(C1992R$string.bluetooth_device_mac_address, new Object[]{this.mCachedDevice.getAddress()}));
    }
}
