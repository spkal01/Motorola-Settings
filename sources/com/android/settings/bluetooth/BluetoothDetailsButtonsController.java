...
public class BluetoothDetailsButtonsController extends BluetoothDetailsController {
    ...
    public void init(PreferenceScreen preferenceScreen) {
        this.mActionButtons = ((ActionButtonsPreference) preferenceScreen.findPreference(getPreferenceKey())).setButton1Text(C1992R$string.forget).setButton1Icon(C1983R$drawable.ic_settings_delete).setButton1OnClickListener(new BluetoothDetailsButtonsController$$ExternalSyntheticLambda0(this)).setButton1Enabled(true);
    }
    ...
    public void refresh() {
        ...
        if (isConnected) {
            if (!this.mConnectButtonInitialized || !z) {
                this.mActionButtons.setButton2Text(C1992R$string.bluetooth_device_context_disconnect).setButton2Icon(C1983R$drawable.ic_settings_close).setButton2OnClickListener(new BluetoothDetailsButtonsController$$ExternalSyntheticLambda2(this));
                this.mConnectButtonInitialized = true;
            }
        } else if (!this.mConnectButtonInitialized || z) {
            this.mActionButtons.setButton2Text(C1992R$string.bluetooth_device_context_connect).setButton2Icon(C1983R$drawable.ic_add_24dp).setButton2OnClickListener(new BluetoothDetailsButtonsController$$ExternalSyntheticLambda1(this));
            this.mConnectButtonInitialized = true;
        }
    }
