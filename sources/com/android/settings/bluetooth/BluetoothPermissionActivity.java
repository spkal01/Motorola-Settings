...
public class BluetoothPermissionActivity extends AlertActivity implements DialogInterface.OnClickListener, Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (i == 1) {
            showDialog(getString(C1992R$string.bluetooth_connect_access_dialog_title), this.mRequestType);
        } else if (i == 2) {
            showDialog(getString(C1992R$string.bluetooth_phonebook_access_dialog_title), this.mRequestType);
        } else if (i == 3) {
            showDialog(getString(C1992R$string.bluetooth_message_access_dialog_title), this.mRequestType);
        } else if (i == 4) {
            showDialog(getString(C1992R$string.bluetooth_sim_card_access_dialog_title), this.mRequestType);
        } else {
    ...
    private void showDialog(String str, int i) {
        ...
        alertParams.mPositiveButtonText = getString(i == 1 ? C1992R$string.bluetooth_connect_access_dialog_positive : C1992R$string.allow);
        alertParams.mPositiveButtonListener = this;
        if (i == 1) {
            i2 = C1992R$string.bluetooth_connect_access_dialog_negative;
        } else {
            i2 = C1992R$string.request_manage_bluetooth_permission_dont_allow;
        }
    ...
    private View createConnectionDialogView() {
        ...
        View inflate = getLayoutInflater().inflate(C1987R$layout.bluetooth_access, (ViewGroup) null);
        this.mView = inflate;
        TextView textView = (TextView) inflate.findViewById(C1985R$id.message);
        this.messageView = textView;
        textView.setText(getString(C1992R$string.bluetooth_connect_access_dialog_content, new Object[]{createRemoteName, createRemoteName}));
        return this.mView;
    }
    ...
    private View createPhonebookDialogView() {
        ...
        TextView textView = (TextView) inflate.findViewById(C1985R$id.message);
        this.messageView = textView;
        textView.setText(getString(C1992R$string.bluetooth_phonebook_access_dialog_content, new Object[]{createRemoteName, createRemoteName}));
        return this.mView;
    }
    ...
    private View createMapDialogView() {
        ...
        TextView textView = (TextView) inflate.findViewById(C1985R$id.message);
        this.messageView = textView;
        textView.setText(getString(C1992R$string.bluetooth_message_access_dialog_content, new Object[]{createRemoteName, createRemoteName}));
        return this.mView;
    }
    ...
    private View createSapDialogView() {
        ...
        TextView textView = (TextView) inflate.findViewById(C1985R$id.message);
        this.messageView = textView;
        textView.setText(getString(C1992R$string.bluetooth_sim_card_access_dialog_content, new Object[]{createRemoteName, createRemoteName, ((TelephonyManager) getSystemService(TelephonyManager.class)).getLine1Number()}));
        return this.mView;
    }
