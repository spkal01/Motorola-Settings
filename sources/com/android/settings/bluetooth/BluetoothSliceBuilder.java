...
public class BluetoothSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        CharSequence text = context.getText(C1992R$string.bluetooth_settings);
        IconCompat createWithResource = IconCompat.createWithResource(context, 17303713);
    ...
    public static Intent getIntent(Context context) {
        String charSequence = context.getText(C1992R$string.bluetooth_settings_title).toString();
        return SliceBuilderUtils.buildSearchResultPageIntent(context, BluetoothDashboardFragment.class.getName(), (String) null, charSequence, 747).setClassName(context.getPackageName(), SubSettings.class.getName()).setData(new Uri.Builder().appendPath("bluetooth").build());
    }
