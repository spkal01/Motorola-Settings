...
public final class BluetoothPairingService extends Service {
    ...
    public void onCreate() {
        ...
        this.mNm.createNotificationChannel(new NotificationChannel("bluetooth_notification_channel", getString(C1992R$string.bluetooth), 4));
    }
    ...
    private void createPairingNotification(Intent intent) {
        ...
        NotificationCompat.Builder localOnly = new NotificationCompat.Builder(this, "bluetooth_notification_channel").setSmallIcon(NOTIFICATION_ID).setTicker(resources.getString(C1992R$string.bluetooth_notif_ticker)).setLocalOnly(true);
        int intExtra = intent.getIntExtra("android.bluetooth.device.extra.PAIRING_VARIANT", Integer.MIN_VALUE);
        ...
        localOnly.setContentTitle(resources.getString(C1992R$string.bluetooth_notif_title)).setContentText(resources.getString(C1992R$string.bluetooth_notif_message, new Object[]{stringExtra})).setContentIntent(service).setDefaults(1).setOngoing(true).setColor(getColor(17170460)).addAction(new NotificationCompat.Action.Builder(0, resources.getString(C1992R$string.bluetooth_device_context_pair_connect), service).build()).addAction(new NotificationCompat.Action.Builder(0, resources.getString(17039360), service2).build());
