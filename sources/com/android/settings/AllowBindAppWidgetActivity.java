...
public class AllowBindAppWidgetActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getString(C1992R$string.allow_bind_app_widget_activity_allow_bind_title);
        alertParams.mMessage = getString(C1992R$string.allow_bind_app_widget_activity_allow_bind, new Object[]{obj});
        alertParams.mPositiveButtonText = getString(C1992R$string.create);
        ...
        checkBox.setText(getString(C1992R$string.allow_bind_app_widget_activity_always_allow_bind, new Object[]{obj}));
        CheckBox checkBox2 = this.mAlwaysUse;
        checkBox2.setPadding(checkBox2.getPaddingLeft(), this.mAlwaysUse.getPaddingTop(), this.mAlwaysUse.getPaddingRight(), (int) (((float) this.mAlwaysUse.getPaddingBottom()) + getResources().getDimension(C1982R$dimen.bind_app_widget_dialog_checkbox_bottom_padding)));
