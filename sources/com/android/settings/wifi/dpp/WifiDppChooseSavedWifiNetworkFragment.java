...
public class WifiDppChooseSavedWifiNetworkFragment extends WifiDppQrCodeBaseFragment {
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        beginTransaction.replace(C1985R$id.wifi_network_list_container, wifiNetworkListFragment, "wifi_network_list_fragment");
        beginTransaction.commit();
    }

    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C1987R$layout.wifi_dpp_choose_saved_wifi_network_fragment, viewGroup, false);
    }

    public void onViewCreated(View view, Bundle bundle) {
        super.onViewCreated(view, bundle);
        setHeaderTitle(C1992R$string.wifi_dpp_choose_network, new Object[0]);
        this.mSummary.setText(C1992R$string.wifi_dpp_choose_network_to_connect_device);
