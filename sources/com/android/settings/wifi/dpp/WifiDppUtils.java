...
public class WifiDppUtils {
    ...
    public static void showLockScreen(Context context, final Runnable runnable) {
        ...
        if (keyguardManager.isKeyguardSecure()) {
            C14391 r1 = new BiometricPrompt.AuthenticationCallback() {
            ...
            BiometricPrompt.Builder title = new BiometricPrompt.Builder(context).setTitle(context.getText(C1992R$string.wifi_dpp_lockscreen_title));
