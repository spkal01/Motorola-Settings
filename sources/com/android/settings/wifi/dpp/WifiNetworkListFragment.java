...
public class WifiNetworkListFragment extends SettingsPreferenceFragment implements SavedNetworkTracker.SavedNetworkTrackerCallback, Preference.OnPreferenceClickListener {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (!MotoDevicePolicyUtils.canAddNetworkWithAdminRestrictions(getContext(), wifiConfiguration)) {
            if (Build.IS_DEBUGGABLE) {
                Log.d("WifiNetworkListFragment", "-> MotoDevicePolicyManager Can't save the current wifi configuration: " + wifiConfiguration.SSID);
            }
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        addPreferencesFromResource(C1994R$xml.wifi_dpp_network_list);
        ...
        this.mAddPreference.setTitle(C1992R$string.wifi_add_network);
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (preference instanceof WifiEntryPreference) {
            ...
            new SubSettingLauncher(getContext()).setTitleRes(C1992R$string.wifi_add_network).setDestination(AddNetworkFragment.class.getName()).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, 1).launch();
        }
        return true;
    }
