...
public class WifiDppQrCodeScannerFragment extends WifiDppQrCodeBaseFragment implements TextureView.SurfaceTextureListener, QrCamera.ScannerCallback, WifiManager.ActionListener {
    ...
    /* access modifiers changed from: private */
    public SurfaceTexture mCurrentSurface = null;
    /* access modifiers changed from: private */
    ...
    public final Handler mHandler = new Handler() {
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                if (i == 4 && WifiDppQrCodeScannerFragment.this.mScanWifiDppSuccessListener != null) {
                    WifiManager wifiManager = (WifiManager) WifiDppQrCodeScannerFragment.this.getContext().getSystemService(WifiManager.class);
                    WifiNetworkConfig wifiNetworkConfig = (WifiNetworkConfig) message.obj;
                    List<WifiConfiguration> wifiConfigurations = wifiNetworkConfig.getWifiConfigurations();
                    if (UnsecuredNetworkDialog.shouldShowQRCodeDialog(WifiDppQrCodeScannerFragment.this.getContext(), message.arg1, wifiNetworkConfig)) {
                        UnsecuredNetworkDialog.show(WifiDppQrCodeScannerFragment.this.getContext(), wifiNetworkConfig.getSsid(), new WifiDppQrCodeScannerFragment$1$$ExternalSyntheticLambda1(this, wifiNetworkConfig), new WifiDppQrCodeScannerFragment$1$$ExternalSyntheticLambda0(this));
                        return;
                    }
                    boolean z = false;
                    for (WifiConfiguration next : wifiConfigurations) {
                        int addNetwork = wifiManager.addNetwork(next);
                        if (addNetwork != -1) {
                            if (!MotoDevicePolicyUtils.applyAdminRestriction((WifiEntry) null, next, WifiDppQrCodeScannerFragment.this.getContext())) {
                                ...
                                Log.d("WifiDppQrCodeScanner", "Can't connect to networks due to Admin Restrictions...");
                            }
                        }
                    }
                    if (!z) {
                        WifiDppQrCodeScannerFragment.this.showErrorMessageAndRestartCamera(C1992R$string.wifi_dpp_check_connection_try_again);
                        return;
                    }
        ...
        /* access modifiers changed from: private */
        public /* synthetic */ void lambda$handleMessage$0(WifiNetworkConfig wifiNetworkConfig, DialogInterface dialogInterface, int i) {
            Message obtainMessage = WifiDppQrCodeScannerFragment.this.mHandler.obtainMessage(4);
            obtainMessage.obj = wifiNetworkConfig;
            obtainMessage.arg1 = 1;
            WifiDppQrCodeScannerFragment.this.mHandler.sendMessage(obtainMessage);
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        getParentFragmentManager().setFragmentResultListener("QrCodeScanner", this, new FragmentResultListener() {
            public void onFragmentResult(String str, Bundle bundle) {
                int rotation;
                if (bundle.getInt("orientation") != -1 && WifiDppQrCodeScannerFragment.this.mCamera != null && (rotation = WifiDppQrCodeScannerFragment.this.mCamera.getRotation()) != -1 && WifiDppQrCodeScannerFragment.this.mWindowManager != null && WifiDppQrCodeScannerFragment.this.mWindowManager.getDefaultDisplay().getRotation() != rotation && WifiDppQrCodeScannerFragment.this.mCurrentSurface != null) {
                    WifiDppQrCodeScannerFragment.this.destroyCamera();
                    WifiDppQrCodeScannerFragment wifiDppQrCodeScannerFragment = WifiDppQrCodeScannerFragment.this;
                    wifiDppQrCodeScannerFragment.initCamera(wifiDppQrCodeScannerFragment.mCurrentSurface);
                }
            }
        });
    }
    ...
    /* JADX WARNING: type inference failed for: r7v0, types: [com.android.settings.wifi.dpp.WifiDppQrCodeScannerFragment$3, java.time.Clock] */
    public void onActivityCreated(Bundle bundle) {
        ...
        if (this.mIsConfiguratorMode) {
            getActivity().setTitle(C1992R$string.wifi_dpp_add_device_to_network);
        } else {
            getActivity().setTitle(C1992R$string.wifi_dpp_scan_qr_code);
        }
    }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C1987R$layout.wifi_dpp_qrcode_scanner_fragment, viewGroup, false);
    }

    public void onViewCreated(View view, Bundle bundle) {
        super.onViewCreated(view, bundle);
        this.mSummary = (TextView) view.findViewById(C1985R$id.sud_layout_subtitle);
        TextureView textureView = (TextureView) view.findViewById(C1985R$id.preview_view);
        this.mTextureView = textureView;
        textureView.setSurfaceTextureListener(this);
        this.mDecorateView = (QrDecorateView) view.findViewById(C1985R$id.decorate_view);
        setProgressBarShown(isWifiDppHandshaking());
        if (this.mIsConfiguratorMode) {
            setHeaderTitle(C1992R$string.wifi_dpp_add_device_to_network, new Object[0]);
            WifiNetworkConfig wifiNetworkConfig = ((WifiNetworkConfig.Retriever) getActivity()).getWifiNetworkConfig();
            if (WifiNetworkConfig.isValidConfig(wifiNetworkConfig)) {
                this.mSummary.setText(getString(C1992R$string.wifi_dpp_center_qr_code, wifiNetworkConfig.getSsid()));
            } else {
                throw new IllegalStateException("Invalid Wi-Fi network for configuring");
            }
        } else {
            setHeaderTitle(C1992R$string.wifi_dpp_scan_qr_code, new Object[0]);
            updateEnrolleeSummary();
        }
        this.mErrorMessage = (TextView) view.findViewById(C1985R$id.error_message);
    }
    ...
    public boolean isValid(String str) {
        try {
            ...
            showErrorMessage(C1992R$string.wifi_dpp_qr_code_is_not_valid_format);
            return false;
    ...
    private class EasyConnectEnrolleeStatusCallback extends EasyConnectStatusCallback {
        ...
        public void onEnrolleeSuccess(int i) {
            ...
            for (WifiConfiguration wifiConfiguration : wifiManager.getPrivilegedConfiguredNetworks()) {
                if (wifiConfiguration.networkId == i) {
                    if (!MotoDevicePolicyUtils.applyAdminRestriction((WifiEntry) null, wifiConfiguration, WifiDppQrCodeScannerFragment.this.getContext())) {
                        ...
                        Log.d("WifiDppQrCodeScanner", "Can't connect to network due to admin restrictions...");
                    }
                }
            }
        ...
        public void onFailure(int i) {
            ...
            switch (i) {
                ...
                case -7:
                    i2 = C1992R$string.wifi_dpp_failure_generic;
                    break;
                case -6:
                    i2 = C1992R$string.wifi_dpp_failure_timeout;
                    break;
                case -5:
                ...
                case -4:
                    i2 = C1992R$string.wifi_dpp_failure_authentication_or_configuration;
                    break;
                case -3:
                    i2 = C1992R$string.wifi_dpp_failure_not_compatible;
                    break;
                case -2:
                    i2 = C1992R$string.wifi_dpp_failure_authentication_or_configuration;
                    break;
                case -1:
                    i2 = C1992R$string.wifi_dpp_qr_code_is_not_valid_format;
                    break;
                default:
    ...
    public void onFailure(int i) {
        ...
        showErrorMessageAndRestartCamera(C1992R$string.wifi_dpp_check_connection_try_again);
    }
    ...
    public void updateEnrolleeSummary() {
        String str;
        if (isWifiDppHandshaking()) {
            this.mSummary.setText(C1992R$string.wifi_dpp_connecting);
            return;
        }
        if (TextUtils.isEmpty(this.mSsid)) {
            str = getString(C1992R$string.wifi_dpp_scan_qr_code_join_unknown_network, this.mSsid);
        } else {
            str = getString(C1992R$string.wifi_dpp_scan_qr_code_join_network, this.mSsid);
        }
