...
public class WifiSettings extends RestrictedSettingsFragment implements WifiPickerTracker.WifiPickerTrackerCallback, WifiDialog2.WifiDialog2Listener, DialogInterface.OnDismissListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.wifi_settings) {
    ...
    private final Runnable mHideProgressBarRunnable = new WifiSettings$$ExternalSyntheticLambda8(this);
    ...
    private final Runnable mUpdateWifiEntryPreferencesRunnable = new WifiSettings$$ExternalSyntheticLambda6(this);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        ((SettingsActivity) activity).getSwitchBar().setTitle(getContext().getString(C1992R$string.wifi_settings_primary_switch_title));
    }
    ...
    private void addPreferences() {
        addPreferencesFromResource(C1994R$xml.wifi_settings);
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        if (preference instanceof LongPressWifiEntryPreference) {
            ...
            if (this.mSelectedWifiEntry.canDisconnect()) {
                contextMenu.add(0, 6, 0, C1992R$string.share);
    ...
    public boolean onContextItemSelected(MenuItem menuItem) {
        ...
        if (itemId == 2) {
            if (UnsecuredNetworkDialog.shouldShowDialog((Context) getActivity(), this.mSelectedWifiEntry)) {
                UnsecuredNetworkDialog.show(getActivity(), this.mSelectedWifiEntry.getSsid(), new WifiSettings$$ExternalSyntheticLambda0(this), (DialogInterface.OnClickListener) null);
            } else {
            ...
            WifiDppUtils.showLockScreen(getContext(), new WifiSettings$$ExternalSyntheticLambda7(this));
            return true;
        }
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference instanceof LongPressWifiEntryPreference) {
            ...
            if (wifiEntry.shouldEditBeforeConnect()) {
                ...
                UnsecuredNetworkDialog.show(getActivity(), wifiEntry.getSsid(), new WifiSettings$$ExternalSyntheticLambda1(this, wifiEntry), (DialogInterface.OnClickListener) null);
            } else {
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$onPreferenceTreeClick$4(WifiEntry wifiEntry, DialogInterface dialogInterface, int i) {
        connect(wifiEntry, true, true);
    }
    ...
    public void onWifiStateChanged() {
        if (!this.mIsRestricted) {
            ...
            if (wifiState == 0) {
                ...
                addMessagePreference(C1992R$string.wifi_stopping);
            } else if (wifiState == 1) {
                setOffMessage();
                ...
                removeConnectedWifiEntryPreference();
                removeWifiEntryPreference();
                addMessagePreference(C1992R$string.wifi_starting);
    ...
    public void onWifiEntriesChanged() {
        ...
        if (this.mOpenSsid != null) {
            Optional findFirst = this.mWifiPickerTracker.getWifiEntries().stream().filter(new WifiSettings$$ExternalSyntheticLambda9(this)).filter(WifiSettings$$ExternalSyntheticLambda11.INSTANCE).filter(WifiSettings$$ExternalSyntheticLambda10.INSTANCE).findFirst();
        ...
        if (this.mWifiPickerTracker.getWifiState() == 3) {
            ...
            if (connectedWifiEntry != null) {
                ...
                if (longPressWifiEntryPreference == null || longPressWifiEntryPreference.getWifiEntry() != connectedWifiEntry) {
                    ...
                    connectedWifiEntryPreference.setOnPreferenceClickListener(new WifiSettings$$ExternalSyntheticLambda2(this, connectedWifiEntry, connectedWifiEntryPreference));
    ...
    private void setOffMessage() {
        CharSequence charSequence;
        CharSequence text = getText(C1992R$string.wifi_empty_list_wifi_off);
        if (this.mWifiManager.isScanAlwaysAvailable()) {
            charSequence = getText(C1992R$string.wifi_scan_notify_text);
        } else {
            charSequence = getText(C1992R$string.wifi_scan_notify_text_scanning_off);
        }
        this.mStatusMessagePreference.setText(text, charSequence, new WifiSettings$$ExternalSyntheticLambda3(this));
        removeConnectedWifiEntryPreference();
        removeWifiEntryPreference();
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$setOffMessage$11() {
        new SubSettingLauncher(getContext()).setDestination(WifiScanningFragment.class.getName()).setTitleRes(C1992R$string.location_scanning_wifi_always_scanning_title).setSourceMetricsCategory(getMetricsCategory()).launch();
    }
    ...
    public void onSubmit(WifiDialog2 wifiDialog2) {
        ...
        if (mode == 2) {
            ...
            } else if (controller.getCurSecurity() == 8) {
                startWapiCertManage();
            }
    ...
    private void startWapiCertManage() {
        ...
        builder.setMessage(getString(C1992R$string.wapi_no_vaild_cert));
        builder.setCancelable(false);
        builder.setPositiveButton(C1992R$string.wapi_yes, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                Log.d("WifiSettings", "startWapiCertManage: yes");
                WifiSettings.this.startActivity(new Intent("android.Wapi.CertManage"));
            }
        });
        builder.setNegativeButton(C1992R$string.wapi_no, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private class WifiConnectActionListener implements WifiManager.ActionListener {
        ...
        public void onFailure(int i) {
            if (!WifiSettings.this.isFinishingOrDestroyed()) {
                Toast.makeText(WifiSettings.this.getContext(), C1992R$string.wifi_failed_connect_message, 0).show();
            }
        }
    }
