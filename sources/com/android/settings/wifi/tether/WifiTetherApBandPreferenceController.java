...
public class WifiTetherApBandPreferenceController extends WifiTetherBasePreferenceController {
    ...
    public void updateDisplay() {
        ...
        if (!is5GhzBandSupported()) {
            ...
            listPreference.setSummary(C1992R$string.wifi_ap_choose_2G);
            return;
        }
    ...
    public String getConfigSummary() {
        ...
        if (i != 2) {
            return this.mContext.getString(C1992R$string.wifi_ap_prefer_5G);
        }
    ...
    public void updatePreferenceEntries() {
        ...
        int i = C1978R$array.wifi_ap_band;
        int i2 = C1978R$array.wifi_ap_band_summary;
    ...
    private boolean is5GhzBandSupported() {
        ...
        return this.mWifiManager.is5GHzBandSupported() && countryCode != null && !countryCode.equals("JP");
    }
