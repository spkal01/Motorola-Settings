...
public class WifiTetherMaximizeCompatibilityPreferenceController extends WifiTetherBasePreferenceController {
    ...
    public void updateDisplay() {
        ...
        if (preference != null) {
            ...
            if (this.mWifiManager.isBridgedApConcurrencySupported()) {
                i = C1992R$string.wifi_hotspot_maximize_compatibility_dual_ap_summary;
            } else {
                i = C1992R$string.wifi_hotspot_maximize_compatibility_single_ap_summary;
            }
    ...
    private boolean is5GhzBandSupported() {
        ...
        if (wifiManager != null && wifiManager.is5GHzBandSupported() && this.mWifiManager.getCountryCode() != null && !this.mWifiManager.getCountryCode().equals("JP")) {
            return true;
        }
        return false;
    }
