...
public class WifiWakeupPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnPause, OnResume {
    ...
    public CharSequence getSummary() {
        ...
        return this.mContext.getText(C1992R$string.wifi_wakeup_summary);
    }
    ...
    public CharSequence getNoLocationSummary() {
        ...
        return AnnotationSpan.linkify(this.mContext.getText(C1992R$string.wifi_wakeup_summary_no_location), linkInfo);
    }
