    ...
    public static class AlertDialogFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            if (TextUtils.isEmpty(this.mApp)) {
                str = getString(C1992R$string.wifi_scan_always_turn_on_message_unknown);
            } else {
                str = getString(C1992R$string.wifi_scan_always_turnon_message, this.mApp);
            }
            return builder.setMessage((CharSequence) str).setPositiveButton(C1992R$string.wifi_scan_always_confirm_allow, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    ((WifiScanModeActivity) AlertDialogFragment.this.getActivity()).doPositiveClick();
                }
            }).setNegativeButton(C1992R$string.wifi_scan_always_confirm_deny, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
