...
public class NetworkRequestErrorDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (error_dialog_type2 == error_dialog_type) {
            builder.setMessage(C1992R$string.network_connection_timeout_dialog_message).setPositiveButton(C1992R$string.network_connection_timeout_dialog_ok, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda1(this));
        } else {
            builder.setMessage(C1992R$string.network_connection_errorstate_dialog_message).setPositiveButton(C1992R$string.okay, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda2(this));
        }
