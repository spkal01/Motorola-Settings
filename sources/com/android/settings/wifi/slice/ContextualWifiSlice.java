...
public class ContextualWifiSlice extends WifiSlice {
    ...
    private IconCompat getHeaderIcon(boolean z, WifiSliceItem wifiSliceItem) {
        ...
        int i;
        if (!z) {
            drawable = this.mContext.getDrawable(C1983R$drawable.ic_wifi_off);
    ...
    private CharSequence getHeaderSubtitle(WifiSliceItem wifiSliceItem) {
        if (wifiSliceItem == null || wifiSliceItem.getConnectedState() == 0) {
            return this.mContext.getText(C1992R$string.disconnected);
        }
        if (wifiSliceItem.getConnectedState() == 1) {
            return this.mContext.getString(C1992R$string.wifi_connecting_to_message, new Object[]{wifiSliceItem.getTitle()});
        }
        return this.mContext.getString(C1992R$string.wifi_connected_to_message, new Object[]{wifiSliceItem.getTitle()});
    }
