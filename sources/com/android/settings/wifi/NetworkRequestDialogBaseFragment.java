...
public abstract class NetworkRequestDialogBaseFragment extends InstrumentedDialogFragment {
    ...
    public String getTitle() {
        return getString(C1992R$string.network_connection_request_dialog_title);
    }

    /* access modifiers changed from: protected */
    public String getSummary() {
        return getString(C1992R$string.network_connection_request_dialog_summary, this.mAppName);
    }
}
