...
public class QrDecorateView extends View {
    ...
    public QrDecorateView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCornerColor = context.getResources().getColor(C1981R$color.qr_corner_line_color);
        this.mFocusedCornerColor = context.getResources().getColor(C1981R$color.qr_focused_corner_line_color);
        int color = context.getResources().getColor(C1981R$color.qr_background_color);
