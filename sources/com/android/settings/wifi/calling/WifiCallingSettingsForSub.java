...
import com.motorola.settings.wifi.calling.WfcEmergencyCallDisclaimerDialogFragment;
...
public class WifiCallingSettingsForSub extends SettingsPreferenceFragment implements OnMainSwitchChangeListener, Preference.OnPreferenceChangeListener {
    ...
    private class PhoneTelephonyCallback extends TelephonyCallback implements TelephonyCallback.CallStateListener {
        ...
        public void onCallStateChanged(int i) {
            ...
            if (settingsActivity == null) {
                Log.e("WifiCallingForSub", "onCallStateChanged Activity is null");
                return;
            }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        this.mEmptyView.setText(resourcesForSubId.getString(C1992R$string.wifi_calling_off_explanation, new Object[]{resourcesForSubId.getString(C1992R$string.wifi_calling_off_explanation_2)}));
        SettingsMainSwitchBar settingsMainSwitchBar = (SettingsMainSwitchBar) getView().findViewById(C1985R$id.switch_bar);
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.wifi_calling_settings);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C1987R$layout.wifi_calling_settings_preferences, viewGroup, false);
    ...
    public void updateBody() {
        ...
        Resources resourcesForSubId = getResourcesForSubId();
        this.mButtonWfcMode.setTitle((CharSequence) resourcesForSubId.getString(C1992R$string.wifi_calling_mode_title));
        this.mButtonWfcMode.setDialogTitle((CharSequence) resourcesForSubId.getString(C1992R$string.wifi_calling_mode_dialog_title));
        this.mButtonWfcRoamingMode.setTitle((CharSequence) resourcesForSubId.getString(C1992R$string.wifi_calling_roaming_mode_title));
        this.mButtonWfcRoamingMode.setDialogTitle((CharSequence) resourcesForSubId.getString(C1992R$string.wifi_calling_roaming_mode_dialog_title));
        if (z) {
            charSequenceArr4 = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_choices);
            charSequenceArr3 = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_values);
            charSequenceArr2 = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_summaries);
            charSequenceArr = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_choices_v2);
        } else {
            charSequenceArr4 = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_choices_without_wifi_only);
            charSequenceArr3 = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_values_without_wifi_only);
            charSequenceArr2 = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_summaries_without_wifi_only);
            charSequenceArr = resourcesForSubId.getStringArray(C1978R$array.wifi_calling_mode_choices_v2_without_wifi_only);
        }
        if (z2) {
            String string = resourcesForSubId.getString(C1992R$string.wifi_calling_mode_ims_preferred);
            String string2 = resourcesForSubId.getString(C1992R$string.wifi_calling_mode_ims_preferred_v2);
            String valueOf = String.valueOf(10);
            String string3 = resourcesForSubId.getString(C1992R$string.wifi_calling_mode_ims_preferred_summary);
            charSequenceArr4 = addNewElementToArray(charSequenceArr4, string);
            charSequenceArr3 = addNewElementToArray(charSequenceArr3, valueOf);
            charSequenceArr2 = addNewElementToArray(charSequenceArr2, string3);
            charSequenceArr = addNewElementToArray(charSequenceArr, string2);
        }
        this.mButtonWfcMode.setEntries(charSequenceArr4);
        this.mButtonWfcMode.setEntryValues(charSequenceArr3);
        this.mButtonWfcMode.setEntrySummaries(charSequenceArr2);
        this.mButtonWfcRoamingMode.setEntries(charSequenceArr);
        this.mButtonWfcRoamingMode.setEntryValues(charSequenceArr3);
        this.mButtonWfcRoamingMode.setEntrySummaries(charSequenceArr2);
    ...
    private CharSequence[] addNewElementToArray(CharSequence[] charSequenceArr, CharSequence charSequence) {
        CharSequence[] charSequenceArr2 = new CharSequence[(charSequenceArr.length + 1)];
        for (int i = 0; i < charSequenceArr.length; i++) {
            charSequenceArr2[i] = charSequenceArr[i];
        }
        charSequenceArr2[charSequenceArr.length] = charSequence;
    ...
    public void onSwitchChanged(Switch switchR, boolean z) {
        ...
        if (!z) {
            updateWfcMode(false);
        } else if (!WfcEmergencyCallDisclaimerDialogFragment.isWFCEmergencyWarningsEnabled(getContext(), this.mSubId)) {
            FragmentActivity activity = getActivity();
            Bundle bundle = new Bundle();
            bundle.putInt("EXTRA_SUB_ID", this.mSubId);
            new SubSettingLauncher(activity).setDestination(WifiCallingDisclaimerFragment.class.getName()).setArguments(bundle).setTitleRes(C1992R$string.wifi_calling_settings_title).setSourceMetricsCategory(getMetricsCategory()).setResultListener(this, 2).launch();
        } else if (WfcEmergencyCallDisclaimerDialogFragment.shouldShow(getContext(), this.mSubId, z)) {
    ...
    private CharSequence getWfcModeSummary(int i) {
        ...
        if (queryImsState(this.mSubId).isEnabledByUser()) {
            if (i == 0) {
                ...
                i2 = C1992R$string.wifi_calling_mode_ims_preferred;
            }
    ...
    private void showDialogDisclaimer() {
        WfcEmergencyCallDisclaimerDialogFragment.show(getFragmentManager(), new WfcEmergencyCallDisclaimerDialogFragment.WfcDisclaimerCallback() {
            public void accept() {
                WifiCallingSettingsForSub.this.updateWfcMode(true);
            }

            public void cancel() {
                WifiCallingSettingsForSub.this.mSwitchBar.setCheckedInternal(false);
            }
        });
    }
}
