...
public class ListWithEntrySummaryPreference extends CustomListPreference {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder, DialogInterface.OnClickListener onClickListener) {
        builder.setSingleChoiceItems((ListAdapter) new SelectorAdapter(this.mContext, C1994R$xml.single_choice_list_item_2, this), findIndexOfValue(getValue()), onClickListener);
    ...
    private static class SelectorAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View inflate = LayoutInflater.from(this.mContext).inflate(C1994R$xml.single_choice_list_item_2, viewGroup, false);
            ((TextView) inflate.findViewById(C1985R$id.title)).setText(this.mSelector.getEntries()[i]);
            ((TextView) inflate.findViewById(C1985R$id.summary)).setText(this.mSelector.getEntrySummary(i));
            RadioButton radioButton = (RadioButton) inflate.findViewById(C1985R$id.radio);
