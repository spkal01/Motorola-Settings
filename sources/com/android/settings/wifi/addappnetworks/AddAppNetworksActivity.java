...
public class AddAppNetworksActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1987R$layout.settings_panel);
    ...
    public void showAddNetworksFragment() {
        ...
        if (findFragmentByTag == null) {
            ...
            supportFragmentManager.beginTransaction().add(C1985R$id.main_content, (Fragment) addAppNetworksFragment, "AddAppNetworksActivity").commit();
            return;
        }
