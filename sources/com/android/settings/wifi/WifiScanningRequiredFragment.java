...
public class WifiScanningRequiredFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        AlertDialog.Builder negativeButton = new AlertDialog.Builder(getContext()).setTitle(C1992R$string.wifi_settings_scanning_required_title).setView(C1987R$layout.wifi_settings_scanning_required_view).setPositiveButton(C1992R$string.wifi_settings_scanning_required_turn_on, (DialogInterface.OnClickListener) this).setNegativeButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null);
    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        if (i == -3) {
            ...
            Toast.makeText(context, context.getString(C1992R$string.wifi_settings_scanning_required_enabled), 0).show();
    ...
    public void addButtonIfNeeded(AlertDialog.Builder builder) {
        if (!TextUtils.isEmpty(getContext().getString(C1992R$string.help_uri_wifi_scanning_required))) {
            builder.setNeutralButton(C1992R$string.learn_more, this);
        }
    }
    ...
    public Intent getHelpIntent(Context context) {
        return HelpUtils.getHelpIntent(context, context.getString(C1992R$string.help_uri_wifi_scanning_required), context.getClass().getName());
    }
}
