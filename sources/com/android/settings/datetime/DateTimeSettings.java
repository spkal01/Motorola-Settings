...
public class DateTimeSettings extends DashboardFragment implements TimePreferenceController.TimePreferenceHost, DatePreferenceController.DatePreferenceHost {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.date_time_prefs);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.date_time_prefs;
    }

    public int getHelpResource() {
        return C1992R$string.help_url_date_time;
    }
