...
public class RegionZonePreferenceController extends BaseTimeZonePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        return SpannableUtil.getResourcesText(this.mContext.getResources(), C1992R$string.zone_info_exemplar_location_and_offset, this.mTimeZoneInfo.getExemplarLocation(), this.mTimeZoneInfo.getGmtOffset());
    }
