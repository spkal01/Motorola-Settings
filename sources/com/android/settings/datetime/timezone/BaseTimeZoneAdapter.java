...
public class BaseTimeZoneAdapter<T extends AdapterItem> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            return new HeaderViewHolder(from.inflate(C1987R$layout.time_zone_search_header, viewGroup, false));
        }
        if (i == 1) {
            return new ItemViewHolder(from.inflate(C1987R$layout.time_zone_search_item, viewGroup, false), this.mOnListItemClickListener);
        }
    ...
    public static class ItemViewHolder<T extends AdapterItem> extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ItemViewHolder(View view, BaseTimeZonePicker.OnListItemClickListener<T> onListItemClickListener) {
            ...
            this.mSummaryFrame = view.findViewById(C1985R$id.summary_frame);
            this.mTitleView = (TextView) view.findViewById(16908310);
            this.mIconFrameView = view.findViewById(C1985R$id.icon_frame);
            this.mIconTextView = (TextView) view.findViewById(C1985R$id.icon_text);
            this.mSummaryView = (TextView) view.findViewById(16908304);
            this.mTimeView = (TextView) view.findViewById(C1985R$id.current_time);
            this.mOnListItemClickListener = onListItemClickListener;
        }
        ...
        public void setAdapterItem(T t) {
            ...
            if (t.getIconText() == null) {
                this.mIconFrameView.setVisibility(8);
            }
        }
