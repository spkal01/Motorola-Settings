...
public class TimeZoneSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.time_zone_prefs) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.time_zone_prefs;
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 1, 0, C1992R$string.zone_menu_by_region);
        menu.add(0, 2, 0, C1992R$string.zone_menu_by_offset);
