...
class LocaleDragAndDropAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new CustomViewHolder((LocaleDragCell) LayoutInflater.from(this.mContext).inflate(C1987R$layout.locale_drag_cell, viewGroup, false));
    }
    ...
    public void onBindViewHolder(CustomViewHolder customViewHolder, int i) {
        ...
        localeDragCell.setLocalized(localeInfo);
        boolean z = true;
    ...
    public void updateLocalesWhenAnimationStops(LocaleList localeList) {
        if (!localeList.equals(this.mLocalesToSetNext)) {
            if (Build.IS_DEBUGGABLE) {
                Log.d("LocaleDragAndDropAdapter", "doTheUpdate: " + localeList.toString());
            }
