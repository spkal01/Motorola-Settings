...
public class LocaleLinearLayoutManager extends LinearLayoutManager {
    ...
    public LocaleLinearLayoutManager(Context context, LocaleDragAndDropAdapter localeDragAndDropAdapter) {
        ...
        this.mActionMoveUp = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C1985R$id.action_drag_move_up, context.getString(C1992R$string.action_drag_label_move_up));
        this.mActionMoveDown = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C1985R$id.action_drag_move_down, context.getString(C1992R$string.action_drag_label_move_down));
        this.mActionMoveTop = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C1985R$id.action_drag_move_top, context.getString(C1992R$string.action_drag_label_move_top));
        this.mActionMoveBottom = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C1985R$id.action_drag_move_bottom, context.getString(C1992R$string.action_drag_label_move_bottom));
        this.mActionRemove = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C1985R$id.action_drag_remove, context.getString(C1992R$string.action_drag_label_remove));
    }
    ...
    public boolean performAccessibilityActionForItem(androidx.recyclerview.widget.RecyclerView.Recycler r6, androidx.recyclerview.widget.RecyclerView.State r7, android.view.View r8, int r9, android.os.Bundle r10) {
        /*
            ...
            int r2 = com.android.settings.C1985R$id.action_drag_move_up
            r3 = 0
            r4 = 1
        ...
        L_0x0017:
            ...
            goto L_0x004c
        L_0x0019:
            int r2 = com.android.settings.C1985R$id.action_drag_move_down
            ...
            goto L_0x0017
        L_0x0027:
            int r2 = com.android.settings.C1985R$id.action_drag_move_top
            ...
            goto L_0x0017
        L_0x0033:
            int r2 = com.android.settings.C1985R$id.action_drag_move_bottom
            ...
            goto L_0x0017
        L_0x0040:
            int r2 = com.android.settings.C1985R$id.action_drag_remove
