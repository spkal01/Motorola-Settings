...
import com.android.settings.C1984R$fraction;
...
public class FingerprintLocationAnimationView extends View implements FingerprintFindSensorAnimation {
    ...
    private final int mDotRadius = getResources().getDimensionPixelSize(C1982R$dimen.fingerprint_dot_radius);
    private final Interpolator mFastOutSlowInInterpolator;
    private final float mFractionCenterX = getResources().getFraction(C1984R$fraction.fingerprint_sensor_location_fraction_x, 1, 1);
    private final float mFractionCenterY = getResources().getFraction(C1984R$fraction.fingerprint_sensor_location_fraction_y, 1, 1);
    private final Interpolator mLinearOutSlowInInterpolator;
    private final int mMaxPulseRadius = getResources().getDimensionPixelSize(C1982R$dimen.fingerprint_pulse_radius);
    /* access modifiers changed from: private */
