...
public class ParticleCollection implements BiometricEnrollSidecar.Listener {
    ...
    public ParticleCollection(Context context, Listener listener, Rect rect, int i) {
        ...
        arrayList.add(Integer.valueOf(resources.getColor(C1981R$color.face_anim_particle_color_1, theme)));
        arrayList.add(Integer.valueOf(resources.getColor(C1981R$color.face_anim_particle_color_2, theme)));
        arrayList.add(Integer.valueOf(resources.getColor(C1981R$color.face_anim_particle_color_3, theme)));
        arrayList.add(Integer.valueOf(resources.getColor(C1981R$color.face_anim_particle_color_4, theme)));
