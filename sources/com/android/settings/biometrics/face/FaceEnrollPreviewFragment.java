...
public class FaceEnrollPreviewFragment extends InstrumentedPreferenceFragment implements BiometricEnrollSidecar.Listener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mTextureView = (FaceSquareTextureView) getActivity().findViewById(C1985R$id.texture_view);
        ImageView imageView = (ImageView) getActivity().findViewById(C1985R$id.circle_view);
    ...
    public void configureTransform(int i, int i2) {
        if (this.mTextureView != null) {
            ...
            getResources().getValue(C1982R$dimen.face_preview_translate_x, typedValue, true);
            getResources().getValue(C1982R$dimen.face_preview_translate_y, typedValue2, true);
            getResources().getValue(C1982R$dimen.face_preview_scale, typedValue3, true);
