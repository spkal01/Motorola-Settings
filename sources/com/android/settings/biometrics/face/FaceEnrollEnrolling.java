...
public class FaceEnrollEnrolling extends BiometricsEnrollEnrolling {
    ...
    public static class FaceErrorDialog extends BiometricErrorDialog {
        ...
        public int getTitleResId() {
            return C1992R$string.security_settings_face_enroll_error_dialog_title;
        }

        public int getOkButtonTextResId() {
            return C1992R$string.security_settings_face_enroll_dialog_ok;
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1987R$layout.face_enroll_enrolling);
        setHeaderText(C1992R$string.security_settings_face_enroll_repeat_title);
        ...
        footerBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(C1992R$string.security_settings_face_enroll_enrolling_skip).setListener(new FaceEnrollEnrolling$$ExternalSyntheticLambda0(this)).setButtonType(7).setTheme(C1993R$style.SudGlifButton_Secondary).build());
    ...
    public void onEnrollmentError(int i, CharSequence charSequence) {
        int i2;
        if (i != 3) {
            i2 = C1992R$string.security_settings_face_enroll_error_generic_dialog_message;
        } else {
            i2 = C1992R$string.security_settings_face_enroll_error_timeout_dialog_message;
        }
