...
public class FaceSettingsRemoveButtonPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public static class ConfirmRemoveDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            if (FaceUtils.isMotoFaceUnlock()) {
                i = C1992R$string.face_remove_warning_msg;
            } else {
                i = C1992R$string.security_settings_face_settings_remove_dialog_details;
            }
            builder.setTitle(C1992R$string.security_settings_face_settings_remove_dialog_title_moto).setMessage(i).setPositiveButton(C1992R$string.face_remove_confirm_btn, this.mOnClickListener).setNegativeButton(C1992R$string.cancel, this.mOnClickListener);
    ...
    public FaceSettingsRemoveButtonPreferenceController(Context context, String str) {
        ...
        this.mOnClickListener = new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                if (i == -1) {
                    boolean unused = FaceSettingsRemoveButtonPreferenceController.this.mRemoving = true;
                ...
                FaceSettingsRemoveButtonPreferenceController.this.mButton.setEnabled(true);
                boolean unused2 = FaceSettingsRemoveButtonPreferenceController.this.mRemoving = false;
            }
        };
    ...
    public void updateState(Preference preference) {
        ...
        Button button = (Button) ((LayoutPreference) preference).findViewById(C1985R$id.security_settings_face_settings_remove_button);
        this.mButton = button;
