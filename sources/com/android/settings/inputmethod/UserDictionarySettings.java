...
public class UserDictionarySettings extends ListFragment implements Instrumentable, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        int i = C1992R$string.user_dict_settings_title;
        activity.setTitle(i);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        textView.setText(C1992R$string.user_dict_settings_empty_text);
    ...
    private ListAdapter createAdapter() {
        return new MyAdapter(getActivity(), C1987R$layout.user_dictionary_item, this.mCursor, new String[]{"word", "shortcut"}, new int[]{16908308, 16908309});
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 1, 0, C1992R$string.user_dict_settings_add_menu_title).setIcon(C1983R$drawable.ic_add_24dp).setShowAsAction(5);
    }
    ...
    private void showAddOrEditDialog(String str, String str2) {
        ...
        new SubSettingLauncher(getContext()).setDestination(UserDictionaryAddWordFragment.class.getName()).setArguments(bundle).setTitleRes(C1992R$string.user_dict_settings_add_dialog_title).setSourceMetricsCategory(getMetricsCategory()).launch();
    }
    ...
    private static class MyAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public MyAdapter(Context context, int i, Cursor cursor, String[] strArr, int[] iArr) {
            ...
            C10061 r2 = new SimpleCursorAdapter.ViewBinder() {
            ...
            this.mViewBinder = r2;
            if (cursor != null) {
                this.mIndexer = new AlphabetIndexer(cursor, cursor.getColumnIndexOrThrow("word"), context.getString(17040281));
            }
            setViewBinder(r2);
        }
