...
public class SpellCheckersSettings extends SettingsPreferenceFragment implements OnMainSwitchChangeListener, Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.spellchecker_prefs);
    ...
    private void populatePreferenceScreen() {
        ...
        spellCheckerPreference.setTitle(C1992R$string.default_spell_checker);
        ...
        if ((spellCheckerInfoArr == null ? 0 : spellCheckerInfoArr.length) > 0) {
            ...
            spellCheckerPreference.setSummary(C1992R$string.spell_checker_not_selected);
        }
    ...
    public void onResume() {
        ...
        switchBar.setTitle(getContext().getString(C1992R$string.spell_checker_primary_switch_title));
    ...
    private CharSequence getSpellCheckerSubtypeLabel(SpellCheckerInfo spellCheckerInfo, SpellCheckerSubtype spellCheckerSubtype) {
        if (spellCheckerInfo == null) {
            return getString(C1992R$string.spell_checker_not_selected);
        }
        if (spellCheckerSubtype == null) {
            return getString(C1992R$string.use_system_language_to_select_input_method_subtypes);
        }
    ...
    private void showChooseLanguageDialog() {
        ...
        if (currentSpellChecker != null) {
            ...
            builder.setTitle(C1992R$string.phone_language);
    ...
    private void showSecurityWarnDialog(final SpellCheckerInfo spellCheckerInfo) {
        ...
        builder.setMessage((CharSequence) getString(C1992R$string.spellchecker_security_warning, spellCheckerInfo.loadLabel(getPackageManager())));
