...
public class SpellCheckerPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public boolean isAvailable() {
        return this.mContext.getResources().getBoolean(C1980R$bool.config_show_spellcheckers_settings);
    }
    ...
    public void updateState(Preference preference) {
        if (preference != null) {
            ...
            if (currentSpellChecker != null) {
                ...
                preference.setSummary(C1992R$string.spell_checker_not_selected);
            }
        }
    }
}
