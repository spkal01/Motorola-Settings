...
public class KeyboardLayoutDialogFragment extends InstrumentedDialogFragment implements InputManager.InputDeviceListener, LoaderManager.LoaderCallbacks<Keyboards> {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog.Builder view = new AlertDialog.Builder(activity).setTitle(C1992R$string.keyboard_layout_dialog_title).setPositiveButton(C1992R$string.keyboard_layout_dialog_setup_button, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        }).setView(LayoutInflater.from(activity).inflate(C1987R$layout.keyboard_layout_dialog_switch_hint, (ViewGroup) null));
    ...
    private void updateSwitchHintVisibility() {
        AlertDialog alertDialog = (AlertDialog) getDialog();
        if (alertDialog != null) {
            alertDialog.findViewById(C1985R$id.customPanel).setVisibility(this.mAdapter.getCount() > 1 ? 0 : 8);
        }
    }
    ...
    private static final class KeyboardLayoutAdapter extends ArrayAdapter<KeyboardLayout> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (keyboardLayout != null) {
                ...
                str = getContext().getString(C1992R$string.keyboard_layout_default_label);
                str2 = "";
            }
            String str3 = str2;
            String str4 = str;
        ...
        private View inflateTwoLine(View view, ViewGroup viewGroup, String str, String str2, boolean z) {
            ...
            ((RadioButton) view.findViewById(16909342)).setChecked(z);
            return view;
        }
