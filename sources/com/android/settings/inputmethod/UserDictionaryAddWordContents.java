...
public class UserDictionaryAddWordContents {
    ...
    UserDictionaryAddWordContents(View view, Bundle bundle) {
        EditText editText = (EditText) view.findViewById(C1985R$id.user_dictionary_add_word_text);
        this.mWordEditText = editText;
        EditText editText2 = (EditText) view.findViewById(C1985R$id.user_dictionary_add_shortcut);
    ...
    UserDictionaryAddWordContents(View view, UserDictionaryAddWordContents userDictionaryAddWordContents) {
        this.mWordEditText = (EditText) view.findViewById(C1985R$id.user_dictionary_add_word_text);
        this.mShortcutEditText = (EditText) view.findViewById(C1985R$id.user_dictionary_add_shortcut);
        this.mMode = 0;
    ...
    public static class LocaleRenderer {
        ...
        public LocaleRenderer(Context context, String str) {
            ...
            if (str == null) {
                this.mDescription = context.getString(C1992R$string.user_dict_settings_more_languages);
            } else if ("".equals(str)) {
                this.mDescription = context.getString(C1992R$string.user_dict_settings_all_languages);
            } else {
