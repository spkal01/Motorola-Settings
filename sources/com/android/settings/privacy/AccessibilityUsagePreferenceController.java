...
public class AccessibilityUsagePreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        return this.mContext.getResources().getQuantityString(C1990R$plurals.accessibility_usage_summary, this.mEnabledServiceInfos.size(), new Object[]{Integer.valueOf(this.mEnabledServiceInfos.size())});
    }
}
