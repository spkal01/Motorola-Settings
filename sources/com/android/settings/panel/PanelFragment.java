...
public class PanelFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C1987R$layout.panel_layout, viewGroup, false);
        this.mLayoutView = inflate;
        inflate.getViewTreeObserver().addOnGlobalLayoutListener(this.mPanelLayoutListener);
        this.mMaxHeight = getResources().getDimensionPixelSize(C1982R$dimen.output_switcher_slice_max_height);
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (configuration.orientation == 2 && (view = this.mLayoutView) != null) {
    ...
    public void updatePanelWithAnimation() {
        this.mPanelCreating = true;
        AnimatorSet buildAnimatorSet = buildAnimatorSet(this.mLayoutView, 0.0f, (float) this.mLayoutView.findViewById(C1985R$id.panel_container).getHeight(), 1.0f, 0.0f, 200);
    ...
    public void createPanelContent() {
        ...
        if (activity != null) {
            ...
            layoutParams.height = -2;
            this.mLayoutView.setLayoutParams(layoutParams);
            this.mPanelSlices = (RecyclerView) this.mLayoutView.findViewById(C1985R$id.panel_parent_layout);
            this.mSeeMoreButton = (Button) this.mLayoutView.findViewById(C1985R$id.see_more);
            this.mDoneButton = (Button) this.mLayoutView.findViewById(C1985R$id.done);
            this.mTitleView = (TextView) this.mLayoutView.findViewById(C1985R$id.panel_title);
            this.mPanelHeader = (LinearLayout) this.mLayoutView.findViewById(C1985R$id.panel_header);
            this.mTitleIcon = (ImageView) this.mLayoutView.findViewById(C1985R$id.title_icon);
            this.mTitleGroup = (LinearLayout) this.mLayoutView.findViewById(C1985R$id.title_group);
            this.mHeaderLayout = (LinearLayout) this.mLayoutView.findViewById(C1985R$id.header_layout);
            this.mHeaderTitle = (TextView) this.mLayoutView.findViewById(C1985R$id.header_title);
            this.mHeaderSubtitle = (TextView) this.mLayoutView.findViewById(C1985R$id.header_subtitle);
            this.mFooterDivider = this.mLayoutView.findViewById(C1985R$id.footer_divider);
            this.mProgressBar = (ProgressBar) this.mLayoutView.findViewById(C1985R$id.progress_bar);
            this.mHeaderDivider = this.mLayoutView.findViewById(C1985R$id.header_divider);
    ...
    public void enablePanelHeader(IconCompat iconCompat, CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (iconCompat != null) {
            ...
            int dimensionPixelSize = getResources().getDimensionPixelSize(C1982R$dimen.output_switcher_panel_icon_size);
    ...
    private void removeSliceLiveData(Uri uri) {
        if (!Arrays.asList(getResources().getStringArray(C1978R$array.config_panel_keep_observe_uri)).contains(uri.toString())) {
    ...
    public void animateIn() {
        AnimatorSet buildAnimatorSet = buildAnimatorSet(this.mLayoutView, (float) this.mLayoutView.findViewById(C1985R$id.panel_container).getHeight(), 0.0f, 0.0f, 1.0f, 250);
        ValueAnimator valueAnimator = new ValueAnimator();
        valueAnimator.setFloatValues(new float[]{0.0f, 1.0f});
        buildAnimatorSet.play(valueAnimator);
        buildAnimatorSet.start();
    ...
    private static AnimatorSet buildAnimatorSet(View view, float f, float f2, float f3, float f4, int i) {
        View findViewById = view.findViewById(C1985R$id.panel_container);
