...
public class NfcPanel implements PanelContent {
    ...
    public CharSequence getTitle() {
        return this.mContext.getText(C1992R$string.nfc_quick_toggle_title);
    }
    ...
    public Intent getSeeMoreIntent() {
        Intent buildSearchResultPageIntent = SliceBuilderUtils.buildSearchResultPageIntent(this.mContext, AdvancedConnectedDeviceDashboardFragment.class.getName(), (String) null, this.mContext.getText(C1992R$string.connected_device_connections_title).toString(), 747);
