...
public class PanelSlicesAdapter extends RecyclerView.Adapter<SliceRowViewHolder> {
    static final int MAX_NUM_OF_SLICES = 8;
    ...
    public SliceRowViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 1) {
            view = from.inflate(C1987R$layout.panel_slice_slider_row, viewGroup, false);
        } else {
            view = from.inflate(C1987R$layout.panel_slice_row, viewGroup, false);
        }
    ...
    public int getItemCount() {
        return Math.min(this.mSliceLiveData.size(), 8);
    }
    ...
    public class SliceRowViewHolder extends RecyclerView.ViewHolder implements DividerItemDecoration.DividedViewHolder {
        ...
        public SliceRowViewHolder(View view) {
            super(view);
            SliceView sliceView2 = (SliceView) view.findViewById(C1985R$id.slice_view);
            this.sliceView = sliceView2;
            sliceView2.setMode(2);
            sliceView2.setShowTitleItems(true);
            sliceView2.setImportantForAccessibility(2);
            this.mSliceSliderLayout = (LinearLayout) view.findViewById(C1985R$id.slice_slider_layout);
        }
        ...
        public void onBind(LiveData<Slice> liveData, int i) {
            ...
            if (value == null || value.getUri().equals(CustomSliceRegistry.MEDIA_OUTPUT_INDICATOR_SLICE_URI) || value.getUri().equals(CustomSliceRegistry.VOLUME_RELATIVE_URI)) {
