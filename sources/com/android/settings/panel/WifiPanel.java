...
public class WifiPanel implements PanelContent {
    ...
    public CharSequence getTitle() {
        return this.mContext.getText(C1992R$string.wifi_settings);
    }
    ...
    public Intent getSeeMoreIntent() {
        Intent buildSearchResultPageIntent = SliceBuilderUtils.buildSearchResultPageIntent(this.mContext, WifiSettings.class.getName(), (String) null, this.mContext.getText(C1992R$string.wifi_settings).toString(), R$styleable.Constraint_layout_goneMarginTop);
