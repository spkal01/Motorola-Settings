...
public class SliceBuilderUtils {
    ...
    private static SliceAction getCopyableAction(Context context, SliceData sliceData) {
        return SliceAction.create(getActionIntent(context, "com.android.settings.slice.action.COPY", sliceData), IconCompat.createWithResource(context, C1983R$drawable.ic_content_copy_grey600_24dp), 0, sliceData.getTitle());
    }
    ...
    private static boolean isValidSummary(Context context, CharSequence charSequence) {
        ...
        CharSequence text = context.getText(C1992R$string.summary_placeholder);
        CharSequence text2 = context.getText(C1992R$string.summary_two_lines_placeholder);
    ...
    private static Slice buildUnavailableSlice(Context context, SliceData sliceData) {
        ...
        if (TextUtils.isEmpty(unavailableSliceSubtitle)) {
            unavailableSliceSubtitle = context.getText(C1992R$string.disabled_dependent_setting_summary);
        }
        IconCompat safeIcon = getSafeIcon(context, sliceData);
    ...
    static IconCompat getSafeIcon(Context context, SliceData sliceData) {
        ...
        if (iconResource == 0) {
            iconResource = C1983R$drawable.ic_settings_accent;
        }
        try {
            ...
            return IconCompat.createWithResource(context, C1983R$drawable.ic_settings_accent);
        }
    }
}
