...
class SliceDataConverter {
    ...
    private List<SliceData> getAccessibilitySliceData() {
        ...
        SliceData.Builder preferenceControllerClassName = new SliceData.Builder().setFragmentName(name2).setScreenTitle(this.mContext.getText(C1992R$string.accessibility_settings)).setPreferenceControllerClassName(name);
        HashSet hashSet = new HashSet();
        Collections.addAll(hashSet, this.mContext.getResources().getStringArray(C1978R$array.config_settings_slices_accessibility_components));
        ...
        for (AccessibilityServiceInfo resolveInfo : accessibilityServiceInfoList) {
            ...
            if (hashSet.contains(flattenToString)) {
                ...
                if (iconResource == 0) {
                    iconResource = C1983R$drawable.ic_accessibility_generic;
                }
