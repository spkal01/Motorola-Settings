...
import com.motorola.settings.network.telephony.ExtendedMobileDataSlice;
import com.motorola.settings.network.telephony.MobileDataSIM1Slice;
import com.motorola.settings.network.telephony.MobileDataSIM2Slice;
import com.motorola.settings.relativevolume.RelativeVolumePreferenceController;
import com.motorola.settings.relativevolume.RelativeVolumeSlice;
...
public class CustomSliceRegistry {
    ...
    public static final Uri MOBILE_DATA_SIM1_SLICE_URI;
    public static final Uri MOBILE_DATA_SIM2_SLICE_URI;
    ...
    public static final Uri VOLUME_NOTIFICATION_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("notification_volume").build();
    public static final Uri VOLUME_RELATIVE_URI;
    ...
    static {
        ...
        Uri uri = build9;
        Uri build10 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendEncodedPath("action").appendPath("mobile_data").appendPath("sim_1").build();
        MOBILE_DATA_SIM1_SLICE_URI = build10;
        Uri build11 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendEncodedPath("action").appendPath("mobile_data").appendPath("sim_2").build();
        MOBILE_DATA_SIM2_SLICE_URI = build11;
        Uri uri2 = build11;
        Uri build12 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendEncodedPath("action").appendPath("provider_model").build();
        PROVIDER_MODEL_SLICE_URI = build12;
        Uri uri3 = build12;
        Uri build13 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath(RelativeVolumePreferenceController.KEY_RELATIVE_VOLUME).build();
        VOLUME_RELATIVE_URI = build13;
        Uri uri4 = build13;
        Uri build14 = new Uri.Builder().scheme("content").authority("android.settings.slices").appendPath("action").appendPath("wifi").build();
        WIFI_SLICE_URI = build14;
        Uri build15 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("dark_theme").build();
        DARK_THEME_SLICE_URI = build15;
        Uri build16 = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("always_on_display").build();
        ALWAYS_ON_SLICE_URI = build16;
        ...
        arrayMap.put(uri, ExtendedMobileDataSlice.class);
        arrayMap.put(build10, MobileDataSIM1Slice.class);
        arrayMap.put(uri2, MobileDataSIM2Slice.class);
        arrayMap.put(uri3, ProviderModelSlice.class);
        arrayMap.put(build14, WifiSlice.class);
        arrayMap.put(build15, DarkThemeSlice.class);
        arrayMap.put(REMOTE_MEDIA_SLICE_URI, RemoteMediaSlice.class);
        arrayMap.put(build16, AlwaysOnDisplaySlice.class);
        arrayMap.put(uri4, RelativeVolumeSlice.class);
    }
