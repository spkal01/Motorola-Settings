...
public class DoubleTwistPreferenceController extends GesturePreferenceController {
    ...
    public static boolean isGestureAvailable(Context context) {
        ...
        String string = resources.getString(C1992R$string.gesture_double_twist_sensor_type);
        String string2 = resources.getString(C1992R$string.gesture_double_twist_sensor_vendor);
