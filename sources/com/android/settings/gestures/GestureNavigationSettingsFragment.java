...
public class GestureNavigationSettingsFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.gesture_navigation_settings) {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        this.mDefaultBackGestureInset = (float) resources.getDimensionPixelSize(17105067);
        this.mBackGestureInsetScales = getFloatArray(resources.obtainTypedArray(17236005));
        initSeekBarPreference("gesture_left_back_sensitivity");
        initSeekBarPreference("gesture_right_back_sensitivity");
        initGesturePillChooserPreference(resources);
    }

    private void initGesturePillChooserPreference(Resources resources) {
        PreferenceCategory preferenceCategory = (PreferenceCategory) getPreferenceScreen().findPreference("gesture_pill_category");
        boolean isCustNavBarAvailable = SystemNavigationGestureSettings.isCustNavBarAvailable();
        if (preferenceCategory != null) {
            preferenceCategory.setVisible(isCustNavBarAvailable);
        }
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.gesture_navigation_settings;
    }
