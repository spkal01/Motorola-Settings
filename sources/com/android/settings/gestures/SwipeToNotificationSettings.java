...
public class SwipeToNotificationSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.swipe_to_notification_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.swipe_to_notification_settings;
    }
}
