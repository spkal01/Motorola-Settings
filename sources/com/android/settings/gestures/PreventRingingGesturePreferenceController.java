...
public class PreventRingingGesturePreferenceController extends AbstractPreferenceController implements RadioButtonPreference.OnClickListener, LifecycleObserver, OnResume, OnPause, PreferenceControllerMixin {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (isAvailable()) {
            ...
            this.mVibratePref = makeRadioPreference(KEY_VIBRATE, C1992R$string.prevent_ringing_option_vibrate);
            this.mMutePref = makeRadioPreference(KEY_MUTE, C1992R$string.prevent_ringing_option_mute);
    ...
    public boolean isAvailable() {
        return this.mContext.getResources().getBoolean(17891795);
    }
