...
public class PreventRingingGestureSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.prevent_ringing_gesture_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.prevent_ringing_gesture_settings;
    }

    public int getHelpResource() {
        return C1992R$string.help_uri_prevent_ringing_gesture;
    }
}
