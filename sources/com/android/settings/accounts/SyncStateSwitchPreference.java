...
public class SyncStateSwitchPreference extends SwitchPreference {
    ...
    public SyncStateSwitchPreference(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0, C1993R$style.SyncSwitchPreference);
    ...
    public SyncStateSwitchPreference(Context context, Account account, String str, String str2, int i) {
        super(context, (AttributeSet) null, 0, C1993R$style.SyncSwitchPreference);
        this.mIsActive = false;
        this.mIsPending = false;
        this.mFailed = false;
        this.mOneTimeSyncMode = false;
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        AnimatedImageView animatedImageView = (AnimatedImageView) preferenceViewHolder.findViewById(C1985R$id.sync_active);
        View findViewById = preferenceViewHolder.findViewById(C1985R$id.sync_failed);
        ...
        if (this.mOneTimeSyncMode) {
            ...
            ((TextView) preferenceViewHolder.findViewById(16908304)).setText(getContext().getString(C1992R$string.sync_one_time_sync, new Object[]{getSummary()}));
            return;
        }
