    ...
    public PreferenceScreen addPreferencesForType(String str, PreferenceScreen preferenceScreen) {
        ...
        try {
            ...
            try {
                ...
                newTheme.applyStyle(C1993R$style.Theme_SettingsBase, true);
        ...
        while (i < preferenceGroup.getPreferenceCount()) {
            ...
            if (intent != null) {
                if (TextUtils.equals(intent.getAction(), "android.settings.LOCATION_SOURCE_SETTINGS")) {
                    preference.setOnPreferenceClickListener(new FragmentStarter(LocationSettings.class.getName(), C1992R$string.location_settings_title));
