...
public class ChooseAccountPreferenceController extends BasePreferenceController {
    ...
    private void updateAuthDescriptions() {
        AuthenticatorDescription[] authenticatorTypesAsUser = AccountManager.get(this.mContext).getAuthenticatorTypesAsUser(this.mUserHandle.getIdentifier());
        this.mAuthDescs = authenticatorTypesAsUser;
        this.mAuthDescs = MotoAccountsHelper.removeUnneededAuthDescs(this.mContext, authenticatorTypesAsUser);
        int i = 0;
        while (true) {
