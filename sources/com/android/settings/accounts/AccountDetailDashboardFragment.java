...
public class AccountDetailDashboardFragment extends DashboardFragment {
    ...
    public int getHelpResource() {
        return C1992R$string.help_url_account_detail;
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.account_type_settings;
    }
    ...
    public List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        ...
        accountSyncPreferenceController.init(this.mAccount, secureTargetUser);
        ...
        removeAccountPreferenceController.init(this.mAccount, secureTargetUser);
