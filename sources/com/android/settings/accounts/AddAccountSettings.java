...
public class AddAccountSettings extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (userManager.hasUserRestriction("no_modify_accounts", secureTargetUser)) {
            Toast.makeText(this, C1992R$string.user_cannot_add_accounts_message, 1).show();
            finish();
        ...
        } else if (!new ChooseLockSettingsHelper.Builder(this).setRequestCode(3).setTitle(getString(C1992R$string.unlock_set_unlock_launch_picker_title)).setUserId(this.mUserHandle.getIdentifier()).show()) {
            requestChooseAccount();
        }
    }
