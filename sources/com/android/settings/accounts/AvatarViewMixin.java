...
public class AvatarViewMixin implements LifecycleObserver {
    ...
    public static boolean isAvatarSupported(Context context) {
        if (context.getResources().getBoolean(C1980R$bool.config_show_avatar_in_homepage)) {
            return true;
        }
    ...
    public /* synthetic */ void lambda$new$0(SettingsHomepageActivity settingsHomepageActivity, View view) {
        try {
            Intent parseUri = Intent.parseUri(this.mContext.getResources().getString(C1992R$string.config_account_intent_uri), 1);
    ...
    public void onStart() {
        ...
        this.mAvatarView.setImageResource(C1983R$drawable.ic_account_circle_24dp);
    }
