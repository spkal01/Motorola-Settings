...
public class AccountDashboardFragment extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.accounts_dashboard_settings) {
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.accounts_dashboard_settings;
    }
