...
public class RemoveAccountPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, View.OnClickListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        if (isAvailable()) {
            ...
            ((Button) layoutPreference.findViewById(C1985R$id.button)).setOnClickListener(this);
        }
    }
    ...
    public boolean isAvailable() {
        ...
        if (account != null) {
            return MotoAccountsHelper.removeAllowed(this.mContext, account.type);
        }
        return false;
    }
    ...
    public static class ConfirmRemoveAccountDialog extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setTitle(C1992R$string.really_remove_account_title).setMessage(C1992R$string.really_remove_account_message).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setPositiveButton(C1992R$string.remove_account_label, (DialogInterface.OnClickListener) this).create();
        }

        public void onClick(DialogInterface dialogInterface, int i) {
            FragmentActivity activity = getTargetFragment().getActivity();
            AccountManager.get(activity).removeAccountAsUser(this.mAccount, activity, new C0648x609c4744(this), (Handler) null, this.mUserHandle);
        }
    ...
    public static class RemoveAccountFailureDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setTitle(C1992R$string.really_remove_account_title).setMessage(C1992R$string.remove_account_failed).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
        }
    }
}
