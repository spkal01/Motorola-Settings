...
public class MonitoringCertInfoActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (RestrictedLockUtils.getProfileOrDeviceOwner(this, userHandle) != null) {
            i = C1990R$plurals.ssl_ca_cert_settings_button;
        } else {
            i = C1990R$plurals.ssl_ca_cert_dialog_title;
        }
        ...
        builder.setPositiveButton(getResources().getQuantityText(C1990R$plurals.ssl_ca_cert_settings_button, intExtra2), (DialogInterface.OnClickListener) this);
        builder.setNeutralButton(C1992R$string.cancel, (DialogInterface.OnClickListener) null);
        builder.setOnDismissListener(this);
        if (devicePolicyManager.getProfileOwnerAsUser(this.mUserId) != null) {
            builder.setMessage((CharSequence) getResources().getQuantityString(C1990R$plurals.ssl_ca_cert_info_message, intExtra2, new Object[]{devicePolicyManager.getProfileOwnerNameAsUser(this.mUserId)}));
        } else if (devicePolicyManager.getDeviceOwnerComponentOnCallingUser() != null) {
            builder.setMessage((CharSequence) getResources().getQuantityString(C1990R$plurals.ssl_ca_cert_info_message_device_owner, intExtra2, new Object[]{devicePolicyManager.getDeviceOwnerNameOnAnyUser()}));
        } else {
            builder.setIcon(17301624);
            builder.setMessage(C1992R$string.ssl_ca_cert_warning_message);
        }
        builder.show();
    }
