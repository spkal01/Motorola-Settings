...
public class UwbPreferenceController extends TogglePreferenceController implements UwbManager.AdapterStateCallback, LifecycleObserver {
    ...
    public CharSequence getSummary() {
        if (this.mAirplaneModeOn) {
            return this.mContext.getResources().getString(C1992R$string.uwb_settings_summary_airplane_mode);
        }
        return this.mContext.getResources().getString(C1992R$string.uwb_settings_summary);
    }
}
