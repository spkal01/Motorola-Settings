...
public class DashboardFeatureProviderImpl implements DashboardFeatureProvider {
    ...
    public List<DynamicDataObserver> bindPreferenceToTileAndGetObservers(FragmentActivity fragmentActivity, boolean z, int i, Preference preference, Tile tile, String str, int i2) {
        ...
        bindSelectable(preference2, tile2);
        boolean z2 = z;
        ...
        if (tile2 instanceof ActivityTile) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                ...
                Intent customIntent = getCustomIntent(tile2);
                Intent intent = customIntent == null ? new Intent(tile.getIntent()) : customIntent;
                int i4 = i;
                intent.putExtra(":settings:source_metrics", i);
                if (str3 != null && customIntent == null) {
    ...
    private void bindSelectable(Preference preference, Tile tile) {
        if (tile.getMetaData() != null && tile.getMetaData().containsKey("com.android.settings.selectable")) {
            preference.setSelectable(tile.getMetaData().getBoolean("com.android.settings.selectable", true));
        }
    }

    private Intent getCustomIntent(Tile tile) {
        if (!"com.android.settings.category.ia.security".equals(tile.getCategory()) || !"security_status_security_patch_level".equals(getDashboardKeyForTile(tile))) {
            return null;
        }
    ...
    private DynamicDataObserver bindTitleAndGetObserver(Preference preference, Tile tile) {
        ...
        if (title != null) {
            ...
            preference.setTitle(C1992R$string.summary_placeholder);
    ...
    private DynamicDataObserver bindSummaryAndGetObserver(Preference preference, Tile tile) {
        ...
        if (summary != null) {
            ...
            preference.setSummary(C1992R$string.summary_placeholder);
    ...
    private void setSwitchChecked(Preference preference, boolean z) {
        if (preference instanceof PrimarySwitchPreference) {
            ...
            if (primarySwitchPreference.isChecked() != z) {
    ...
    private void setPreferenceIcon(Preference preference, Tile tile, boolean z, String str, Icon icon) {
        ...
        if (TextUtils.equals(tile.getCategory(), "com.android.settings.category.ia.homepage")) {
            ...
            AdaptiveIcon adaptiveIcon = new AdaptiveIcon(this.mContext, loadDrawable, C1982R$dimen.dashboard_tile_foreground_image_inset);
