...
import com.motorola.settings.deviceinfo.hardwareinfo.HardwareSettings;
...
public class DashboardFragmentRegistry {
    ...
    static {
        ...
        arrayMap.put(HardwareSettings.class.getName(), "com.android.settings.category.hardware");
        arrayMap.put(LocationSettings.class.getName(), "com.android.settings.category.location");
        arrayMap.put(NfcAndPaymentFragment.class.getName(), "com.android.settings.category.nfc");
        arrayMap.put(ConfigureWifiSettings.class.getName(), "com.android.settings.category.wifi_preferences");
        arrayMap.put(AccessibilitySettings.class.getName(), "com.android.settings.category.accessibility");
        arrayMap.put(FirmwareVersionSettings.class.getName(), "com.android.settings.category.firmware_info");
        arrayMap.put(HardwareInfoFragment.class.getName(), "com.android.settings.category.model_info");
        arrayMap.put(ResetDashboardFragment.class.getName(), "com.android.settings.category.reset_dashboard");
        arrayMap.put(FaceSettings.class.getName(), "com.android.settings.category.face_settings");
        arrayMap.put(TestingSettings.class.getName(), "com.android.settings.category.testing_settings");
