...
public class CryptKeeperConfirm extends InstrumentedFragment {
    ...
    public static class Blank extends Activity {
        ...
        public void onCreate(Bundle bundle) {
            ...
            setContentView(C1987R$layout.crypt_keeper_blank);
            if (Utils.isMonkeyRunning()) {
                finish();
            }
    ...
    private void establishFinalConfirmationState() {
        Button button = (Button) this.mContentView.findViewById(C1985R$id.execute_encrypt);
    ...
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        getActivity().setTitle(C1992R$string.crypt_keeper_confirm_title);
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.mContentView = layoutInflater.inflate(C1987R$layout.crypt_keeper_confirm, (ViewGroup) null);
