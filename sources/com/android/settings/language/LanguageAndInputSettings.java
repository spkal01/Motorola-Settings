...
public class LanguageAndInputSettings extends DashboardFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.language_and_input) {
    ...
    public void onResume() {
        ...
        if (activity != null) {
            activity.setTitle(C1992R$string.language_settings);
        }
    }

    /* access modifiers changed from: protected */
    public int getPreferenceScreenResId() {
        return C1994R$xml.language_and_input;
    }

    public int getHelpResource() {
        return C1992R$string.help_url_languages_input_dashboard;
    }
