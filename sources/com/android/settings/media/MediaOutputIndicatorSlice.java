...
public class MediaOutputIndicatorSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        ...
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, 17303713);
        Context context = this.mContext;
        String string = context.getString(C1992R$string.media_output_label_title, new Object[]{Utils.getApplicationLabel(context, getWorker().getPackageName())});
