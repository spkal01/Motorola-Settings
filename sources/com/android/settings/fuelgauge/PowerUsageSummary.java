...
public class PowerUsageSummary extends PowerUsageBase implements BatteryTipPreferenceController.BatteryTipListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.power_usage_summary);
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.power_usage_summary;
    }

    public int getHelpResource() {
        return C1992R$string.help_url_battery;
    }
    ...
    public void initPreference() {
        ...
        if (this.mPowerFeatureProvider.isChartGraphEnabled(getContext())) {
            str = getString(C1992R$string.advanced_battery_preference_summary_with_hours);
        } else {
            str = getString(C1992R$string.advanced_battery_preference_summary);
        }
