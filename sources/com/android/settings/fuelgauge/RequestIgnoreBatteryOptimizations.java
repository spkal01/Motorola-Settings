    ...
    public void onCreate(Bundle bundle) {
        ...
        if (schemeSpecificPart == null) {
            ...
            try {
                ...
                alertParams.mTitle = getText(C1992R$string.high_power_prompt_title);
                alertParams.mMessage = getString(C1992R$string.high_power_prompt_body, new Object[]{applicationInfo.loadLabel(getPackageManager())});
                alertParams.mPositiveButtonText = getText(C1992R$string.allow);
                alertParams.mNegativeButtonText = getText(C1992R$string.deny);
