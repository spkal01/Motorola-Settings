...
public class BatteryMeterView extends ImageView {
    ...
    public BatteryMeterView(Context context, AttributeSet attributeSet, int i) {
        ...
        int color = context.getColor(C1981R$color.meter_background_color);
        this.mAccentColorFilter = Utils.getAlphaInvariantColorFilterForColor(Utils.getColorAttrDefaultColor(context, 16843829));
        this.mErrorColorFilter = Utils.getAlphaInvariantColorFilterForColor(context.getColor(C1981R$color.battery_icon_color_error));
    ...
    public static class BatteryMeterDrawable extends ThemedBatteryDrawable {
        ...
        public BatteryMeterDrawable(Context context, int i) {
            super(context, i);
            this.mIntrinsicWidth = context.getResources().getDimensionPixelSize(C1982R$dimen.battery_meter_width);
            this.mIntrinsicHeight = context.getResources().getDimensionPixelSize(C1982R$dimen.battery_meter_height);
        }
