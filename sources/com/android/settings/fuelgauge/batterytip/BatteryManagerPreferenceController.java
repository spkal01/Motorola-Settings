...
public class BatteryManagerPreferenceController extends BasePreferenceController {
    ...
    public void updateSummary(Preference preference, int i) {
        if (i > 0) {
            preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C1990R$plurals.battery_manager_app_restricted, i, new Object[]{Integer.valueOf(i)}));
            return;
        }
        preference.setSummary(C1992R$string.battery_manager_summary);
    }
}
