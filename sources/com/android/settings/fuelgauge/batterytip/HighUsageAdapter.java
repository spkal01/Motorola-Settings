...
public class HighUsageAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view2) {
            super(view2);
            this.view = view2;
            this.appIcon = (ImageView) view2.findViewById(C1985R$id.app_icon);
            this.appName = (TextView) view2.findViewById(C1985R$id.app_name);
            this.appTime = (TextView) view2.findViewById(C1985R$id.app_screen_time);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.mContext).inflate(C1987R$layout.app_high_usage_item, viewGroup, false));
    }
