...
public class SmartBatteryAction extends BatteryTipAction {
    ...
    public void handlePositiveAction(int i) {
        ...
        subSettingLauncher.setSourceMetricsCategory(fragment instanceof Instrumentable ? ((Instrumentable) fragment).getMetricsCategory() : 0).setDestination(SmartBatterySettings.class.getName()).setTitleRes(C1992R$string.smart_battery_manager_title).launch();
    }
}
