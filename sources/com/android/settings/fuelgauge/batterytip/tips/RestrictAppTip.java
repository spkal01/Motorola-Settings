...
public class RestrictAppTip extends BatteryTip {
    ...
    public CharSequence getTitle(Context context) {
        ...
        if (this.mState == 1) {
            return resources.getQuantityString(C1990R$plurals.battery_tip_restrict_handled_title, size, new Object[]{applicationLabel, Integer.valueOf(size)});
        }
        return resources.getQuantityString(C1990R$plurals.battery_tip_restrict_title, size, new Object[]{Integer.valueOf(size)});
    }
    ...
    public CharSequence getSummary(Context context) {
        ...
        String applicationLabel = size > 0 ? Utils.getApplicationLabel(context, this.mRestrictAppList.get(0).packageName) : "";
        if (this.mState == 1) {
            i = C1990R$plurals.battery_tip_restrict_handled_summary;
        } else {
            i = C1990R$plurals.battery_tip_restrict_summary;
        }
    ...
    public int getIconId() {
        if (this.mState == 1) {
            return C1983R$drawable.ic_perm_device_information_green_24dp;
        }
        return C1983R$drawable.ic_battery_alert_24dp;
    }
