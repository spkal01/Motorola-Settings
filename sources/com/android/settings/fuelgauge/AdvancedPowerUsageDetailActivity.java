...
public class AdvancedPowerUsageDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (str != null) {
            ...
            new SubSettingLauncher(this).setDestination(AdvancedPowerUsageDetail.class.getName()).setTitleRes(C1992R$string.battery_details_title).setArguments(bundle2).setSourceMetricsCategory(20).launch();
        }
        finish();
    }
}
