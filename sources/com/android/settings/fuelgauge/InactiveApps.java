...
public class InactiveApps extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        addPreferencesFromResource(C1994R$xml.placeholder_preference_screen);
        getActivity().setTitle(C1992R$string.inactive_apps_title);
    }
    ...
    private void updateSummary(ListPreference listPreference) {
        ...
        boolean z = true;
        listPreference.setSummary(resources.getString(C1992R$string.standby_bucket_summary, new Object[]{bucketToName(appStandbyBucket)}));
