...
public class RestrictedAppDetails extends DashboardFragment implements BatteryTipPreferenceController.BatteryTipListener {
    ...
    public static void startRestrictedAppDetails(InstrumentedPreferenceFragment instrumentedPreferenceFragment, List<AppInfo> list) {
        ...
        new SubSettingLauncher(instrumentedPreferenceFragment.getContext()).setDestination(RestrictedAppDetails.class.getName()).setArguments(bundle).setTitleRes(C1992R$string.restricted_app_title).setSourceMetricsCategory(instrumentedPreferenceFragment.getMetricsCategory()).launch();
    }
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.restricted_apps_detail;
    }

    public int getHelpResource() {
        return C1992R$string.help_uri_restricted_apps;
    }
    ...
    public void refreshUi() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            try {
                ...
                if (j != -1) {
                    appCheckBoxPreference.setSummary((CharSequence) getString(C1992R$string.restricted_app_time_summary, StringUtil.formatRelativeTime(prefContext, (double) (currentTimeMillis - j), false)));
                }
