...
public class BatteryChartView extends AppCompatImageView implements View.OnClickListener, AccessibilityManager.AccessibilityStateChangeListener {
    ...
    String[] mTimestamps;
    private final Rect[] mTimestampsBounds = {new Rect(), new Rect(), new Rect(), new Rect(), new Rect()};
    ...
    public void setLatestTimestamp(long j) {
        ...
        for (int i = 0; i < 5; i++) {
            this.mTimestamps[i] = ConvertUtils.utcToLocalTimeHour(getContext(), j - (((long) (4 - i)) * 21600000), is24HourFormat);
        }
        requestLayout();
    }
    ...
    private void initializeColors(Context context) {
        ...
        this.mDividerWidth = resources.getDimensionPixelSize(C1982R$dimen.chartview_divider_width);
        this.mDividerHeight = resources.getDimensionPixelSize(C1982R$dimen.chartview_divider_height);
        Paint paint = new Paint();
        ...
        this.mTrapezoidHOffset = resources.getDimension(C1982R$dimen.chartview_trapezoid_margin_start);
        this.mTrapezoidVOffset = resources.getDimension(C1982R$dimen.chartview_trapezoid_margin_bottom);
        ...
        this.mTrapezoidPaint.setPathEffect(new CornerPathEffect((float) resources.getDimensionPixelSize(C1982R$dimen.chartview_trapezoid_radius)));
        this.mTextPadding = resources.getDimensionPixelSize(C1982R$dimen.chartview_text_padding);
    }
    ...
    private void drawTimestamp(Canvas canvas, float[] fArr) {
        ...
        canvas.drawText(this.mTimestamps[4], (fArr[4] - ((float) this.mTimestampsBounds[4].width())) - ((float) this.mTimestampsBounds[4].left), (float) getTimestampY(4), this.mTextPaint);
        for (int i = 1; i <= 3; i++) {
