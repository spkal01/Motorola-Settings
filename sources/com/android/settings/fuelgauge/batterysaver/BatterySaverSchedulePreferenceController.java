...
public class BatterySaverSchedulePreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (Settings.Global.getInt(contentResolver, "automatic_power_save_mode", 0) != 0) {
            return this.mContext.getText(C1992R$string.battery_saver_auto_routine);
        }
        int i = Settings.Global.getInt(contentResolver, "low_power_trigger_level", 0);
        if (i <= 0) {
            return this.mContext.getText(C1992R$string.battery_saver_auto_no_schedule);
        }
        return this.mContext.getString(C1992R$string.battery_saver_auto_percentage_summary, new Object[]{Utils.formatPercentage(i)});
    }
}
