...
public class BatterySaverStickyPreferenceController extends TogglePreferenceController implements PreferenceControllerMixin {
    ...
    public void refreshSummary(Preference preference) {
        ...
        preference.setSummary(TextUtils.expandTemplate(this.mContext.getString(C1992R$string.battery_saver_sticky_description_new), new CharSequence[]{NumberFormat.getIntegerInstance().format((long) i)}));
    }
