...
public class ImePreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        preference.setSummary((CharSequence) this.mContext.getResources().getString(C1992R$string.enterprise_privacy_input_method_name, new Object[]{this.mFeatureProvider.getImeLabelIfOwnerSet()}));
    }
