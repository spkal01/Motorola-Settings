...
public class EnterpriseSetDefaultAppsPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        ...
        preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C1990R$plurals.enterprise_privacy_number_packages, numberOfEnterpriseSetDefaultApps, new Object[]{Integer.valueOf(numberOfEnterpriseSetDefaultApps)}));
    }
