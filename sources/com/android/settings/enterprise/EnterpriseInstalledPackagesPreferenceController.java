...
public class EnterpriseInstalledPackagesPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        this.mFeatureProvider.calculateNumberOfPolicyInstalledApps(true, new C0933xc1662b8c(this, preference));
    }
    ...
    public boolean isAvailable() {
        ...
        this.mFeatureProvider.calculateNumberOfPolicyInstalledApps(false, new C0934xc1662b8d(boolArr));
