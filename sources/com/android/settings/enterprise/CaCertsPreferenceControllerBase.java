...
public abstract class CaCertsPreferenceControllerBase extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        ...
        preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C1990R$plurals.enterprise_privacy_number_ca_certs, numberOfCaCerts, new Object[]{Integer.valueOf(numberOfCaCerts)}));
    }
