    ...
    public void updateState(Preference preference) {
        if (preference != null) {
            ...
            if (deviceOwnerOrganizationName == null) {
                preference.setSummary(C1992R$string.enterprise_privacy_settings_summary_generic);
                return;
            }
            preference.setSummary((CharSequence) this.mContext.getResources().getString(C1992R$string.enterprise_privacy_settings_summary_with_name, new Object[]{deviceOwnerOrganizationName}));
        }
    }
