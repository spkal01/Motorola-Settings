...
public class ManageDeviceAdminPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        ...
        if (numberOfActiveDeviceAdminsForCurrentUserAndManagedProfile == 0) {
            return this.mContext.getResources().getString(C1992R$string.number_of_device_admins_none);
        }
        return this.mContext.getResources().getQuantityString(C1990R$plurals.number_of_device_admins, numberOfActiveDeviceAdminsForCurrentUserAndManagedProfile, new Object[]{Integer.valueOf(numberOfActiveDeviceAdminsForCurrentUserAndManagedProfile)});
    }

    public int getAvailabilityStatus() {
        return this.mContext.getResources().getBoolean(C1980R$bool.config_show_manage_device_admin) ? 0 : 3;
    }
}
