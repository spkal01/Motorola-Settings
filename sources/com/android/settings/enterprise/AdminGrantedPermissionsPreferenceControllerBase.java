...
public abstract class AdminGrantedPermissionsPreferenceControllerBase extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public void updateState(Preference preference) {
        this.mFeatureProvider.calculateNumberOfAppsWithAdminGrantedPermissions(this.mPermissions, true, new C0931x5f15e78f(this, preference));
    }
    ...
    public /* synthetic */ void lambda$updateState$0(Preference preference, int i) {
        if (i == 0) {
            ...
            preference.setSummary((CharSequence) this.mContext.getResources().getQuantityString(C1990R$plurals.enterprise_privacy_number_packages_lower_bound, i, new Object[]{Integer.valueOf(i)}));
            this.mHasApps = true;
        }
    ...
    public boolean isAvailable() {
        ...
        this.mFeatureProvider.calculateNumberOfAppsWithAdminGrantedPermissions(this.mPermissions, false, new C0932x5f15e790(boolArr));
