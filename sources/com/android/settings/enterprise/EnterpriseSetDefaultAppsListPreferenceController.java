...
public class EnterpriseSetDefaultAppsListPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    private void buildAppList() {
        ...
        ThreadUtils.postOnMainThread(new C0937xb9e1e136(this));
    }
            ...
            if (this.mEnterprisePrivacyFeatureProvider.isInCompMode() || this.mUsers.size() != 1) {
                for (int i = 0; i < this.mUsers.size(); i++) {
                    ...
                    if (this.mUsers.get(i).isManagedProfile()) {
                        preferenceCategory.setTitle(C1992R$string.category_work);
                    } else {
                        preferenceCategory.setTitle(C1992R$string.category_personal);
                    }
    ...
    private CharSequence buildSummaryString(Context context, List<ApplicationInfo> list) {
        ...
        if (list.size() == 2) {
            return context.getString(C1992R$string.app_names_concatenation_template_2, new Object[]{charSequenceArr[0], charSequenceArr[1]});
        }
        return context.getString(C1992R$string.app_names_concatenation_template_3, new Object[]{charSequenceArr[0], charSequenceArr[1], charSequenceArr[2]});
    }
    ...
    static /* synthetic */ class C09361 {
        ...
        static final /* synthetic */ int[] f96x4783f43a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f96x4783f43a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f96x4783f43a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f96x4783f43a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f96x4783f43a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f96x4783f43a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f96x4783f43a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.enterprise.EnterpriseSetDefaultAppsListPreferenceController.C09361.<clinit>():void");
        }
    }

    private String getTitle(Context context, EnterpriseDefaultApps enterpriseDefaultApps, int i) {
        switch (C09361.f96x4783f43a[enterpriseDefaultApps.ordinal()]) {
            case 1:
                return context.getString(C1992R$string.default_browser_title);
            case 2:
                return context.getString(C1992R$string.default_calendar_app_title);
            case 3:
                return context.getString(C1992R$string.default_contacts_app_title);
            case 4:
                return context.getResources().getQuantityString(C1990R$plurals.default_phone_app_title, i);
            case 5:
                return context.getString(C1992R$string.default_map_app_title);
            case 6:
                return context.getResources().getQuantityString(C1990R$plurals.default_email_app_title, i);
            case 7:
                return context.getResources().getQuantityString(C1990R$plurals.default_camera_app_title, i);
            default:
