...
import com.motorola.settings.dashboard.suggestions.ExtendedSuggestionFeatureProviderImpl;
...
public class FeatureFactoryImpl extends FeatureFactory {
    ...
    public SuggestionFeatureProvider getSuggestionFeatureProvider(Context context) {
        if (this.mSuggestionFeatureProvider == null) {
            this.mSuggestionFeatureProvider = new ExtendedSuggestionFeatureProviderImpl(context.getApplicationContext());
        }
