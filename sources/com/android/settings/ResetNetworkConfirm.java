...
public class ResetNetworkConfirm extends InstrumentedFragment {
    ...
    private class ResetNetworkTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public Boolean doInBackground(Void... voidArr) {
            ...
            PersistableBundle configForSubId = ((CarrierConfigManager) this.mContext.getSystemService("carrier_config")).getConfigForSubId(ResetNetworkConfirm.this.mSubId);
            ...
            if (ResetNetwork.isResetNfcEnabled(this.mContext) && (defaultAdapter = NfcAdapter.getDefaultAdapter(this.mContext)) != null) {
                defaultAdapter.factoryReset();
            }
            if (configForSubId != null ? configForSubId.getBoolean("allow_resetting_apns_bool") : false) {
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                Toast.makeText(this.mContext, C1992R$string.reset_network_complete_toast, 0).show();
            } else {
                AlertDialog unused = ResetNetworkConfirm.this.mAlertDialog = new AlertDialog.Builder(this.mContext).setTitle(C1992R$string.reset_esim_error_title).setMessage(C1992R$string.reset_esim_error_msg).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).show();
            }
        }
    }
    ...
    public ProgressDialog getProgressDialog(Context context) {
        ...
        progressDialog.setMessage(context.getString(C1992R$string.main_clear_progress_text));
    ...
    private void establishFinalConfirmationState() {
        this.mContentView.findViewById(C1985R$id.execute_reset_network).setOnClickListener(this.mFinalClickListener);
    }

    /* access modifiers changed from: package-private */
    public void setSubtitle() {
        if (this.mEraseEsim) {
            ((TextView) this.mContentView.findViewById(C1985R$id.reset_network_confirm)).setText(C1992R$string.reset_network_final_desc_esim);
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mContentView = layoutInflater.inflate(C1987R$layout.reset_network_confirm, (ViewGroup) null);
