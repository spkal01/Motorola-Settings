...
public class AllInOneTetherSettings extends RestrictedDashboardFragment implements DataSaverBackend.Listener, WifiTetherBasePreferenceController.OnTetherConfigUpdateListener {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(C1994R$xml.all_tether_prefs) {
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!TetherUtil.isTetherAvailable(context)) {
                ...
                nonIndexableKeys.add("wifi_tether_hidden_network_2");
                nonIndexableKeys.add("wifi_tether_timeout_settings_2");
                nonIndexableKeys.add("wifi_tether_manage_devices_2");
            }
    ...
    private WifiTetherTimeoutPreferenceController mTimeoutPreferenceController;
    ...
    public void onAttach(Context context) {
        ...
        this.mTimeoutPreferenceController = (WifiTetherTimeoutPreferenceController) use(WifiTetherTimeoutPreferenceController.class);
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, WifiTetherBasePreferenceController.OnTetherConfigUpdateListener onTetherConfigUpdateListener) {
        ...
        arrayList.add(new WifiTetherManageDevicesController(context, "wifi_tether_manage_devices_2"));
    ...
    public int getPreferenceScreenResId() {
        return C1994R$xml.all_tether_prefs;
    }
    ...
    public void updateDisplayWithNewConfig() {
        ...
        this.mHiddenSSIDPreferenceController.updateDisplay();
        this.mTimeoutPreferenceController.updateDisplay();
    }
