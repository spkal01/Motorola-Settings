...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        this.mDreamsEnabledByDefault = applicationContext.getResources().getBoolean(17891550);
        this.mDreamsActivatedOnSleepByDefault = applicationContext.getResources().getBoolean(17891549);
        this.mDreamsActivatedOnDockByDefault = applicationContext.getResources().getBoolean(17891548);
    }
