...
public class ZenDurationDialog {
    ...
    public void updateZenDuration(int i) {
        ...
        if (i != i2) {
            ...
            if (Settings.Global.getInt(this.mContext.getContentResolver(), "zen_mode", 0) != 0 && i2 != -1) {
                if (i2 != 0) {
                    NotificationManager.from(this.mContext).setZenMode(0, (Uri) null, "ZenDurationDialog");
                    this.mNotificationManager.setZenMode(1, ZenModeConfig.toTimeCondition(this.mContext, i2, ActivityManager.getCurrentUser(), true).id, "ZenDurationDialog");
                    return;
                }
                NotificationManager.from(this.mContext).setZenMode(1, (Uri) null, "ZenDurationDialog");
            }
        }
    }
    ...
    public void setupRadioButtons(int i) {
        ...
        getConditionTagAt(i2).f147rb.setChecked(true);
    }
    ...
    private void bindTag(int i, View view, int i2) {
        ...
        if (conditionTag.f147rb == null) {
            conditionTag.f147rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
        }
        if (i <= 0) {
        ...
        conditionTag.f147rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    conditionTag.f147rb.setChecked(true);
                }
            }
        });
