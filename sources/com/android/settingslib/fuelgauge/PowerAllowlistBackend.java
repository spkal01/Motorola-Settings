...
public class PowerAllowlistBackend {
    ...
    public void refreshList() {
        ...
        if (iDeviceIdleController != null) {
            try {
                ...
                for (String add2 : getSystemPowerAllowlist()) {
    ...
    public List<String> getSystemPowerAllowlist() throws RemoteException {
        MotoDevicePolicyManager motoDevicePolicyManager = (MotoDevicePolicyManager) this.mContext.getSystemService("mot_device_policy");
        ArrayList arrayList = new ArrayList(Arrays.asList(this.mDeviceIdleService.getSystemPowerWhitelist()));
        if (motoDevicePolicyManager != null) {
            arrayList.addAll(motoDevicePolicyManager.getNonBatteryOptimizedAppList());
        }
        return arrayList;
    }
