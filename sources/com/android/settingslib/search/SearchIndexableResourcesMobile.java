...
import com.motorola.settings.display.edge.EdgeSensitivitySettingsFragment;
...
public class SearchIndexableResourcesMobile extends SearchIndexableResourcesBase {
    public SearchIndexableResourcesMobile() {
        ...
        addIndex(new SearchIndexableData(EdgeSensitivitySettingsFragment.class, EdgeSensitivitySettingsFragment.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(ThreeButtonNavSettingsFragment.class, ThreeButtonNavSettingsFragment.SEARCH_INDEX_DATA_PROVIDER));
    }
}
