...
import com.motorola.settings.display.refreshrate.DisplayRefreshRatePreferenceFragment;
...
public class SearchIndexableResourcesBase implements SearchIndexableResources {
    ...
    public SearchIndexableResourcesBase() {
        ...
        addIndex(new SearchIndexableData(HardwareSettings.class, HardwareSettings.SEARCH_INDEX_DATA_PROVIDER));
        addIndex(new SearchIndexableData(DisplayRefreshRatePreferenceFragment.class, DisplayRefreshRatePreferenceFragment.SEARCH_INDEX_DATA_PROVIDER));
    }
