...
public final class WizardManagerHelper {
    ...
    public static final String EXTRA_ALLOW_CUSTOMIZATION_IN_SETUP_FLOW = "allowCustomizationInSetupFlow";
    ...
    public static boolean allowCustomizationInSetupFlow(Intent intent) {
        return intent.getBooleanExtra(EXTRA_ALLOW_CUSTOMIZATION_IN_SETUP_FLOW, false);
    }
