...
public class SetupCompatServiceProvider {
    ...
    final ServiceConnection serviceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (iBinder == null) {
                ...
                SetupCompatServiceProvider.LOG.mo20057w("Binder is null when onServiceConnected was called!");
            }
    ...
    public ISetupCompatService getService(long j, TimeUnit timeUnit) throws TimeoutException, InterruptedException {
        ...
        switch (C17852.f153x90ac3479[currentServiceState.state.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C17852 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f153x90ac3479     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f153x90ac3479     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f153x90ac3479     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f153x90ac3479     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f153x90ac3479     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f153x90ac3479     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.setupcompat.internal.SetupCompatServiceProvider.C17852.<clinit>():void");
        }
    }
    ...
    private synchronized void requestServiceBind() {
        /*
            r4 = this;
            monitor-enter(r4)
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$ServiceContext r0 = r4.getCurrentServiceState()     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r0 = r0.state     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r1 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.CONNECTED     // Catch:{ all -> 0x007a }
            if (r0 != r1) goto L_0x0014
            com.google.android.setupcompat.util.Logger r0 = LOG     // Catch:{ all -> 0x007a }
            java.lang.String r1 = "Refusing to rebind since current state is already connected"
            r0.atInfo(r1)     // Catch:{ all -> 0x007a }
            monitor-exit(r4)
            return
        L_0x0014:
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r1 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.NOT_STARTED     // Catch:{ all -> 0x007a }
            if (r0 == r1) goto L_0x0026
            com.google.android.setupcompat.util.Logger r0 = LOG     // Catch:{ all -> 0x007a }
            java.lang.String r1 = "Unbinding existing service connection."
            r0.atInfo(r1)     // Catch:{ all -> 0x007a }
            android.content.Context r0 = r4.context     // Catch:{ all -> 0x007a }
            android.content.ServiceConnection r1 = r4.serviceConnection     // Catch:{ all -> 0x007a }
            r0.unbindService(r1)     // Catch:{ all -> 0x007a }
        L_0x0026:
        ...
        L_0x0032:
            r0 = move-exception
            com.google.android.setupcompat.util.Logger r1 = LOG     // Catch:{ all -> 0x007a }
            ...
            r1.mo20053e(r0)     // Catch:{ all -> 0x007a }
            r0 = 0
        L_0x004a:
            r1 = 0
            if (r0 == 0) goto L_0x0067
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r0 = r4.getCurrentState()     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r2 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.CONNECTED     // Catch:{ all -> 0x007a }
            if (r0 == r2) goto L_0x0078
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$ServiceContext r0 = new com.google.android.setupcompat.internal.SetupCompatServiceProvider$ServiceContext     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r2 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.BINDING     // Catch:{ all -> 0x007a }
            r0.<init>((com.google.android.setupcompat.internal.SetupCompatServiceProvider.State) r2)     // Catch:{ all -> 0x007a }
            r4.swapServiceContextAndNotify(r0)     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.util.Logger r0 = LOG     // Catch:{ all -> 0x007a }
        ...
        L_0x0067:
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$ServiceContext r0 = new com.google.android.setupcompat.internal.SetupCompatServiceProvider$ServiceContext     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r2 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.BIND_FAILED     // Catch:{ all -> 0x007a }
            r0.<init>((com.google.android.setupcompat.internal.SetupCompatServiceProvider.State) r2)     // Catch:{ all -> 0x007a }
            r4.swapServiceContextAndNotify(r0)     // Catch:{ all -> 0x007a }
            com.google.android.setupcompat.util.Logger r0 = LOG     // Catch:{ all -> 0x007a }
            java.lang.String r1 = "Context#bindService did not succeed."
            r0.mo20053e(r1)     // Catch:{ all -> 0x007a }
        L_0x0078:
            monitor-exit(r4)
            return
        L_0x007a:
