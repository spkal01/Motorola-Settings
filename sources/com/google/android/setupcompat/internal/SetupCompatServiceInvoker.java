...
public class SetupCompatServiceInvoker {
    ...
    public void logMetricEvent(int i, Bundle bundle) {
        try {
            ...
            LOG.mo20054e(String.format("Metric of type %d dropped since queue is full.", new Object[]{Integer.valueOf(i)}), e);
        }
    }
    ...
    public void bindBack(String str, Bundle bundle) {
        try {
            ...
            LOG.mo20054e(String.format("Screen %s bind back fail.", new Object[]{str}), e);
        }
    }
    ...
    public void lambda$logMetricEvent$0(int i, Bundle bundle) {
        try {
            ...
            if (iSetupCompatService != null) {
                ...
                LOG.mo20057w("logMetric failed since service reference is null. Are the permissions valid?");
            }
        } catch (RemoteException | IllegalStateException | InterruptedException | TimeoutException e) {
            LOG.mo20054e(String.format("Exception occurred while trying to log metric = [%s]", new Object[]{bundle}), e);
        }
    }
    ...
    public void lambda$bindBack$1(String str, Bundle bundle) {
        try {
            ...
            if (iSetupCompatService != null) {
                ...
                LOG.mo20057w("BindBack failed since service reference is null. Are the permissions valid?");
            }
        } catch (RemoteException | InterruptedException | TimeoutException e) {
            LOG.mo20054e(String.format("Exception occurred while %s trying bind back to SetupWizard.", new Object[]{str}), e);
        }
    }
