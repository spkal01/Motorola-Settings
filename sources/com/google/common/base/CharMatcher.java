...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: or */
    public CharMatcher mo20410or(CharMatcher charMatcher) {
        return new C1808Or(this, charMatcher);
    }
    ...
    private static final class C1808Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;

        C1808Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
    ...
    private static final class C1807Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo20410or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : CharMatcher.super.mo20410or(charMatcher);
        }
