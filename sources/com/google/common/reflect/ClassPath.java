...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m25on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m32of(File file2, String str, ClassLoader classLoader) {
    ...
    static abstract class Scanner {
        ...
        static com.google.common.collect.ImmutableList<java.net.URL> parseJavaClassPath() {
            /*
                ...
                com.google.common.base.Splitter r1 = com.google.common.base.Splitter.m25on((java.lang.String) r1)
        ...
        public void scanJarFile(ClassLoader classLoader, JarFile jarFile) throws IOException {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (!nextElement.isDirectory() && !nextElement.getName().equals("META-INF/MANIFEST.MF")) {
                    scanResource(ResourceInfo.m32of(new File(jarFile.getName()), nextElement.getName(), classLoader));
                }
            }
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (!str2.equals("META-INF/MANIFEST.MF")) {
                        scanResource(ResourceInfo.m32of(file2, str2, classLoader));
                    }
                }
            }
        }
