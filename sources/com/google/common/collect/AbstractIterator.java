...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    static /* synthetic */ class C18161 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.AbstractIterator.C18161.<clinit>():void");
        }
    }
    ...
    public final boolean hasNext() {
        ...
        int i = C18161.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
