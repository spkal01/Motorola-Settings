...
class JsonUtils {
    private static final JsonReader.Options POINT_NAMES = JsonReader.Options.m8of("x", "y");
    ...
    static /* synthetic */ class C05171 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.JsonUtils.C05171.<clinit>():void");
        }
    }

    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C05171.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C05171.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[peek.ordinal()];
        if (i == 1) {
