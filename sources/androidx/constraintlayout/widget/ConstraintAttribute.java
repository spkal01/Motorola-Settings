...
public class ConstraintAttribute {
    ...
    static /* synthetic */ class C01261 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.widget.ConstraintAttribute.C01261.<clinit>():void");
        }
    }

    public int noOfInterpValues() {
        int i = C01261.f28x66adad53[this.mType.ordinal()];
        return (i == 1 || i == 2) ? 4 : 1;
    }

    public float getValueToInterpolate() {
        switch (C01261.f28x66adad53[this.mType.ordinal()]) {
            case 1:
            case 2:
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            String str = "set" + next;
            try {
                switch (C01261.f28x66adad53[constraintAttribute.mType.ordinal()]) {
                    case 1:
