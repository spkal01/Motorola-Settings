...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation next : list) {
            ...
            int i = C018810.f35xe493b431[next.getFinalState().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
    ...
    static /* synthetic */ class C018810 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.DefaultSpecialEffectsController.C018810.<clinit>():void");
        }
    }
                ...
                if (animation == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(operation))) {
                            ...
                            C01892 r0 = new AnimatorListenerAdapter() {
