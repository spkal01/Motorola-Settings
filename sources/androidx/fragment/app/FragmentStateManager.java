...
class FragmentStateManager {
    ...
    public int computeExpectedState() {
        ...
        int i2 = C02322.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment2.mMaxState.ordinal()];
        if (i2 != 1) {
            if (i2 == 2) {
                i = Math.min(i, 5);
            } else if (i2 == 3) {
    ...
    static /* synthetic */ class C02322 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentStateManager.C02322.<clinit>():void");
        }
    }
