    ...
    static class Operation {
        ...
        enum State {
            ...
            public void applyState(View view) {
                int i = C02533.f37xe493b431[ordinal()];
                if (i == 1) {
        ...
        public final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C02533.f36xb9e640f0[lifecycleImpact.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    if (FragmentManager.isLoggingEnabled(2)) {
    ...
    static /* synthetic */ class C02533 {
        ...
        static {
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.SpecialEffectsController.C02533.<clinit>():void");
        }
    }
